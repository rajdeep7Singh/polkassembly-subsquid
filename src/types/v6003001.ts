 ...
 */
export type UtilityCall = UtilityCall_as_derivative | UtilityCall_batch | UtilityCall_batch_all | UtilityCall_batch_atomic | UtilityCall_batch_old | UtilityCall_batch_optimistic | UtilityCall_dispatch_as | UtilityCall_force_batch | UtilityCall_relay_tx | UtilityCall_with_weight
...
export type Type_533 = Type_533_Endorsed

export interface Type_533_Endorsed {
    __kind: 'Endorsed'
}

export type Type_532 = Type_532_Endorsed

export interface Type_532_Endorsed {
    __kind: 'Endorsed'
}

export type Type_531 = Type_531_Endorsed

export interface Type_531_Endorsed {
    __kind: 'Endorsed'
}
...
export const OriginCaller: sts.Type<OriginCaller> = sts.closedEnum(() => {
    return  {
        PolymeshCommittee: Type_531,
        TechnicalCommittee: Type_532,
        UpgradeCommittee: Type_533,
        Void: Void,
        system: RawOrigin,
    }
})
...
export const Type_533: sts.Type<Type_533> = sts.closedEnum(() => {
    return  {
        Endorsed: sts.unit(),
    }
})
...
export const Type_468: sts.Type<Type_468> = sts.struct(() => {
    return  {
        roundNumber: sts.bigint(),
        identity: Public,
...
export const AssetCall: sts.Type<AssetCall> = sts.closedEnum(() => {
    return  {
        ...
        redeem_from_portfolio: sts.enumStruct({
            ticker: Ticker,
            value: sts.bigint(),
            portfolio: PortfolioKind,
        }),
