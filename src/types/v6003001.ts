...
export type Type_534 = Type_534_Endorsed

export interface Type_534_Endorsed {
    __kind: 'Endorsed'
}
...
export const OriginCaller: sts.Type<OriginCaller> = sts.closedEnum(() => {
    return  {
        PolymeshCommittee: Type_532,
        TechnicalCommittee: Type_533,
        UpgradeCommittee: Type_534,
        Void: Void,
        system: RawOrigin,
    }
})
