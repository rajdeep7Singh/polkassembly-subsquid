...
export type Call = Call_Authorship | Call_Babe | Call_Balances | Call_Bounties | Call_CereDDCModule | Call_ChainBridge | Call_ChildBounties | Call_Contracts | Call_Council | Call_DdcMetricsOffchainWorker | Call_Democracy | Call_ElectionProviderMultiPhase | Call_Elections | Call_Erc20 | Call_Erc721 | Call_Grandpa | Call_Identity | Call_ImOnline | Call_Indices | Call_Multisig | Call_NominationPools | Call_Proxy | Call_Recovery | Call_Scheduler | Call_Session | Call_Society | Call_Staking | Call_Sudo | Call_System | Call_TechnicalCommittee | Call_TechnicalMembership | Call_Timestamp | Call_Tips | Call_Treasury | Call_Utility | Call_Vesting | Call_VoterList
...
export type Type_288 = Type_288_Approve | Type_288_Rebid | Type_288_Reject
...
export const Type_232: sts.Type<Type_232> = sts.struct(() => {
    return  {
        roundNumber: sts.bigint(),
        identity: Public,
