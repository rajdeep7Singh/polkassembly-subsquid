...
export type Call = Call_System | Call_Utility | Call_Babe | Call_Timestamp | Call_Authorship | Call_Indices | Call_Balances | Call_ElectionProviderMultiPhase | Call_Staking | Call_Session | Call_Democracy | Call_Council | Call_TechnicalCommittee | Call_Elections | Call_TechnicalMembership | Call_Grandpa | Call_Treasury | Call_Contracts | Call_Sudo | Call_ImOnline | Call_Identity | Call_Society | Call_Recovery | Call_Vesting | Call_Scheduler | Call_Proxy | Call_Multisig | Call_Bounties | Call_Tips | Call_VoterList | Call_ChildBounties | Call_NominationPools | Call_CereDDCModule | Call_ChainBridge | Call_Erc721 | Call_Erc20 | Call_DdcMetricsOffchainWorker
...
export type Type_288 = Type_288_Rebid | Type_288_Reject | Type_288_Approve

export interface Type_288_Rebid {
    __kind: 'Rebid'
}

export interface Type_288_Reject {
    __kind: 'Reject'
}

export interface Type_288_Approve {
    __kind: 'Approve'
}
...
export type Type_307 = Type_307_Noop | Type_307_Set | Type_307_Remove
...
export type Type_308 = Type_308_Noop | Type_308_Set | Type_308_Remove
