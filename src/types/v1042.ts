...
export type Type_114 = Type_114_Attestations | Type_114_AuthorityDiscovery | Type_114_Authorship | Type_114_Babe | Type_114_Balances | Type_114_Claims | Type_114_Council | Type_114_Democracy | Type_114_ElectionsPhragmen | Type_114_FinalityTracker | Type_114_Grandpa | Type_114_Identity | Type_114_ImOnline | Type_114_Indices | Type_114_Offences | Type_114_Parachains | Type_114_Recovery | Type_114_Registrar | Type_114_Session | Type_114_Slots | Type_114_Society | Type_114_Staking | Type_114_System | Type_114_TechnicalCommittee | Type_114_TechnicalMembership | Type_114_Timestamp | Type_114_Treasury | Type_114_Utility

export interface Type_114_Attestations {
    __kind: 'Attestations'
    value: AttestationsCall
}

export interface Type_114_AuthorityDiscovery {
    __kind: 'AuthorityDiscovery'
    value: AuthorityDiscoveryCall
}

export interface Type_114_Authorship {
    __kind: 'Authorship'
    value: AuthorshipCall
}

export interface Type_114_Babe {
    __kind: 'Babe'
    value: BabeCall
}

export interface Type_114_Balances {
    __kind: 'Balances'
    value: BalancesCall
}

export interface Type_114_Claims {
    __kind: 'Claims'
    value: ClaimsCall
}

export interface Type_114_Council {
    __kind: 'Council'
    value: CouncilCall
}

export interface Type_114_Democracy {
    __kind: 'Democracy'
    value: DemocracyCall
}

export interface Type_114_ElectionsPhragmen {
    __kind: 'ElectionsPhragmen'
    value: ElectionsPhragmenCall
}

export interface Type_114_FinalityTracker {
    __kind: 'FinalityTracker'
    value: FinalityTrackerCall
}

export interface Type_114_Grandpa {
    __kind: 'Grandpa'
    value: GrandpaCall
}

export interface Type_114_Identity {
    __kind: 'Identity'
    value: IdentityCall
}

export interface Type_114_ImOnline {
    __kind: 'ImOnline'
    value: ImOnlineCall
}

export interface Type_114_Indices {
    __kind: 'Indices'
    value: IndicesCall
}

export interface Type_114_Offences {
    __kind: 'Offences'
    value: OffencesCall
}

export interface Type_114_Parachains {
    __kind: 'Parachains'
    value: ParachainsCall
}

export interface Type_114_Recovery {
    __kind: 'Recovery'
    value: RecoveryCall
}

export interface Type_114_Registrar {
    __kind: 'Registrar'
    value: RegistrarCall
}

export interface Type_114_Session {
    __kind: 'Session'
    value: SessionCall
}

export interface Type_114_Slots {
    __kind: 'Slots'
    value: SlotsCall
}

export interface Type_114_Society {
    __kind: 'Society'
    value: SocietyCall
}

export interface Type_114_Staking {
    __kind: 'Staking'
    value: StakingCall
}

export interface Type_114_System {
    __kind: 'System'
    value: SystemCall
}

export interface Type_114_TechnicalCommittee {
    __kind: 'TechnicalCommittee'
    value: TechnicalCommitteeCall
}

export interface Type_114_TechnicalMembership {
    __kind: 'TechnicalMembership'
    value: TechnicalMembershipCall
}

export interface Type_114_Timestamp {
    __kind: 'Timestamp'
    value: TimestampCall
}

export interface Type_114_Treasury {
    __kind: 'Treasury'
    value: TreasuryCall
}

export interface Type_114_Utility {
    __kind: 'Utility'
    value: UtilityCall
}
