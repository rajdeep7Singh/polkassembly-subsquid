...
export type Call = Call_System | Call_ParachainSystem | Call_Timestamp | Call_Balances | Call_Authorship | Call_Session | Call_Multisig | Call_Proxy | Call_Utility | Call_Scheduler | Call_Council | Call_Elections | Call_Democracy | Call_Identity | Call_Vesting | Call_Preimage | Call_Treasury | Call_Fees | Call_Anchor | Call_Claims | Call_Nfts | Call_Bridge | Call_Migration | Call_CrowdloanClaim | Call_CrowdloanReward | Call_Tokens | Call_XcmpQueue | Call_PolkadotXcm | Call_DmpQueue | Call_XTokens | Call_ChainBridge | Call_OrmlAssetRegistry
...
export type Type_223 = Type_223_Relay | Type_223_SiblingParachain

export interface Type_223_Relay {
    __kind: 'Relay'
}

export interface Type_223_SiblingParachain {
