...
export type ClaimType = ClaimType_Accredited | ClaimType_Affiliate | ClaimType_BuyLockup | ClaimType_SellLockup | ClaimType_CustomerDueDiligence | ClaimType_KnowYourCustomer | ClaimType_Jurisdiction | ClaimType_Exempted | ClaimType_Blocked | ClaimType_InvestorUniqueness | ClaimType_NoType | ClaimType_InvestorUniquenessV2
