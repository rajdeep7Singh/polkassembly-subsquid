...
export type Type_164 = Type_164_Member | Type_164_Members | Type_164__Phantom

export interface Type_164_Member {
    __kind: 'Member'
    value: AccountId32
}

export interface Type_164_Members {
    __kind: 'Members'
    value: [number, number]
}

export interface Type_164__Phantom {
    __kind: '_Phantom'
}
