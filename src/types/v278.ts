...
export type Call = Call_AssetHandler | Call_Assets | Call_Authorship | Call_Babe | Call_Balances | Call_Bounties | Call_ChainBridge | Call_ChildBounties | Call_Council | Call_Democracy | Call_ElectionProviderMultiPhase | Call_Elections | Call_Grandpa | Call_Identity | Call_ImOnline | Call_Indices | Call_Multisig | Call_OCEX | Call_OrderbookCommittee | Call_OrmlVesting | Call_PDEXMigration | Call_Preimage | Call_Proxy | Call_Recovery | Call_Scheduler | Call_Session | Call_Staking | Call_Sudo | Call_System | Call_TechnicalCommittee | Call_TechnicalMembership | Call_Timestamp | Call_Treasury | Call_Utility
...
export type Type_331 = Type_331_Member | Type_331_Members | Type_331__Phantom
...
export type Type_332 = Type_332_Member | Type_332_Members | Type_332__Phantom
...
export interface StakingCall_set_staking_configs {
    ...
    maxNominatorCount: Type_214
    maxValidatorCount: Type_214
    chillThreshold: Type_215
    minCommission: Type_216
}
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type OCEXCall = OCEXCall_add_proxy_account | OCEXCall_allowlist_enclave | OCEXCall_allowlist_token | OCEXCall_claim_withdraw | OCEXCall_close_trading_pair | OCEXCall_collect_fees | OCEXCall_deposit | OCEXCall_insert_enclave | OCEXCall_open_trading_pair | OCEXCall_register_enclave | OCEXCall_register_main_account | OCEXCall_register_trading_pair | OCEXCall_remove_allowlisted_token | OCEXCall_remove_proxy_account | OCEXCall_set_balances | OCEXCall_set_exchange_state | OCEXCall_shutdown | OCEXCall_submit_snapshot | OCEXCall_update_certificate | OCEXCall_update_trading_pair
...
export interface EnclaveSnapshot {
    ...
    eventId: bigint
    snapshotHash: H256
    withdrawals: [AccountId32, Withdrawal[]][]
    fees: Fees[]
}
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type ChainBridgeCall = ChainBridgeCall_acknowledge_proposal | ChainBridgeCall_add_relayer | ChainBridgeCall_allowlist_chain | ChainBridgeCall_eval_vote_state | ChainBridgeCall_reject_proposal | ChainBridgeCall_remove_relayer | ChainBridgeCall_remove_resource | ChainBridgeCall_set_resource | ChainBridgeCall_set_threshold
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type AssetHandlerCall = AssetHandlerCall_add_precision | AssetHandlerCall_allowlist_token | AssetHandlerCall_create_asset | AssetHandlerCall_mint_asset | AssetHandlerCall_remove_allowlisted_token | AssetHandlerCall_set_block_delay | AssetHandlerCall_set_bridge_status | AssetHandlerCall_update_fee | AssetHandlerCall_withdraw
...
export type PrecisionType = PrecisionType_HighPrecision | PrecisionType_LowPrecision | PrecisionType_SamePrecision
...
export const OriginCaller: sts.Type<OriginCaller> = sts.closedEnum(() => {
    return  {
        Council: Type_330,
        OrderbookCommittee: Type_332,
        TechnicalCommittee: Type_331,
        Void: Void,
        system: RawOrigin,
    }
})
...
export const OCEXCall: sts.Type<OCEXCall> = sts.closedEnum(() => {
    return  {
        ...
        allowlist_enclave: sts.enumStruct({
            enclaveAccountId: AccountId32,
        }),
        ...
        update_certificate: sts.enumStruct({
            certificateValidUntil: sts.bigint(),
        }),
...
export const EnclaveSnapshot: sts.Type<EnclaveSnapshot> = sts.struct(() => {
    return  {
        snapshotNumber: sts.number(),
        enclaveId: AccountId32,
        eventId: sts.bigint(),
        snapshotHash: H256,
        withdrawals: sts.array(() => sts.tuple(() => [AccountId32, sts.array(() => Withdrawal)])),
        fees: sts.array(() => Fees),
    }
})

export const Fees: sts.Type<Fees> = sts.struct(() => {
    return  {
        asset: AssetId,
        amount: Decimal,
    }
...
export const ChainBridgeCall: sts.Type<ChainBridgeCall> = sts.closedEnum(() => {
    return  {
        ...
        allowlist_chain: sts.enumStruct({
            id: sts.number(),
        }),
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export const AssetHandlerCall: sts.Type<AssetHandlerCall> = sts.closedEnum(() => {
    return  {
        add_precision: sts.enumStruct({
            rid: sts.bytes(),
            precisionType: PrecisionType,
        }),
        allowlist_token: sts.enumStruct({
        ...
        mint_asset: sts.enumStruct({
            destinationAdd: sts.bytes(),
            amount: sts.bigint(),
            rid: sts.bytes(),
        }),
        remove_allowlisted_token: sts.enumStruct({
        ...
        set_block_delay: sts.enumStruct({
            noOfBlocks: sts.number(),
        }),
        set_bridge_status: sts.enumStruct({
            status: sts.boolean(),
        }),
        update_fee: sts.enumStruct({
            chainId: sts.number(),
            minFee: sts.bigint(),
            feeScale: sts.number(),
        }),
...
export const PrecisionType: sts.Type<PrecisionType> = sts.closedEnum(() => {
    return  {
        HighPrecision: sts.bigint(),
        LowPrecision: sts.bigint(),
        SamePrecision: sts.unit(),
    }
})
