...
export type Call = Call_System | Call_Timestamp | Call_Utility | Call_Multisig | Call_Balances | Call_Assets | Call_Proxy | Call_Identity | Call_Sudo | Call_Democracy | Call_GeneralCouncil | Call_TechnicalCommittee | Call_Treasury | Call_Scheduler | Call_Preimage | Call_ParachainSystem | Call_XcmpQueue | Call_DmpQueue | Call_PolkadotXcm | Call_CumulusXcm | Call_Authorship | Call_CollatorSelection | Call_Session | Call_Oracle | Call_XTokens | Call_OrmlXcm | Call_Vesting | Call_Loans | Call_Prices | Call_Crowdloans | Call_LiquidStaking | Call_NomineeElection | Call_GeneralCouncilMembership | Call_TechnicalCommitteeMembership | Call_OracleMembership | Call_LiquidStakingAgentsMembership | Call_BridgeMembership | Call_AMM | Call_AMMRoute | Call_CurrencyAdapter | Call_Bridge | Call_EmergencyShutdown | Call_Farming | Call_XcmHelper
...
export interface Call_NomineeElection {
    __kind: 'NomineeElection'
    value: NomineeElectionCall
}
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type LoansCall = LoansCall_add_market | LoansCall_activate_market | LoansCall_update_rate_model | LoansCall_update_market | LoansCall_force_update_market | LoansCall_mint | LoansCall_redeem | LoansCall_redeem_all | LoansCall_borrow | LoansCall_repay_borrow | LoansCall_repay_borrow_all | LoansCall_collateral_asset | LoansCall_liquidate_borrow | LoansCall_add_reserves | LoansCall_reduce_reserves
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type PricesCall = PricesCall_set_price | PricesCall_reset_price
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type CrowdloansCall = CrowdloansCall_create_vault | CrowdloansCall_update_vault | CrowdloansCall_open | CrowdloansCall_contribute | CrowdloansCall_set_vrfs | CrowdloansCall_close | CrowdloansCall_reopen | CrowdloansCall_auction_succeeded | CrowdloansCall_auction_failed | CrowdloansCall_claim | CrowdloansCall_withdraw | CrowdloansCall_redeem | CrowdloansCall_slot_expired | CrowdloansCall_migrate_pending | CrowdloansCall_notification_received | CrowdloansCall_refund | CrowdloansCall_dissolve_vault
 ...
 */
export interface CrowdloansCall_set_vrfs {
    __kind: 'set_vrfs'
    vrfs: number[]
}
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type LiquidStakingCall = LiquidStakingCall_stake | LiquidStakingCall_unstake | LiquidStakingCall_update_reserve_factor | LiquidStakingCall_update_market_cap | LiquidStakingCall_settlement | LiquidStakingCall_bond | LiquidStakingCall_bond_extra | LiquidStakingCall_unbond | LiquidStakingCall_rebond | LiquidStakingCall_withdraw_unbonded | LiquidStakingCall_nominate | LiquidStakingCall_notification_received | LiquidStakingCall_claim_for
 ...
 */
export interface LiquidStakingCall_update_market_cap {
    __kind: 'update_market_cap'
    cap: bigint
}
 ...
 * relay-chain.
 */
export interface LiquidStakingCall_settlement {
    __kind: 'settlement'
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type NomineeElectionCall = NomineeElectionCall_set_validators
 ...
 */
export interface NomineeElectionCall_set_validators {
    __kind: 'set_validators'
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type AMMCall = AMMCall_add_liquidity | AMMCall_remove_liquidity | AMMCall_create_pool
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type BridgeCall = BridgeCall_set_vote_threshold | BridgeCall_register_chain | BridgeCall_unregister_chain | BridgeCall_register_bridge_token | BridgeCall_unregister_bridge_token | BridgeCall_set_bridge_token_fee | BridgeCall_teleport | BridgeCall_materialize

/**
 * Set the threshold required to reach multi-signature consensus
 */
export interface BridgeCall_set_vote_threshold {
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type EmergencyShutdownCall = EmergencyShutdownCall_toggle_shutdown_flag

/**
 * Toggle the shutdown flag
 */
export interface EmergencyShutdownCall_toggle_shutdown_flag {
    __kind: 'toggle_shutdown_flag'
}

/**
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type FarmingCall = FarmingCall_create | FarmingCall_set_pool_status | FarmingCall_set_pool_lock_duration | FarmingCall_deposit | FarmingCall_withdraw | FarmingCall_redeem | FarmingCall_claim | FarmingCall_dispatch_reward
 ...
 */
export interface FarmingCall_set_pool_lock_duration {
    __kind: 'set_pool_lock_duration'
    asset: number
    rewardAsset: number
    lockDuration: number
}
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type XcmHelperCall = XcmHelperCall_update_xcm_fees | XcmHelperCall_update_xcm_weight

/**
 * Update xcm fees amount to be used in xcm.Withdraw message
 */
export interface XcmHelperCall_update_xcm_fees {
    __kind: 'update_xcm_fees'
    fees: bigint
}
 ...
 */
export interface XcmHelperCall_update_xcm_weight {
    __kind: 'update_xcm_weight'
    xcmWeightMisc: XcmWeightMisc
}
...
export type OriginCaller = OriginCaller_system | OriginCaller_GeneralCouncil | OriginCaller_TechnicalCommittee | OriginCaller_PolkadotXcm | OriginCaller_CumulusXcm | OriginCaller_Void
...
export type Type_256 = Type_256_V0 | Type_256_V1 | Type_256_V2

export interface Type_256_V0 {
    __kind: 'V0'
    value: Type_257
}

export interface Type_256_V1 {
    __kind: 'V1'
    value: Type_262
}
...
export type ContributionStrategy = ContributionStrategy_XCM
...
export interface XcmWeightMisc {
    bondWeight: bigint
    bondExtraWeight: bigint
    unbondWeight: bigint
    rebondWeight: bigint
    withdrawUnbondedWeight: bigint
    nominateWeight: bigint
    contributeWeight: bigint
    withdrawWeight: bigint
    addMemoWeight: bigint
}
...
export type Type_257 = Type_257_WithdrawAsset | Type_257_ReserveAssetDeposit | Type_257_TeleportAsset | Type_257_QueryResponse | Type_257_TransferAsset | Type_257_TransferReserveAsset | Type_257_Transact | Type_257_HrmpNewChannelOpenRequest | Type_257_HrmpChannelAccepted | Type_257_HrmpChannelClosing | Type_257_RelayedFrom
...
export interface Type_257_ReserveAssetDeposit {
    __kind: 'ReserveAssetDeposit'
    assets: V0MultiAsset[]
    effects: Type_259[]
}

export interface Type_257_TeleportAsset {
    __kind: 'TeleportAsset'
    assets: V0MultiAsset[]
    effects: Type_259[]
}
...
export type Type_262 = Type_262_WithdrawAsset | Type_262_ReserveAssetDeposited | Type_262_ReceiveTeleportedAsset | Type_262_QueryResponse | Type_262_TransferAsset | Type_262_TransferReserveAsset | Type_262_Transact | Type_262_HrmpNewChannelOpenRequest | Type_262_HrmpChannelAccepted | Type_262_HrmpChannelClosing | Type_262_RelayedFrom | Type_262_SubscribeVersion | Type_262_UnsubscribeVersion
...
export interface Type_262_ReserveAssetDeposited {
    __kind: 'ReserveAssetDeposited'
    assets: V1MultiAsset[]
    effects: Type_264[]
}

export interface Type_262_ReceiveTeleportedAsset {
    __kind: 'ReceiveTeleportedAsset'
    assets: V1MultiAsset[]
    effects: Type_264[]
}
...
export interface Type_262_SubscribeVersion {
    __kind: 'SubscribeVersion'
    queryId: bigint
    maxResponseWeight: bigint
}

export interface Type_262_UnsubscribeVersion {
    __kind: 'UnsubscribeVersion'
}

export type Type_268 = Type_268_WithdrawAsset | Type_268_ReserveAssetDeposited | Type_268_ReceiveTeleportedAsset | Type_268_QueryResponse | Type_268_TransferAsset | Type_268_TransferReserveAsset | Type_268_Transact | Type_268_HrmpNewChannelOpenRequest | Type_268_HrmpChannelAccepted | Type_268_HrmpChannelClosing | Type_268_ClearOrigin | Type_268_DescendOrigin | Type_268_ReportError | Type_268_DepositAsset | Type_268_DepositReserveAsset | Type_268_ExchangeAsset | Type_268_InitiateReserveWithdraw | Type_268_InitiateTeleport | Type_268_QueryHolding | Type_268_BuyExecution | Type_268_RefundSurplus | Type_268_SetErrorHandler | Type_268_SetAppendix | Type_268_ClearError | Type_268_ClaimAsset | Type_268_Trap | Type_268_SubscribeVersion | Type_268_UnsubscribeVersion
...
export type Type_259 = Type_259_Null | Type_259_DepositAsset | Type_259_DepositReserveAsset | Type_259_ExchangeAsset | Type_259_InitiateReserveWithdraw | Type_259_InitiateTeleport | Type_259_QueryHolding | Type_259_BuyExecution

export interface Type_259_Null {
    __kind: 'Null'
}
...
export type Type_264 = Type_264_Noop | Type_264_DepositAsset | Type_264_DepositReserveAsset | Type_264_ExchangeAsset | Type_264_InitiateReserveWithdraw | Type_264_InitiateTeleport | Type_264_QueryHolding | Type_264_BuyExecution

export interface Type_264_Noop {
    __kind: 'Noop'
}
