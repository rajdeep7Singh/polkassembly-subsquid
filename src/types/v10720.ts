...
export type Call = Call_System | Call_Timestamp | Call_Indices | Call_Balances | Call_Authorship | Call_ParachainStaking | Call_Session | Call_Democracy | Call_Council | Call_TechnicalCommittee | Call_TechnicalMembership | Call_Treasury | Call_RelayMigration | Call_DynFilter | Call_Utility | Call_Vesting | Call_Scheduler | Call_Proxy | Call_Preimage | Call_TipsMembership | Call_Tips | Call_Ctype | Call_Attestation | Call_Delegation | Call_Did | Call_DidLookup | Call_Web3Names | Call_ParachainSystem | Call_XcmpQueue | Call_PolkadotXcm | Call_DmpQueue
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type RelayMigrationCall = RelayMigrationCall_send_swap_call_bytes | RelayMigrationCall_enable_strict_relay_number_check | RelayMigrationCall_disable_strict_relay_number_check
