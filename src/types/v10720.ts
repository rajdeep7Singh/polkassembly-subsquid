...
export type Call = Call_Attestation | Call_Authorship | Call_Balances | Call_Council | Call_Ctype | Call_Delegation | Call_Democracy | Call_Did | Call_DidLookup | Call_DmpQueue | Call_DynFilter | Call_Indices | Call_ParachainStaking | Call_ParachainSystem | Call_PolkadotXcm | Call_Preimage | Call_Proxy | Call_RelayMigration | Call_Scheduler | Call_Session | Call_System | Call_TechnicalCommittee | Call_TechnicalMembership | Call_Timestamp | Call_Tips | Call_TipsMembership | Call_Treasury | Call_Utility | Call_Vesting | Call_Web3Names | Call_XcmpQueue
...
export interface Call_DynFilter {
    __kind: 'DynFilter'
    value: DynFilterCall
}
...
export interface Call_RelayMigration {
    __kind: 'RelayMigration'
    value: RelayMigrationCall
}
...
export type Type_240 = Type_240_Relay | Type_240_SiblingParachain

export interface Type_240_Relay {
    __kind: 'Relay'
}

export interface Type_240_SiblingParachain {
...
export type Type_236 = Type_236_Member | Type_236_Members | Type_236__Phantom
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type RelayMigrationCall = RelayMigrationCall_disable_strict_relay_number_check | RelayMigrationCall_enable_strict_relay_number_check | RelayMigrationCall_send_swap_call_bytes
 ...
 */
export interface RelayMigrationCall_disable_strict_relay_number_check {
    __kind: 'disable_strict_relay_number_check'
}
 ...
 */
export interface RelayMigrationCall_enable_strict_relay_number_check {
    __kind: 'enable_strict_relay_number_check'
}
 ...
 * Has to be done pre migration.
 */
export interface RelayMigrationCall_send_swap_call_bytes {
    __kind: 'send_swap_call_bytes'
    relayCall: Bytes
    relayBalance: bigint
    maxWeight: bigint
}
...
export type Type_327 = Type_327_BuyExecution | Type_327_ClaimAsset | Type_327_ClearError | Type_327_ClearOrigin | Type_327_DepositAsset | Type_327_DepositReserveAsset | Type_327_DescendOrigin | Type_327_ExchangeAsset | Type_327_HrmpChannelAccepted | Type_327_HrmpChannelClosing | Type_327_HrmpNewChannelOpenRequest | Type_327_InitiateReserveWithdraw | Type_327_InitiateTeleport | Type_327_QueryHolding | Type_327_QueryResponse | Type_327_ReceiveTeleportedAsset | Type_327_RefundSurplus | Type_327_ReportError | Type_327_ReserveAssetDeposited | Type_327_SetAppendix | Type_327_SetErrorHandler | Type_327_SubscribeVersion | Type_327_Transact | Type_327_TransferAsset | Type_327_TransferReserveAsset | Type_327_Trap | Type_327_UnsubscribeVersion | Type_327_WithdrawAsset
...
export type Type_321 = Type_321_HrmpChannelAccepted | Type_321_HrmpChannelClosing | Type_321_HrmpNewChannelOpenRequest | Type_321_QueryResponse | Type_321_ReceiveTeleportedAsset | Type_321_RelayedFrom | Type_321_ReserveAssetDeposited | Type_321_SubscribeVersion | Type_321_Transact | Type_321_TransferAsset | Type_321_TransferReserveAsset | Type_321_UnsubscribeVersion | Type_321_WithdrawAsset
...
export type Type_323 = Type_323_BuyExecution | Type_323_DepositAsset | Type_323_DepositReserveAsset | Type_323_ExchangeAsset | Type_323_InitiateReserveWithdraw | Type_323_InitiateTeleport | Type_323_Noop | Type_323_QueryHolding
...
export type Type_316 = Type_316_HrmpChannelAccepted | Type_316_HrmpChannelClosing | Type_316_HrmpNewChannelOpenRequest | Type_316_QueryResponse | Type_316_RelayedFrom | Type_316_ReserveAssetDeposit | Type_316_TeleportAsset | Type_316_Transact | Type_316_TransferAsset | Type_316_TransferReserveAsset | Type_316_WithdrawAsset
...
export type Type_318 = Type_318_BuyExecution | Type_318_DepositAsset | Type_318_DepositReserveAsset | Type_318_ExchangeAsset | Type_318_InitiateReserveWithdraw | Type_318_InitiateTeleport | Type_318_Null | Type_318_QueryHolding
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type DynFilterCall = DynFilterCall_set_filter

export interface DynFilterCall_set_filter {
    __kind: 'set_filter'
...
export const Call: sts.Type<Call> = sts.closedEnum(() => {
    return  {
        ...
        Proxy: ProxyCall,
        RelayMigration: RelayMigrationCall,
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export const RelayMigrationCall: sts.Type<RelayMigrationCall> = sts.closedEnum(() => {
    return  {
        disable_strict_relay_number_check: sts.unit(),
        enable_strict_relay_number_check: sts.unit(),
        send_swap_call_bytes: sts.enumStruct({
            relayCall: sts.bytes(),
            relayBalance: sts.bigint(),
...
export const Type_323: sts.Type<Type_323> = sts.closedEnum(() => {
    return  {
        BuyExecution: sts.enumStruct({
            ...
            debt: sts.bigint(),
            haltOnError: sts.boolean(),
            instructions: sts.array(() => Type_321),
        }),
        DepositAsset: sts.enumStruct({
            assets: V1MultiAssetFilter,
            maxAssets: sts.number(),
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export const DynFilterCall: sts.Type<DynFilterCall> = sts.closedEnum(() => {
    return  {
        set_filter: sts.enumStruct({
            filter: FilterSettings,
        }),
    }
})

export const FilterSettings: sts.Type<FilterSettings> = sts.struct(() => {
    return  {
        transferDisabled: sts.boolean(),
        featureDisabled: sts.boolean(),
        xcmDisabled: sts.boolean(),
    }
})
