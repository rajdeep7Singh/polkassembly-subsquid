 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type IbcCall = IbcCall_add_channels_to_feeless_channel_list | IbcCall_deliver | IbcCall_freeze_client | IbcCall_increase_counters | IbcCall_remove_channels_from_feeless_channel_list | IbcCall_transfer | IbcCall_upgrade_client
