...
export interface StakingCall_set_staking_configs {
    ...
    maxNominatorCount: Type_199
    maxValidatorCount: Type_199
    chillThreshold: Type_200
    minCommission: Type_201
}
...
export type Type_199 = Type_199_Noop | Type_199_Remove | Type_199_Set

export interface Type_199_Noop {
    __kind: 'Noop'
}

export interface Type_199_Remove {
    __kind: 'Remove'
}

export interface Type_199_Set {
    __kind: 'Set'
    value: number
}
