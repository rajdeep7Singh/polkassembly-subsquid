...
export type Call = Call_System | Call_Timestamp | Call_Utility | Call_Multisig | Call_Balances | Call_Assets | Call_Proxy | Call_Sudo | Call_Democracy | Call_GeneralCouncil | Call_TechnicalCommittee | Call_Treasury | Call_Scheduler | Call_ParachainSystem | Call_XcmpQueue | Call_DmpQueue | Call_PolkadotXcm | Call_CumulusXcm | Call_Authorship | Call_CollatorSelection | Call_Session | Call_Oracle | Call_XTokens | Call_OrmlXcm | Call_Vesting | Call_Loans | Call_Prices | Call_LiquidStaking | Call_NomineeElection | Call_GeneralCouncilMembership | Call_TechnicalCommitteeMembership | Call_OracleMembership | Call_ValidatorFeedersMembership | Call_AMM | Call_AMMRoute | Call_CurrencyAdapter
...
export interface Call_ValidatorFeedersMembership {
    __kind: 'ValidatorFeedersMembership'
    value: ValidatorFeedersMembershipCall
}
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type LiquidStakingCall = LiquidStakingCall_stake | LiquidStakingCall_unstake | LiquidStakingCall_record_staking_settlement | LiquidStakingCall_update_xcm_fees_compensation | LiquidStakingCall_update_reserve_factor | LiquidStakingCall_update_xcm_weight | LiquidStakingCall_update_staking_pool_capacity | LiquidStakingCall_payout_slashed | LiquidStakingCall_settlement | LiquidStakingCall_bond | LiquidStakingCall_bond_extra | LiquidStakingCall_unbond | LiquidStakingCall_rebond | LiquidStakingCall_withdraw_unbonded | LiquidStakingCall_nominate | LiquidStakingCall_set_liquid_currency | LiquidStakingCall_set_staking_currency | LiquidStakingCall_add_insurances
 ...
 */
export interface LiquidStakingCall_record_staking_settlement {
    __kind: 'record_staking_settlement'
    amount: bigint
 ...
 */
export interface LiquidStakingCall_update_xcm_fees_compensation {
    __kind: 'update_xcm_fees_compensation'
    fees: bigint
}
 ...
 */
export interface LiquidStakingCall_update_xcm_weight {
 ...
 */
export interface LiquidStakingCall_update_staking_pool_capacity {
    __kind: 'update_staking_pool_capacity'
    cap: bigint
}
 ...
 * chain.
 */
export interface LiquidStakingCall_payout_slashed {
    __kind: 'payout_slashed'
}
 ...
 */
export interface LiquidStakingCall_set_liquid_currency {
    __kind: 'set_liquid_currency'
    assetId: number
}
 ...
 */
export interface LiquidStakingCall_set_staking_currency {
    __kind: 'set_staking_currency'
    assetId: number
}
 ...
 */
export interface LiquidStakingCall_add_insurances {
    __kind: 'add_insurances'
    amount: bigint
}
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type ValidatorFeedersMembershipCall = ValidatorFeedersMembershipCall_add_member | ValidatorFeedersMembershipCall_remove_member | ValidatorFeedersMembershipCall_swap_member | ValidatorFeedersMembershipCall_reset_members | ValidatorFeedersMembershipCall_change_key | ValidatorFeedersMembershipCall_set_prime | ValidatorFeedersMembershipCall_clear_prime
 ...
 * May only be called from `T::AddOrigin`.
 */
export interface ValidatorFeedersMembershipCall_add_member {
    __kind: 'add_member'
    who: Uint8Array
}
 ...
 * May only be called from `T::RemoveOrigin`.
 */
export interface ValidatorFeedersMembershipCall_remove_member {
    __kind: 'remove_member'
    who: Uint8Array
}
 ...
 * Prime membership is *not* passed from `remove` to `add`, if extant.
 */
export interface ValidatorFeedersMembershipCall_swap_member {
    __kind: 'swap_member'
    remove: Uint8Array
    add: Uint8Array
}
 ...
 * May only be called from `T::ResetOrigin`.
 */
export interface ValidatorFeedersMembershipCall_reset_members {
    __kind: 'reset_members'
    members: Uint8Array[]
}
 ...
 * Prime membership is passed from the origin account to `new`, if extant.
 */
export interface ValidatorFeedersMembershipCall_change_key {
    __kind: 'change_key'
    new: Uint8Array
}
 ...
 * May only be called from `T::PrimeOrigin`.
 */
export interface ValidatorFeedersMembershipCall_set_prime {
    __kind: 'set_prime'
    who: Uint8Array
}
 ...
 * May only be called from `T::PrimeOrigin`.
 */
export interface ValidatorFeedersMembershipCall_clear_prime {
    __kind: 'clear_prime'
}
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type AMMRouteCall = AMMRouteCall_trade
 ...
 * - `expiry`:
 */
export interface AMMRouteCall_trade {
    __kind: 'trade'
    route: [number, number][]
    amountIn: bigint
    minAmountOut: bigint
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type CurrencyAdapterCall = never
...
export type StakingSettlementKind = StakingSettlementKind_Reward | StakingSettlementKind_Slash

export interface StakingSettlementKind_Reward {
    __kind: 'Reward'
}

export interface StakingSettlementKind_Slash {
    __kind: 'Slash'
}
