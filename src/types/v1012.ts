...
export type Call = Call_System | Call_ParachainSystem | Call_Timestamp | Call_Balances | Call_CollatorSelection | Call_Authorship | Call_Session | Call_Multisig | Call_Proxy | Call_Utility | Call_Scheduler | Call_Council | Call_Elections | Call_Democracy | Call_Identity | Call_Vesting | Call_Preimage | Call_Treasury | Call_Fees | Call_Anchor | Call_Claims | Call_Nfts | Call_Bridge | Call_Migration | Call_CrowdloanClaim | Call_CrowdloanReward | Call_Tokens | Call_CollatorAllowlist | Call_XcmpQueue | Call_PolkadotXcm | Call_DmpQueue | Call_XTokens | Call_ChainBridge | Call_OrmlAssetRegistry | Call_OrmlXcm
...
export interface Call_Fees {
    __kind: 'Fees'
    value: FeesCall
}

export interface Call_Anchor {
    __kind: 'Anchor'
    value: AnchorCall
}
...
export interface Call_CrowdloanClaim {
    __kind: 'CrowdloanClaim'
    value: CrowdloanClaimCall
}

export interface Call_CrowdloanReward {
    __kind: 'CrowdloanReward'
    value: CrowdloanRewardCall
}
...
export interface Call_CollatorAllowlist {
    __kind: 'CollatorAllowlist'
    value: CollatorAllowlistCall
}
...
export interface Call_OrmlAssetRegistry {
    __kind: 'OrmlAssetRegistry'
    value: OrmlAssetRegistryCall
}
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type FeesCall = FeesCall_set_fee

/**
 * Set the given fee for the key
 */
export interface FeesCall_set_fee {
    __kind: 'set_fee'
    key: FeeKey
    fee: bigint
}
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type AnchorCall = AnchorCall_pre_commit | AnchorCall_commit | AnchorCall_evict_pre_commits | AnchorCall_evict_anchors
 ...
 */
export interface AnchorCall_pre_commit {
    __kind: 'pre_commit'
    anchorId: Uint8Array
 ...
 * [Centrifuge Protocol Paper](https://staticw.centrifuge.io/assets/centrifuge_os_protocol_paper.pdf)
 */
export interface AnchorCall_commit {
    __kind: 'commit'
    anchorIdPreimage: Uint8Array
    docRoot: Uint8Array
    proof: Uint8Array
    storedUntilDate: bigint
}
 ...
 */
export interface AnchorCall_evict_pre_commits {
    __kind: 'evict_pre_commits'
    anchorIds: Uint8Array[]
}
 ...
 */
export interface AnchorCall_evict_anchors {
    __kind: 'evict_anchors'
}

/**
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type ClaimsCall = ClaimsCall_claim | ClaimsCall_set_upload_account | ClaimsCall_store_root_hash
 ...
 * # </weight>
 */
export interface ClaimsCall_set_upload_account {
    __kind: 'set_upload_account'
    accountId: Uint8Array
}
 ...
 * # </weight>
 */
export interface ClaimsCall_store_root_hash {
    __kind: 'store_root_hash'
    rootHash: Uint8Array
}
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type NftsCall = NftsCall_validate_mint
 ...
 * # </weight>
 */
export interface NftsCall_validate_mint {
    __kind: 'validate_mint'
    anchorId: Uint8Array
    depositAddress: Uint8Array
    proofs: Proof[]
    staticProofs: Uint8Array[]
    destId: number
}
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type BridgeCall = BridgeCall_transfer_native | BridgeCall_transfer | BridgeCall_remark | BridgeCall_set_native_token_transfer_fee | BridgeCall_set_nft_token_transfer_fee

/**
 * Transfers some amount of the native token to some recipient on a (whitelisted) destination chain.
 */
export interface BridgeCall_transfer_native {
 ...
 */
export interface BridgeCall_transfer {
    __kind: 'transfer'
    to: Uint8Array
    amount: bigint
    rId: Uint8Array
 ...
 */
export interface BridgeCall_remark {
    __kind: 'remark'
    hash: Uint8Array
    rId: Uint8Array
}
 ...
 */
export interface BridgeCall_set_native_token_transfer_fee {
    __kind: 'set_native_token_transfer_fee'
    newFee: bigint
}
 ...
 */
export interface BridgeCall_set_nft_token_transfer_fee {
    __kind: 'set_nft_token_transfer_fee'
    newFee: bigint
}
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type MigrationCall = MigrationCall_migrate_system_account | MigrationCall_migrate_balances_issuance | MigrationCall_migrate_vesting_vesting | MigrationCall_migrate_proxy_proxies | MigrationCall_finalize
 ...
 * off-chain.
 */
export interface MigrationCall_migrate_system_account {
    __kind: 'migrate_system_account'
    accounts: [Uint8Array, Uint8Array][]
}
 ...
 */
export interface MigrationCall_migrate_balances_issuance {
    __kind: 'migrate_balances_issuance'
    additionalIssuance: bigint
}
 ...
 * on this chain.
 */
export interface MigrationCall_migrate_vesting_vesting {
    __kind: 'migrate_vesting_vesting'
    vestings: [Uint8Array, VestingInfo][]
}
 ...
 */
export interface MigrationCall_migrate_proxy_proxies {
    __kind: 'migrate_proxy_proxies'
    proxies: [Uint8Array, bigint, [ProxyDefinition[], bigint]][]
}

/**
 * Update the migration status to `Complete`
 */
export interface MigrationCall_finalize {
    __kind: 'finalize'
}
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type CrowdloanClaimCall = CrowdloanClaimCall_claim_reward | CrowdloanClaimCall_initialize | CrowdloanClaimCall_set_lease_start | CrowdloanClaimCall_set_lease_period | CrowdloanClaimCall_set_contributions_root | CrowdloanClaimCall_set_locked_at | CrowdloanClaimCall_set_crowdloan_trie_index

/**
 * Claim for a reward payout
 * 
 */
export interface CrowdloanClaimCall_claim_reward {
    __kind: 'claim_reward'
    relaychainAccountId: Uint8Array
    parachainAccountId: Uint8Array
    identityProof: MultiSignature
 ...
 * well.
 */
export interface CrowdloanClaimCall_initialize {
    __kind: 'initialize'
 ...
 */
export interface CrowdloanClaimCall_set_lease_start {
    __kind: 'set_lease_start'
    start: number
}
 ...
 */
export interface CrowdloanClaimCall_set_lease_period {
    __kind: 'set_lease_period'
    period: number
}
 ...
 */
export interface CrowdloanClaimCall_set_contributions_root {
    __kind: 'set_contributions_root'
    root: Uint8Array
}
 ...
 */
export interface CrowdloanClaimCall_set_locked_at {
    __kind: 'set_locked_at'
    lockedAt: number
}
 ...
 */
export interface CrowdloanClaimCall_set_crowdloan_trie_index {
    __kind: 'set_crowdloan_trie_index'
    trieIndex: number
}
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type CrowdloanRewardCall = CrowdloanRewardCall_initialize | CrowdloanRewardCall_set_vesting_start | CrowdloanRewardCall_set_vesting_period | CrowdloanRewardCall_set_direct_payout_ratio

/**
 * A on call init. Basically a composition of the setters below
 */
export interface CrowdloanRewardCall_initialize {
    __kind: 'initialize'
    directPayoutRatio: number
 ...
 */
export interface CrowdloanRewardCall_set_vesting_start {
    __kind: 'set_vesting_start'
    start: number
}
 ...
 * UpdateVestingPeriod
 */
export interface CrowdloanRewardCall_set_vesting_period {
    __kind: 'set_vesting_period'
    period: number
}
 ...
 */
export interface CrowdloanRewardCall_set_direct_payout_ratio {
    __kind: 'set_direct_payout_ratio'
    ratio: number
}
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type TokensCall = TokensCall_transfer | TokensCall_transfer_keep_alive | TokensCall_transfer_all | TokensCall_force_transfer | TokensCall_set_balance
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type CollatorAllowlistCall = CollatorAllowlistCall_add | CollatorAllowlistCall_remove
 ...
 */
export interface CollatorAllowlistCall_add {
    __kind: 'add'
 ...
 */
export interface CollatorAllowlistCall_remove {
    __kind: 'remove'
    collatorId: Uint8Array
}
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type OrmlAssetRegistryCall = OrmlAssetRegistryCall_register_asset | OrmlAssetRegistryCall_update_asset

export interface OrmlAssetRegistryCall_register_asset {
    __kind: 'register_asset'
    metadata: AssetMetadata
    assetId: (CurrencyId | undefined)
}

export interface OrmlAssetRegistryCall_update_asset {
    __kind: 'update_asset'
    assetId: CurrencyId
...
export type ProxyType = ProxyType_Any | ProxyType_NonTransfer | ProxyType_Governance | ProxyType__Staking | ProxyType_NonProxy
...
export interface ProxyType__Staking {
    __kind: '_Staking'
}

export interface ProxyType_NonProxy {
    __kind: 'NonProxy'
}
...
export type FeeKey = FeeKey_AnchorsCommit | FeeKey_AnchorsPreCommit | FeeKey_BridgeNativeTransfer | FeeKey_NftProofValidation

export interface FeeKey_AnchorsCommit {
    __kind: 'AnchorsCommit'
}

export interface FeeKey_AnchorsPreCommit {
    __kind: 'AnchorsPreCommit'
}

export interface FeeKey_BridgeNativeTransfer {
    __kind: 'BridgeNativeTransfer'
}

export interface FeeKey_NftProofValidation {
    __kind: 'NftProofValidation'
}
...
export type CurrencyId = CurrencyId_Native | CurrencyId_Tranche | CurrencyId_KSM | CurrencyId_AUSD | CurrencyId_ForeignAsset

export interface CurrencyId_Native {
    __kind: 'Native'
}

export interface CurrencyId_Tranche {
    __kind: 'Tranche'
...
export type Type_332 = Type_332_V0 | Type_332_V1 | Type_332_V2

export interface Type_332_V0 {
    __kind: 'V0'
    value: Type_333
}

export interface Type_332_V1 {
    __kind: 'V1'
    value: Type_338
}
...
export type Type_333 = Type_333_WithdrawAsset | Type_333_ReserveAssetDeposit | Type_333_TeleportAsset | Type_333_QueryResponse | Type_333_TransferAsset | Type_333_TransferReserveAsset | Type_333_Transact | Type_333_HrmpNewChannelOpenRequest | Type_333_HrmpChannelAccepted | Type_333_HrmpChannelClosing | Type_333_RelayedFrom
...
export interface Type_333_ReserveAssetDeposit {
    __kind: 'ReserveAssetDeposit'
    assets: V0MultiAsset[]
    effects: Type_335[]
}

export interface Type_333_TeleportAsset {
    __kind: 'TeleportAsset'
    assets: V0MultiAsset[]
    effects: Type_335[]
}
...
export interface Type_333_RelayedFrom {
    __kind: 'RelayedFrom'
    who: V0MultiLocation
    message: Type_333
}

export type Type_338 = Type_338_WithdrawAsset | Type_338_ReserveAssetDeposited | Type_338_ReceiveTeleportedAsset | Type_338_QueryResponse | Type_338_TransferAsset | Type_338_TransferReserveAsset | Type_338_Transact | Type_338_HrmpNewChannelOpenRequest | Type_338_HrmpChannelAccepted | Type_338_HrmpChannelClosing | Type_338_RelayedFrom | Type_338_SubscribeVersion | Type_338_UnsubscribeVersion
...
export type Type_344 = Type_344_WithdrawAsset | Type_344_ReserveAssetDeposited | Type_344_ReceiveTeleportedAsset | Type_344_QueryResponse | Type_344_TransferAsset | Type_344_TransferReserveAsset | Type_344_Transact | Type_344_HrmpNewChannelOpenRequest | Type_344_HrmpChannelAccepted | Type_344_HrmpChannelClosing | Type_344_ClearOrigin | Type_344_DescendOrigin | Type_344_ReportError | Type_344_DepositAsset | Type_344_DepositReserveAsset | Type_344_ExchangeAsset | Type_344_InitiateReserveWithdraw | Type_344_InitiateTeleport | Type_344_QueryHolding | Type_344_BuyExecution | Type_344_RefundSurplus | Type_344_SetErrorHandler | Type_344_SetAppendix | Type_344_ClearError | Type_344_ClaimAsset | Type_344_Trap | Type_344_SubscribeVersion | Type_344_UnsubscribeVersion
...
export type Type_335 = Type_335_Null | Type_335_DepositAsset | Type_335_DepositReserveAsset | Type_335_ExchangeAsset | Type_335_InitiateReserveWithdraw | Type_335_InitiateTeleport | Type_335_QueryHolding | Type_335_BuyExecution

export interface Type_335_Null {
    __kind: 'Null'
}
...
export type Type_340 = Type_340_Noop | Type_340_DepositAsset | Type_340_DepositReserveAsset | Type_340_ExchangeAsset | Type_340_InitiateReserveWithdraw | Type_340_InitiateTeleport | Type_340_QueryHolding | Type_340_BuyExecution
