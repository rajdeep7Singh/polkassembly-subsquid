...
export type Type_34 = Type_34_System | Type_34_Utility | Type_34_Timestamp | Type_34_Balances | Type_34_Sudo | Type_34_RandomnessCollectiveFlip | Type_34_ParachainSystem | Type_34_EVM | Type_34_Ethereum | Type_34_ParachainStaking | Type_34_Scheduler | Type_34_Democracy | Type_34_CouncilCollective | Type_34_TechComitteeCollective | Type_34_Treasury | Type_34_AuthorInherent | Type_34_AuthorFilter | Type_34_CrowdloanRewards | Type_34_AuthorMapping | Type_34_Proxy

export interface Type_34_System {
    __kind: 'System'
    value: SystemCall
}

export interface Type_34_Utility {
    __kind: 'Utility'
    value: UtilityCall
}

export interface Type_34_Timestamp {
    __kind: 'Timestamp'
    value: TimestampCall
}

export interface Type_34_Balances {
    __kind: 'Balances'
    value: BalancesCall
}

export interface Type_34_Sudo {
    __kind: 'Sudo'
    value: SudoCall
}

export interface Type_34_RandomnessCollectiveFlip {
    __kind: 'RandomnessCollectiveFlip'
    value: RandomnessCollectiveFlipCall
}

export interface Type_34_ParachainSystem {
    __kind: 'ParachainSystem'
    value: ParachainSystemCall
}

export interface Type_34_EVM {
    __kind: 'EVM'
    value: EVMCall
}

export interface Type_34_Ethereum {
    __kind: 'Ethereum'
    value: EthereumCall
}

export interface Type_34_ParachainStaking {
    __kind: 'ParachainStaking'
    value: ParachainStakingCall
}

export interface Type_34_Scheduler {
    __kind: 'Scheduler'
    value: SchedulerCall
}

export interface Type_34_Democracy {
    __kind: 'Democracy'
    value: DemocracyCall
}

export interface Type_34_CouncilCollective {
    __kind: 'CouncilCollective'
    value: CouncilCollectiveCall
}

export interface Type_34_TechComitteeCollective {
    __kind: 'TechComitteeCollective'
    value: TechComitteeCollectiveCall
}

export interface Type_34_Treasury {
    __kind: 'Treasury'
    value: TreasuryCall
}

export interface Type_34_AuthorInherent {
    __kind: 'AuthorInherent'
    value: AuthorInherentCall
}

export interface Type_34_AuthorFilter {
    __kind: 'AuthorFilter'
    value: AuthorFilterCall
}

export interface Type_34_CrowdloanRewards {
    __kind: 'CrowdloanRewards'
    value: CrowdloanRewardsCall
}

export interface Type_34_AuthorMapping {
    __kind: 'AuthorMapping'
    value: AuthorMappingCall
}

export interface Type_34_Proxy {
    __kind: 'Proxy'
    value: ProxyCall
}
