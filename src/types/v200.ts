...
export type Call = Call_Authorship | Call_Balances | Call_CollatorSelection | Call_Council | Call_CouncilMembership | Call_CumulusXcm | Call_Democracy | Call_DmpQueue | Call_Indices | Call_LiquidCrowdloan | Call_ParachainSystem | Call_PolkadotXcm | Call_Scheduler | Call_Session | Call_Sudo | Call_System | Call_Timestamp | Call_Tokens | Call_Treasury | Call_Utility | Call_XcmpQueue
...
export type Type_187 = Type_187_BuyExecution | Type_187_ClaimAsset | Type_187_ClearError | Type_187_ClearOrigin | Type_187_DepositAsset | Type_187_DepositReserveAsset | Type_187_DescendOrigin | Type_187_ExchangeAsset | Type_187_HrmpChannelAccepted | Type_187_HrmpChannelClosing | Type_187_HrmpNewChannelOpenRequest | Type_187_InitiateReserveWithdraw | Type_187_InitiateTeleport | Type_187_QueryHolding | Type_187_QueryResponse | Type_187_ReceiveTeleportedAsset | Type_187_RefundSurplus | Type_187_ReportError | Type_187_ReserveAssetDeposited | Type_187_SetAppendix | Type_187_SetErrorHandler | Type_187_SubscribeVersion | Type_187_Transact | Type_187_TransferAsset | Type_187_TransferReserveAsset | Type_187_Trap | Type_187_UnsubscribeVersion | Type_187_WithdrawAsset
...
export interface Type_180 {
    encoded: Bytes
}

export type Type_181 = Type_181_HrmpChannelAccepted | Type_181_HrmpChannelClosing | Type_181_HrmpNewChannelOpenRequest | Type_181_QueryResponse | Type_181_ReceiveTeleportedAsset | Type_181_RelayedFrom | Type_181_ReserveAssetDeposited | Type_181_SubscribeVersion | Type_181_Transact | Type_181_TransferAsset | Type_181_TransferReserveAsset | Type_181_UnsubscribeVersion | Type_181_WithdrawAsset
...
export type Type_183 = Type_183_BuyExecution | Type_183_DepositAsset | Type_183_DepositReserveAsset | Type_183_ExchangeAsset | Type_183_InitiateReserveWithdraw | Type_183_InitiateTeleport | Type_183_Noop | Type_183_QueryHolding
...
export type Type_176 = Type_176_HrmpChannelAccepted | Type_176_HrmpChannelClosing | Type_176_HrmpNewChannelOpenRequest | Type_176_QueryResponse | Type_176_RelayedFrom | Type_176_ReserveAssetDeposit | Type_176_TeleportAsset | Type_176_Transact | Type_176_TransferAsset | Type_176_TransferReserveAsset | Type_176_WithdrawAsset
...
export type Type_178 = Type_178_BuyExecution | Type_178_DepositAsset | Type_178_DepositReserveAsset | Type_178_ExchangeAsset | Type_178_InitiateReserveWithdraw | Type_178_InitiateTeleport | Type_178_Null | Type_178_QueryHolding
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type LiquidCrowdloanCall = LiquidCrowdloanCall_claim | LiquidCrowdloanCall_make_claimable
...
export const Call: sts.Type<Call> = sts.closedEnum(() => {
    return  {
        ...
        Indices: IndicesCall,
        LiquidCrowdloan: LiquidCrowdloanCall,
...
export const Type_187: sts.Type<Type_187> = sts.closedEnum(() => {
    return  {
        ...
        ReserveAssetDeposited: sts.array(() => V1MultiAsset),
        SetAppendix: sts.array(() => Type_187),
        SetErrorHandler: sts.array(() => Type_187),
        SubscribeVersion: sts.enumStruct({
            queryId: sts.bigint(),
            maxResponseWeight: sts.bigint(),
        }),
...
export const Type_180: sts.Type<Type_180> = sts.struct(() => {
    return  {
        encoded: sts.bytes(),
    }
})
...
export const Type_183: sts.Type<Type_183> = sts.closedEnum(() => {
    return  {
        BuyExecution: sts.enumStruct({
            ...
            debt: sts.bigint(),
            haltOnError: sts.boolean(),
            instructions: sts.array(() => Type_181),
        }),
        DepositAsset: sts.enumStruct({
            assets: V1MultiAssetFilter,
            maxAssets: sts.number(),
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export const LiquidCrowdloanCall: sts.Type<LiquidCrowdloanCall> = sts.closedEnum(() => {
    return  {
        claim: sts.enumStruct({
            amount: sts.bigint(),
        }),
        make_claimable: sts.unit(),
    }
})
