...
export interface LoansCall_update_market_reward_speed {
    ...
    assetId: number
    supplyRewardPerBlock: bigint
    borrowRewardPerBlock: bigint
}
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type XcmHelperCall = XcmHelperCall_update_xcm_weight_fee | XcmHelperCall_withdraw | XcmHelperCall_contribute | XcmHelperCall_bond | XcmHelperCall_bond_extra | XcmHelperCall_unbond | XcmHelperCall_rebond | XcmHelperCall_withdraw_unbonded | XcmHelperCall_nominate | XcmHelperCall_send_as_sovereign | XcmHelperCall_ump_transact | XcmHelperCall_add_proxy | XcmHelperCall_remove_proxy
...
export interface XcmHelperCall_withdraw {
    __kind: 'withdraw'
    paraId: number
    paraAccountId: Uint8Array
    notify: Call
}

export interface XcmHelperCall_contribute {
    __kind: 'contribute'
    paraId: number
    amount: bigint
    who: Uint8Array
...
export interface XcmHelperCall_bond {
    __kind: 'bond'
    value: bigint
    payee: RewardDestination
    stash: Uint8Array
...
export interface XcmHelperCall_bond_extra {
    __kind: 'bond_extra'
    value: bigint
    stash: Uint8Array
    index: number
...
export interface XcmHelperCall_unbond {
    __kind: 'unbond'
    value: bigint
    index: number
    notify: Call
...
export interface XcmHelperCall_rebond {
    __kind: 'rebond'
    value: bigint
    index: number
    notify: Call
...
export interface XcmHelperCall_withdraw_unbonded {
    __kind: 'withdraw_unbonded'
    numSlashingSpans: number
    paraAccountId: Uint8Array
    index: number
...
export interface XcmHelperCall_nominate {
    __kind: 'nominate'
    targets: Uint8Array[]
    index: number
    notify: Call
...
export interface XcmHelperCall_send_as_sovereign {
    __kind: 'send_as_sovereign'
    dest: VersionedMultiLocation
    message: VersionedXcm
}

export interface XcmHelperCall_ump_transact {
    __kind: 'ump_transact'
    call: DoubleEncoded
    weight: bigint
...
export interface XcmHelperCall_add_proxy {
    __kind: 'add_proxy'
    delegate: Uint8Array
    proxyType: (Type_300 | undefined)
    delay: number
    notify: Call
}

export interface XcmHelperCall_remove_proxy {
    __kind: 'remove_proxy'
    delegate: Uint8Array
    proxyType: (Type_300 | undefined)
    delay: number
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type StreamingCall = StreamingCall_create_stream | StreamingCall_cancel_stream | StreamingCall_withdraw_from_stream | StreamingCall_set_minimum_deposit

/**
 * Create a stream
 */
export interface StreamingCall_create_stream {
    __kind: 'create_stream'
 ...
 */
export interface StreamingCall_cancel_stream {
    __kind: 'cancel_stream'
    streamId: bigint
}
 ...
 */
export interface StreamingCall_withdraw_from_stream {
    __kind: 'withdraw_from_stream'
    streamId: bigint
    amount: bigint
}
...
export type Type_300 = Type_300_Any | Type_300_NonTransfer | Type_300_Governance | Type_300_Staking

export interface Type_300_Any {
    __kind: 'Any'
}

export interface Type_300_NonTransfer {
    __kind: 'NonTransfer'
}

export interface Type_300_Governance {
    __kind: 'Governance'
}

export interface Type_300_Staking {
    __kind: 'Staking'
}
