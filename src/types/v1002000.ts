...
export type Type_695 = Type_695_Approved | Type_695_Cancelled | Type_695_Killed | Type_695_Ongoing | Type_695_Rejected | Type_695_TimedOut

export interface Type_695_Approved {
    __kind: 'Approved'
    value: [number, (Deposit | undefined), (Deposit | undefined)]
}

export interface Type_695_Cancelled {
    __kind: 'Cancelled'
    value: [number, (Deposit | undefined), (Deposit | undefined)]
}

export interface Type_695_Killed {
    __kind: 'Killed'
    value: number
}

export interface Type_695_Ongoing {
    __kind: 'Ongoing'
    value: Type_696
}

export interface Type_695_Rejected {
    __kind: 'Rejected'
    value: [number, (Deposit | undefined), (Deposit | undefined)]
}

export interface Type_695_TimedOut {
    __kind: 'TimedOut'
    value: [number, (Deposit | undefined), (Deposit | undefined)]
}

export interface Type_696 {
    track: number
    origin: OriginCaller
    proposal: Bounded
...
export const Type_695: sts.Type<Type_695> = sts.closedEnum(() => {
    return  {
...
export const Type_696: sts.Type<Type_696> = sts.struct(() => {
    return  {
        track: sts.number(),
        origin: OriginCaller,
        proposal: Bounded,
