...
export type Call = Call_System | Call_ParachainSystem | Call_Utility | Call_Timestamp | Call_EqSessionManager | Call_Session | Call_EqAssets | Call_Oracle | Call_EqTreasury | Call_Treasury | Call_EqBalances | Call_Bailsman | Call_Whitelists | Call_EqRate | Call_Republic | Call_EqInvestors | Call_EqLiquidityFarming | Call_Vesting | Call_Vesting2 | Call_Claims | Call_Subaccounts | Call_Financial | Call_ChainBridge | Call_EqBridge | Call_EqMultisigSudo | Call_EqMarginCall | Call_EqDex | Call_EqLending | Call_EqLockdrop | Call_Multisig | Call_Proxy | Call_EqMarketMaker | Call_Migration | Call_CurveAmm | Call_PolkadotXcm | Call_DmpQueue | Call_XcmpQueue | Call_EqWrappedDot | Call_Preimage | Call_Scheduler | Call_Council | Call_CouncilMembership | Call_TechnicalCommittee | Call_TechnicalCommitteeMembership | Call_Democracy | Call_EqStaking | Call_EqCrowdLoanDots | Call_QSwap | Call_VestingQSwap
...
export interface Call_EqCrowdLoanDots {
    __kind: 'EqCrowdLoanDots'
    value: EqCrowdLoanDotsCall
}

export interface Call_QSwap {
    __kind: 'QSwap'
    value: QSwapCall
}

export interface Call_VestingQSwap {
    __kind: 'VestingQSwap'
    value: VestingQSwapCall
}
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type VestingCall = VestingCall_vest | VestingCall_vest_other | VestingCall_force_vested_transfer | VestingCall_set_accounts_per_block_removed
 ...
 */
export interface VestingCall_set_accounts_per_block_removed {
    __kind: 'set_accounts_per_block_removed'
    accountPerBlock: number
}

/**
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type Vesting2Call = Vesting2Call_vest | Vesting2Call_vest_other | Vesting2Call_force_vested_transfer | Vesting2Call_set_accounts_per_block_removed
 ...
 * Sets number of accounts to be used in on_initialize vesting removals.
 */
export interface Vesting2Call_set_accounts_per_block_removed {
    __kind: 'set_accounts_per_block_removed'
    accountPerBlock: number
}
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type EqCrowdLoanDotsCall = EqCrowdLoanDotsCall_allow_crowdloan_swap | EqCrowdLoanDotsCall_swap_crowdloan_dots

export interface EqCrowdLoanDotsCall_allow_crowdloan_swap {
    __kind: 'allow_crowdloan_swap'
    assets: CrowdloanDotAsset[]
}

export interface EqCrowdLoanDotsCall_swap_crowdloan_dots {
    __kind: 'swap_crowdloan_dots'
    mbWho: (Uint8Array | undefined)
    assets: CrowdloanDotAsset[]
}
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type QSwapCall = QSwapCall_set_config | QSwapCall_swap

export interface QSwapCall_set_config {
    __kind: 'set_config'
    mbMaxQAmount: (bigint | undefined)
    mbQSwapConfigurations: ([bigint, SwapConfigurationInput][] | undefined)
}

export interface QSwapCall_swap {
    __kind: 'swap'
    asset: bigint
    amount: bigint
}
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type VestingQSwapCall = VestingQSwapCall_vest | VestingQSwapCall_vest_other | VestingQSwapCall_force_vested_transfer | VestingQSwapCall_set_accounts_per_block_removed
 ...
 * Emits either `VestingCompleted` or `VestingUpdated`.
 */
export interface VestingQSwapCall_vest {
    __kind: 'vest'
}
 ...
 * Emits either `VestingCompleted` or `VestingUpdated`.
 */
export interface VestingQSwapCall_vest_other {
    __kind: 'vest_other'
    target: MultiAddress
}
 ...
 * - `schedule`: The vesting schedule attached to the transfer.
 */
export interface VestingQSwapCall_force_vested_transfer {
    __kind: 'force_vested_transfer'
    source: MultiAddress
    target: MultiAddress
    schedule: VestingInfo
 ...
 * Sets number of accounts to be used in on_initialize vesting removals.
 */
export interface VestingQSwapCall_set_accounts_per_block_removed {
    __kind: 'set_accounts_per_block_removed'
    accountPerBlock: number
}
...
export type Type_332 = Type_332_V2 | Type_332_V3
...
export type CrowdloanDotAsset = CrowdloanDotAsset_XDOT | CrowdloanDotAsset_XDOT2 | CrowdloanDotAsset_XDOT3 | CrowdloanDotAsset_CDOT613 | CrowdloanDotAsset_CDOT714 | CrowdloanDotAsset_CDOT815

export interface CrowdloanDotAsset_XDOT {
    __kind: 'XDOT'
}

export interface CrowdloanDotAsset_XDOT2 {
    __kind: 'XDOT2'
}

export interface CrowdloanDotAsset_XDOT3 {
    __kind: 'XDOT3'
}

export interface CrowdloanDotAsset_CDOT613 {
    __kind: 'CDOT613'
}

export interface CrowdloanDotAsset_CDOT714 {
    __kind: 'CDOT714'
}

export interface CrowdloanDotAsset_CDOT815 {
    __kind: 'CDOT815'
}

export interface SwapConfigurationInput {
    mbEnabled: (boolean | undefined)
    mbMinAmount: (bigint | undefined)
    mbQRatio: (bigint | undefined)
    mbVestingShare: (number | undefined)
    mbVestingStartingBlock: (number | undefined)
    mbVestingDurationBlocks: (bigint | undefined)
}
...
export type Type_339 = Type_339_WithdrawAsset | Type_339_ReserveAssetDeposited | Type_339_ReceiveTeleportedAsset | Type_339_QueryResponse | Type_339_TransferAsset | Type_339_TransferReserveAsset | Type_339_Transact | Type_339_HrmpNewChannelOpenRequest | Type_339_HrmpChannelAccepted | Type_339_HrmpChannelClosing | Type_339_ClearOrigin | Type_339_DescendOrigin | Type_339_ReportError | Type_339_DepositAsset | Type_339_DepositReserveAsset | Type_339_ExchangeAsset | Type_339_InitiateReserveWithdraw | Type_339_InitiateTeleport | Type_339_ReportHolding | Type_339_BuyExecution | Type_339_RefundSurplus | Type_339_SetErrorHandler | Type_339_SetAppendix | Type_339_ClearError | Type_339_ClaimAsset | Type_339_Trap | Type_339_SubscribeVersion | Type_339_UnsubscribeVersion | Type_339_BurnAsset | Type_339_ExpectAsset | Type_339_ExpectOrigin | Type_339_ExpectError | Type_339_ExpectTransactStatus | Type_339_QueryPallet | Type_339_ExpectPallet | Type_339_ReportTransactStatus | Type_339_ClearTransactStatus | Type_339_UniversalOrigin | Type_339_ExportMessage | Type_339_LockAsset | Type_339_UnlockAsset | Type_339_NoteUnlockable | Type_339_RequestUnlock | Type_339_SetFeesMode | Type_339_SetTopic | Type_339_ClearTopic | Type_339_AliasOrigin | Type_339_UnpaidExecution
