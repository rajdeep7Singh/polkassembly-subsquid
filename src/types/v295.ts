...
export type Type_280 = Type_280_Approve | Type_280_Rebid | Type_280_Reject
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type ContractsCall = ContractsCall_call | ContractsCall_instantiate | ContractsCall_instantiate_with_code
