...
export type Type_521 = Type_521_Endorsed

export interface Type_521_Endorsed {
    __kind: 'Endorsed'
}

export type Type_520 = Type_520_Endorsed

export interface Type_520_Endorsed {
    __kind: 'Endorsed'
}

export type Type_519 = Type_519_Endorsed

export interface Type_519_Endorsed {
    __kind: 'Endorsed'
}
...
export const OriginCaller: sts.Type<OriginCaller> = sts.closedEnum(() => {
    return  {
        PolymeshCommittee: Type_519,
        TechnicalCommittee: Type_520,
        UpgradeCommittee: Type_521,
        Void: Void,
        system: RawOrigin,
    }
})
...
export const Type_520: sts.Type<Type_520> = sts.closedEnum(() => {
    return  {
        Endorsed: sts.unit(),
    }
})
