...
export type Call = Call_Attestation | Call_Balances | Call_Council | Call_Ctype | Call_Delegation | Call_Democracy | Call_Did | Call_DidLookup | Call_DmpQueue | Call_Indices | Call_ParachainStaking | Call_ParachainSystem | Call_PolkadotXcm | Call_Preimage | Call_Proxy | Call_PublicCredentials | Call_Scheduler | Call_Session | Call_System | Call_TechnicalCommittee | Call_TechnicalMembership | Call_Timestamp | Call_Tips | Call_TipsMembership | Call_Treasury | Call_Utility | Call_Vesting | Call_Web3Names | Call_XcmpQueue
...
export type Type_252 = Type_252_Relay | Type_252_SiblingParachain

export interface Type_252_Relay {
    __kind: 'Relay'
}

export interface Type_252_SiblingParachain {
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type DidLookupCall = DidLookupCall_associate_account | DidLookupCall_associate_sender | DidLookupCall_change_deposit_owner | DidLookupCall_migrate | DidLookupCall_reclaim_deposit | DidLookupCall_remove_account_association | DidLookupCall_remove_sender_association | DidLookupCall_update_deposit
 ...
 */
export interface DidLookupCall_migrate {
    __kind: 'migrate'
    limit: number
}
