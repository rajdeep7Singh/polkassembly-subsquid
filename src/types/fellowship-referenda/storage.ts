...
export const referendumInfoFor =  {
     ...
     *  Information concerning any given referendum.
     */
    v1002000: new StorageType('FellowshipReferenda.ReferendumInfoFor', 'Optional', [sts.number()], v1002000.Type_695) as ReferendumInfoForV1002000,
    /**
     *  Information concerning any given referendum.
     */
    v1005000: new StorageType('FellowshipReferenda.ReferendumInfoFor', 'Optional', [sts.number()], v1005000.Type_696) as ReferendumInfoForV1005000,
}
...
export interface ReferendumInfoForV1002000  {
    is(block: RuntimeCtx): boolean
    get(block: Block, key: number): Promise<(v1002000.Type_695 | undefined)>
    getMany(block: Block, keys: number[]): Promise<(v1002000.Type_695 | undefined)[]>
    getKeys(block: Block): Promise<number[]>
    getKeys(block: Block, key: number): Promise<number[]>
    getKeysPaged(pageSize: number, block: Block): AsyncIterable<number[]>
    getKeysPaged(pageSize: number, block: Block, key: number): AsyncIterable<number[]>
    getPairs(block: Block): Promise<[k: number, v: (v1002000.Type_695 | undefined)][]>
    getPairs(block: Block, key: number): Promise<[k: number, v: (v1002000.Type_695 | undefined)][]>
    getPairsPaged(pageSize: number, block: Block): AsyncIterable<[k: number, v: (v1002000.Type_695 | undefined)][]>
    getPairsPaged(pageSize: number, block: Block, key: number): AsyncIterable<[k: number, v: (v1002000.Type_695 | undefined)][]>
}
...
export interface ReferendumInfoForV1005000  {
    is(block: RuntimeCtx): boolean
    get(block: Block, key: number): Promise<(v1005000.Type_696 | undefined)>
    getMany(block: Block, keys: number[]): Promise<(v1005000.Type_696 | undefined)[]>
    getKeys(block: Block): Promise<number[]>
    getKeys(block: Block, key: number): Promise<number[]>
    getKeysPaged(pageSize: number, block: Block): AsyncIterable<number[]>
    getKeysPaged(pageSize: number, block: Block, key: number): AsyncIterable<number[]>
    getPairs(block: Block): Promise<[k: number, v: (v1005000.Type_696 | undefined)][]>
    getPairs(block: Block, key: number): Promise<[k: number, v: (v1005000.Type_696 | undefined)][]>
    getPairsPaged(pageSize: number, block: Block): AsyncIterable<[k: number, v: (v1005000.Type_696 | undefined)][]>
    getPairsPaged(pageSize: number, block: Block, key: number): AsyncIterable<[k: number, v: (v1005000.Type_696 | undefined)][]>
}
