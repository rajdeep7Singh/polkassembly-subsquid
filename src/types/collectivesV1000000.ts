...
export interface ClaimantStatus {
    lastActive: number
    status: ClaimState
}

export type ClaimState = ClaimState_Attempted | ClaimState_Nothing | ClaimState_Registered

export interface ClaimState_Attempted {
    __kind: 'Attempted'
...
export interface ClaimState_Nothing {
    __kind: 'Nothing'
}

export interface ClaimState_Registered {
    __kind: 'Registered'
    value: bigint
}

export const ClaimantStatus: sts.Type<ClaimantStatus> = sts.struct(() => {
    return  {
        lastActive: sts.number(),
        status: ClaimState,
    }
})

export const ClaimState: sts.Type<ClaimState> = sts.closedEnum(() => {
    return  {
        Attempted: sts.enumStruct({
            registered: sts.option(() => sts.bigint()),
            id: sts.bigint(),
            amount: sts.bigint(),
        }),
        Nothing: sts.unit(),
        Registered: sts.bigint(),
    }
})
...
export const StatusType: sts.Type<StatusType> = sts.struct(() => {
    return  {
        cycleIndex: sts.number(),
        cycleStart: sts.number(),
        budget: sts.bigint(),
        totalRegistrations: sts.bigint(),
        totalUnregisteredPaid: sts.bigint(),
    }
})
...
export type Type_184 = Type_184_Architects | Type_184_Fellows | Type_184_Fellowship2Dan | Type_184_Fellowship5Dan | Type_184_Fellowship6Dan | Type_184_Fellowship8Dan | Type_184_Fellowship9Dan | Type_184_Masters | Type_184_Members | Type_184_PromoteTo1Dan | Type_184_PromoteTo2Dan | Type_184_PromoteTo3Dan | Type_184_PromoteTo4Dan | Type_184_PromoteTo5Dan | Type_184_PromoteTo6Dan | Type_184_RetainAt1Dan | Type_184_RetainAt2Dan | Type_184_RetainAt3Dan | Type_184_RetainAt4Dan | Type_184_RetainAt5Dan | Type_184_RetainAt6Dan
...
export type Type_183 = Type_183_Member | Type_183_Members | Type_183__Phantom
...
export const OriginCaller: sts.Type<OriginCaller> = sts.closedEnum(() => {
    return  {
        AllianceMotion: Type_183,
        CumulusXcm: Type_182,
        FellowshipOrigins: Type_184,
        PolkadotXcm: Origin,
        Void: Void,
        system: RawOrigin,
    }
...
export type Call = Call_Alliance | Call_AllianceMotion | Call_Balances | Call_CollatorSelection | Call_DmpQueue | Call_FellowshipCollective | Call_FellowshipCore | Call_FellowshipReferenda | Call_FellowshipSalary | Call_Multisig | Call_ParachainSystem | Call_PolkadotXcm | Call_Preimage | Call_Proxy | Call_Scheduler | Call_Session | Call_System | Call_Timestamp | Call_Utility | Call_XcmpQueue
...
export type Type_174 = Type_174_AliasOrigin | Type_174_BurnAsset | Type_174_BuyExecution | Type_174_ClaimAsset | Type_174_ClearError | Type_174_ClearOrigin | Type_174_ClearTopic | Type_174_ClearTransactStatus | Type_174_DepositAsset | Type_174_DepositReserveAsset | Type_174_DescendOrigin | Type_174_ExchangeAsset | Type_174_ExpectAsset | Type_174_ExpectError | Type_174_ExpectOrigin | Type_174_ExpectPallet | Type_174_ExpectTransactStatus | Type_174_ExportMessage | Type_174_HrmpChannelAccepted | Type_174_HrmpChannelClosing | Type_174_HrmpNewChannelOpenRequest | Type_174_InitiateReserveWithdraw | Type_174_InitiateTeleport | Type_174_LockAsset | Type_174_NoteUnlockable | Type_174_QueryPallet | Type_174_QueryResponse | Type_174_ReceiveTeleportedAsset | Type_174_RefundSurplus | Type_174_ReportError | Type_174_ReportHolding | Type_174_ReportTransactStatus | Type_174_RequestUnlock | Type_174_ReserveAssetDeposited | Type_174_SetAppendix | Type_174_SetErrorHandler | Type_174_SetFeesMode | Type_174_SetTopic | Type_174_SubscribeVersion | Type_174_Transact | Type_174_TransferAsset | Type_174_TransferReserveAsset | Type_174_Trap | Type_174_UniversalOrigin | Type_174_UnlockAsset | Type_174_UnpaidExecution | Type_174_UnsubscribeVersion | Type_174_WithdrawAsset
...
export interface Type_171 {
    encoded: Bytes
}

export type Type_170 = Type_170_BuyExecution | Type_170_ClaimAsset | Type_170_ClearError | Type_170_ClearOrigin | Type_170_DepositAsset | Type_170_DepositReserveAsset | Type_170_DescendOrigin | Type_170_ExchangeAsset | Type_170_HrmpChannelAccepted | Type_170_HrmpChannelClosing | Type_170_HrmpNewChannelOpenRequest | Type_170_InitiateReserveWithdraw | Type_170_InitiateTeleport | Type_170_QueryHolding | Type_170_QueryResponse | Type_170_ReceiveTeleportedAsset | Type_170_RefundSurplus | Type_170_ReportError | Type_170_ReserveAssetDeposited | Type_170_SetAppendix | Type_170_SetErrorHandler | Type_170_SubscribeVersion | Type_170_Transact | Type_170_TransferAsset | Type_170_TransferReserveAsset | Type_170_Trap | Type_170_UnsubscribeVersion | Type_170_WithdrawAsset
...
export const Type_167: sts.Type<Type_167> = sts.closedEnum(() => {
    return  {
        V2: sts.array(() => Type_170),
        V3: sts.array(() => Type_174),
    }
})
...
export const Type_174: sts.Type<Type_174> = sts.closedEnum(() => {
    return  {
        ...
        ReserveAssetDeposited: sts.array(() => V3MultiAsset),
        SetAppendix: sts.array(() => Type_174),
        SetErrorHandler: sts.array(() => Type_174),
        SetFeesMode: sts.enumStruct({
            jitWithdraw: sts.boolean(),
        }),
        SetTopic: sts.bytes(),
...
export const Type_171: sts.Type<Type_171> = sts.struct(() => {
    return  {
        encoded: sts.bytes(),
    }
})
...
export const Type_170: sts.Type<Type_170> = sts.closedEnum(() => {
    return  {
        ...
        ReserveAssetDeposited: sts.array(() => V2MultiAsset),
        SetAppendix: sts.array(() => Type_170),
        SetErrorHandler: sts.array(() => Type_170),
        SubscribeVersion: sts.enumStruct({
            queryId: sts.bigint(),
            maxResponseWeight: sts.bigint(),
        }),
