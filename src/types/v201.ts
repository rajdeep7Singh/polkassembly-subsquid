...
export type Call = Call_System | Call_Scheduler | Call_Babe | Call_Timestamp | Call_Balances | Call_Authorship | Call_Staking | Call_ElectionProviderMultiPhase | Call_Session | Call_Grandpa | Call_ImOnline | Call_Democracy | Call_Council | Call_TechnicalCommittee | Call_Elections | Call_TechnicalMembership | Call_Treasury | Call_Claims | Call_Vesting | Call_Utility | Call_Identity | Call_Proxy | Call_Bounties | Call_Tips | Call_ChainBridge | Call_Swap | Call_XXCmix | Call_XXEconomics | Call_XXCustody | Call_XXBetanetRewards | Call_XXPublic | Call_Multisig | Call_Recovery | Call_Assets | Call_Uniques
...
export interface Call_Swap {
    __kind: 'Swap'
    value: SwapCall
}

export interface Call_XXCmix {
    __kind: 'XXCmix'
    value: XXCmixCall
}

export interface Call_XXEconomics {
    __kind: 'XXEconomics'
    value: XXEconomicsCall
}

export interface Call_XXCustody {
    __kind: 'XXCustody'
    value: XXCustodyCall
}

export interface Call_XXBetanetRewards {
    __kind: 'XXBetanetRewards'
    value: XXBetanetRewardsCall
}

export interface Call_XXPublic {
    __kind: 'XXPublic'
    value: XXPublicCall
}
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type StakingCall = StakingCall_bond | StakingCall_bond_extra | StakingCall_unbond | StakingCall_withdraw_unbonded | StakingCall_validate | StakingCall_nominate | StakingCall_chill | StakingCall_set_controller | StakingCall_set_validator_count | StakingCall_increase_validator_count | StakingCall_scale_validator_count | StakingCall_force_no_eras | StakingCall_force_new_era | StakingCall_set_invulnerables | StakingCall_force_unstake | StakingCall_force_new_era_always | StakingCall_cancel_deferred_slash | StakingCall_payout_stakers | StakingCall_rebond | StakingCall_set_history_depth | StakingCall_reap_stash | StakingCall_kick | StakingCall_set_staking_limits | StakingCall_chill_other | StakingCall_set_cmix_id
 ...
 * # </weight>
 */
export interface StakingCall_set_cmix_id {
    __kind: 'set_cmix_id'
    cmixId: Uint8Array
}
 ...
 */
export type ClaimsCall = ClaimsCall_claim | ClaimsCall_mint_claim | ClaimsCall_claim_attest | ClaimsCall_attest | ClaimsCall_move_claim | ClaimsCall_set_vesting
...
export interface ClaimsCall_mint_claim {
    ...
    who: Uint8Array
    value: bigint
    vestingSchedules: ([bigint, bigint, number][] | undefined)
...
export interface ClaimsCall_set_vesting {
    __kind: 'set_vesting'
    who: Uint8Array
    vestingSchedules: ([bigint, bigint, number][] | undefined)
}
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type VestingCall = VestingCall_vest | VestingCall_vest_other | VestingCall_vested_transfer | VestingCall_force_vested_transfer | VestingCall_merge_schedules | VestingCall_admin_set_vesting
 ...
 * # </weight>
 */
export interface VestingCall_admin_set_vesting {
    __kind: 'admin_set_vesting'
    target: MultiAddress
 ...
 * Each variant of this enum maps to a dispatchable function from the associated module.
 */
export type SwapCall = SwapCall_transfer_native | SwapCall_transfer | SwapCall_set_swap_fee | SwapCall_set_fee_destination

/**
 * Transfers an amount of the native token to some recipient on a (whitelisted) destination chain.
 */
export interface SwapCall_transfer_native {
 ...
 */
export interface SwapCall_transfer {
    __kind: 'transfer'
    to: Uint8Array
    amount: bigint
}
 ...
 * Set swap fee
 */
export interface SwapCall_set_swap_fee {
    __kind: 'set_swap_fee'
    fee: bigint
}
 ...
 * Set fee destination
 */
export interface SwapCall_set_fee_destination {
    __kind: 'set_fee_destination'
    dest: Uint8Array
}
 ...
 * Each variant of this enum maps to a dispatchable function from the associated module.
 */
export type XXCmixCall = XXCmixCall_set_cmix_hashes | XXCmixCall_set_scheduling_account | XXCmixCall_set_next_cmix_variables | XXCmixCall_submit_cmix_points | XXCmixCall_submit_cmix_deductions | XXCmixCall_set_cmix_address_space | XXCmixCall_set_admin_permission
 ...
 * # </weight>
 */
export interface XXCmixCall_set_cmix_hashes {
    __kind: 'set_cmix_hashes'
    hashes: SoftwareHashes
}
 ...
 * # </weight>
 */
export interface XXCmixCall_set_scheduling_account {
    __kind: 'set_scheduling_account'
    who: Uint8Array
}
 ...
 * # </weight>
 */
export interface XXCmixCall_set_next_cmix_variables {
    __kind: 'set_next_cmix_variables'
    variables: Variables
}
 ...
 * # </weight>
 */
export interface XXCmixCall_submit_cmix_points {
    __kind: 'submit_cmix_points'
 ...
 * # </weight>
 */
export interface XXCmixCall_submit_cmix_deductions {
    __kind: 'submit_cmix_deductions'
    data: [Uint8Array, number][]
}
 ...
 * # </weight>
 */
export interface XXCmixCall_set_cmix_address_space {
    __kind: 'set_cmix_address_space'
    size: number
}
 ...
 * # </weight>
 */
export interface XXCmixCall_set_admin_permission {
    __kind: 'set_admin_permission'
    permission: number
}
 ...
 * Each variant of this enum maps to a dispatchable function from the associated module.
 */
export type XXEconomicsCall = XXEconomicsCall_set_inflation_params | XXEconomicsCall_set_interest_points | XXEconomicsCall_set_liquidity_rewards_stake | XXEconomicsCall_set_liquidity_rewards_balance
 ...
 * 
 */
export interface XXEconomicsCall_set_inflation_params {
    __kind: 'set_inflation_params'
    params: InflationFixedParams
}
 ...
 * 
 */
export interface XXEconomicsCall_set_interest_points {
    __kind: 'set_interest_points'
    points: IdealInterestPoint[]
}
 ...
 * 
 */
export interface XXEconomicsCall_set_liquidity_rewards_stake {
    __kind: 'set_liquidity_rewards_stake'
    amount: bigint
}
 ...
 * 
 */
export interface XXEconomicsCall_set_liquidity_rewards_balance {
    __kind: 'set_liquidity_rewards_balance'
    amount: bigint
}
 ...
 * Each variant of this enum maps to a dispatchable function from the associated module.
 */
export type XXCustodyCall = XXCustodyCall_payout | XXCustodyCall_custody_bond | XXCustodyCall_custody_bond_extra | XXCustodyCall_custody_set_controller | XXCustodyCall_custody_set_proxy | XXCustodyCall_team_custody_set_proxy | XXCustodyCall_add_custodian | XXCustodyCall_remove_custodian | XXCustodyCall_replace_team_member
 ...
 * 
 */
export interface XXCustodyCall_payout {
    __kind: 'payout'
    who: Uint8Array
}
 ...
 * 
 */
export interface XXCustodyCall_custody_bond {
    __kind: 'custody_bond'
    custody: Uint8Array
    controller: Uint8Array
    value: bigint
 ...
 * 
 */
export interface XXCustodyCall_custody_bond_extra {
    __kind: 'custody_bond_extra'
    custody: Uint8Array
    value: bigint
}
 ...
 * 
 */
export interface XXCustodyCall_custody_set_controller {
    __kind: 'custody_set_controller'
    custody: Uint8Array
    controller: Uint8Array
}
 ...
 * 
 */
export interface XXCustodyCall_custody_set_proxy {
    __kind: 'custody_set_proxy'
    custody: Uint8Array
    proxy: Uint8Array
}
 ...
 * 
 */
export interface XXCustodyCall_team_custody_set_proxy {
    __kind: 'team_custody_set_proxy'
    proxy: Uint8Array
}
 ...
 * 
 */
export interface XXCustodyCall_add_custodian {
    __kind: 'add_custodian'
 ...
 * 
 */
export interface XXCustodyCall_remove_custodian {
    __kind: 'remove_custodian'
    custodian: Uint8Array
}
 ...
 * 
 */
export interface XXCustodyCall_replace_team_member {
    __kind: 'replace_team_member'
    who: Uint8Array
    new: Uint8Array
}
 ...
 * Each variant of this enum maps to a dispatchable function from the associated module.
 */
export type XXBetanetRewardsCall = XXBetanetRewardsCall_select_option | XXBetanetRewardsCall_approve
 ...
 * 
 */
export interface XXBetanetRewardsCall_select_option {
    __kind: 'select_option'
    option: RewardOption
}
 ...
 * 
 */
export interface XXBetanetRewardsCall_approve {
    __kind: 'approve'
}
 ...
 * Each variant of this enum maps to a dispatchable function from the associated module.
 */
export type XXPublicCall = XXPublicCall_set_testnet_manager_account | XXPublicCall_set_sale_manager_account | XXPublicCall_testnet_distribute | XXPublicCall_sale_distribute
 ...
 * 
 */
export interface XXPublicCall_set_testnet_manager_account {
    __kind: 'set_testnet_manager_account'
    who: Uint8Array
}
 ...
 * 
 */
export interface XXPublicCall_set_sale_manager_account {
    __kind: 'set_sale_manager_account'
    who: Uint8Array
}
 ...
 * 
 */
export interface XXPublicCall_testnet_distribute {
    __kind: 'testnet_distribute'
    data: TransferData[]
}
 ...
 * 
 */
export interface XXPublicCall_sale_distribute {
    __kind: 'sale_distribute'
    data: TransferData[]
}
...
export type ProxyType = ProxyType_Any | ProxyType_NonTransfer | ProxyType_Governance | ProxyType_Staking | ProxyType_Voting
...
export interface ProxyType_Voting {
    __kind: 'Voting'
}

export interface SoftwareHashes {
    server: Uint8Array
    fatbin: Uint8Array
    libpow: Uint8Array
    gateway: Uint8Array
    scheduling: Uint8Array
    wrapper: Uint8Array
    udb: Uint8Array
...
export interface InflationFixedParams {
    minInflation: number
    idealStake: number
    falloff: number
}

export interface IdealInterestPoint {
    block: number
    interest: number
}

export type RewardOption = RewardOption_NoVesting | RewardOption_Vesting1Month | RewardOption_Vesting3Month | RewardOption_Vesting6Month | RewardOption_Vesting9Month

export interface RewardOption_NoVesting {
    __kind: 'NoVesting'
}

export interface RewardOption_Vesting1Month {
    __kind: 'Vesting1Month'
}

export interface RewardOption_Vesting3Month {
    __kind: 'Vesting3Month'
}

export interface RewardOption_Vesting6Month {
    __kind: 'Vesting6Month'
}

export interface RewardOption_Vesting9Month {
    __kind: 'Vesting9Month'
}

export interface TransferData {
    destination: Uint8Array
    amount: bigint
    schedules: ([bigint, bigint, number][] | undefined)
}
...
export interface Performance {
    period: bigint
    points: RewardPoints
    countries: [Uint8Array, number][]
    multipliers: [number, number][]
}

export interface Timeouts {
    precomputation: bigint
    realtime: bigint
