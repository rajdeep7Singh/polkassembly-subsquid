 ...
 */
export interface CrowdloansCall_force_claim_for {
    __kind: 'force_claim_for'
    dest: MultiAddress
    crowdloan: number
    leaseStart: number
    leaseEnd: number
 ...
 */
export interface CrowdloansCall_redeem_and_lend_for {
    __kind: 'redeem_and_lend_for'
    dest: MultiAddress
    crowdloan: number
    leaseStart: number
    leaseEnd: number
...
export type Type_277 = Type_277_V2 | Type_277_V3
...
export type Type_284 = Type_284_WithdrawAsset | Type_284_ReserveAssetDeposited | Type_284_ReceiveTeleportedAsset | Type_284_QueryResponse | Type_284_TransferAsset | Type_284_TransferReserveAsset | Type_284_Transact | Type_284_HrmpNewChannelOpenRequest | Type_284_HrmpChannelAccepted | Type_284_HrmpChannelClosing | Type_284_ClearOrigin | Type_284_DescendOrigin | Type_284_ReportError | Type_284_DepositAsset | Type_284_DepositReserveAsset | Type_284_ExchangeAsset | Type_284_InitiateReserveWithdraw | Type_284_InitiateTeleport | Type_284_ReportHolding | Type_284_BuyExecution | Type_284_RefundSurplus | Type_284_SetErrorHandler | Type_284_SetAppendix | Type_284_ClearError | Type_284_ClaimAsset | Type_284_Trap | Type_284_SubscribeVersion | Type_284_UnsubscribeVersion | Type_284_BurnAsset | Type_284_ExpectAsset | Type_284_ExpectOrigin | Type_284_ExpectError | Type_284_ExpectTransactStatus | Type_284_QueryPallet | Type_284_ExpectPallet | Type_284_ReportTransactStatus | Type_284_ClearTransactStatus | Type_284_UniversalOrigin | Type_284_ExportMessage | Type_284_LockAsset | Type_284_UnlockAsset | Type_284_NoteUnlockable | Type_284_RequestUnlock | Type_284_SetFeesMode | Type_284_SetTopic | Type_284_ClearTopic | Type_284_AliasOrigin | Type_284_UnpaidExecution
...
export interface Type_284_ReportHolding {
    __kind: 'ReportHolding'
    responseInfo: V3QueryResponseInfo
    assets: V3MultiAssetFilter
}
...
export interface Type_284_BurnAsset {
    __kind: 'BurnAsset'
    value: V3MultiAsset[]
}

export interface Type_284_ExpectAsset {
    __kind: 'ExpectAsset'
    value: V3MultiAsset[]
}

export interface Type_284_ExpectOrigin {
    __kind: 'ExpectOrigin'
    value: (V3MultiLocation | undefined)
}

export interface Type_284_ExpectError {
    __kind: 'ExpectError'
    value: ([number, V3Error] | undefined)
}

export interface Type_284_ExpectTransactStatus {
    __kind: 'ExpectTransactStatus'
    value: V3MaybeErrorCode
}

export interface Type_284_QueryPallet {
    __kind: 'QueryPallet'
    moduleName: Uint8Array
    responseInfo: V3QueryResponseInfo
}

export interface Type_284_ExpectPallet {
    __kind: 'ExpectPallet'
    index: number
    name: Uint8Array
    moduleName: Uint8Array
...
export interface Type_284_ReportTransactStatus {
    __kind: 'ReportTransactStatus'
    value: V3QueryResponseInfo
}

export interface Type_284_ClearTransactStatus {
    __kind: 'ClearTransactStatus'
}

export interface Type_284_UniversalOrigin {
    __kind: 'UniversalOrigin'
    value: V3Junction
}

export interface Type_284_ExportMessage {
    __kind: 'ExportMessage'
    network: V3NetworkId
    destination: V3Junctions
    xcm: V3Instruction[]
...
export interface Type_284_LockAsset {
    __kind: 'LockAsset'
    asset: V3MultiAsset
    unlocker: V3MultiLocation
}

export interface Type_284_UnlockAsset {
    __kind: 'UnlockAsset'
    asset: V3MultiAsset
    target: V3MultiLocation
}

export interface Type_284_NoteUnlockable {
    __kind: 'NoteUnlockable'
    asset: V3MultiAsset
    owner: V3MultiLocation
}

export interface Type_284_RequestUnlock {
    __kind: 'RequestUnlock'
    asset: V3MultiAsset
    locker: V3MultiLocation
}

export interface Type_284_SetFeesMode {
    __kind: 'SetFeesMode'
    jitWithdraw: boolean
}

export interface Type_284_SetTopic {
    __kind: 'SetTopic'
    value: Uint8Array
}

export interface Type_284_ClearTopic {
    __kind: 'ClearTopic'
}

export interface Type_284_AliasOrigin {
    __kind: 'AliasOrigin'
    value: V3MultiLocation
}

export interface Type_284_UnpaidExecution {
    __kind: 'UnpaidExecution'
    weightLimit: V3WeightLimit
    checkOrigin: (V3MultiLocation | undefined)
}
