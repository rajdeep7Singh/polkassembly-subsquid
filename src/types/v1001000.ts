...
export type Call = Call_Alliance | Call_AllianceMotion | Call_AssetRate | Call_Balances | Call_CollatorSelection | Call_DmpQueue | Call_FellowshipCollective | Call_FellowshipCore | Call_FellowshipReferenda | Call_FellowshipSalary | Call_FellowshipTreasury | Call_Multisig | Call_ParachainSystem | Call_PolkadotXcm | Call_Preimage | Call_Proxy | Call_Scheduler | Call_Session | Call_System | Call_Timestamp | Call_Utility | Call_XcmpQueue
...
export type Type_187 = Type_187_Architects | Type_187_Fellows | Type_187_Fellowship2Dan | Type_187_Fellowship5Dan | Type_187_Fellowship6Dan | Type_187_Fellowship8Dan | Type_187_Fellowship9Dan | Type_187_Masters | Type_187_Members | Type_187_PromoteTo1Dan | Type_187_PromoteTo2Dan | Type_187_PromoteTo3Dan | Type_187_PromoteTo4Dan | Type_187_PromoteTo5Dan | Type_187_PromoteTo6Dan | Type_187_RetainAt1Dan | Type_187_RetainAt2Dan | Type_187_RetainAt3Dan | Type_187_RetainAt4Dan | Type_187_RetainAt5Dan | Type_187_RetainAt6Dan

export interface Type_187_Architects {
    __kind: 'Architects'
}

export interface Type_187_Fellows {
    __kind: 'Fellows'
}

export interface Type_187_Fellowship2Dan {
    __kind: 'Fellowship2Dan'
}

export interface Type_187_Fellowship5Dan {
    __kind: 'Fellowship5Dan'
}

export interface Type_187_Fellowship6Dan {
    __kind: 'Fellowship6Dan'
}

export interface Type_187_Fellowship8Dan {
    __kind: 'Fellowship8Dan'
}

export interface Type_187_Fellowship9Dan {
    __kind: 'Fellowship9Dan'
}

export interface Type_187_Masters {
    __kind: 'Masters'
}
...
export interface Type_187_PromoteTo1Dan {
    __kind: 'PromoteTo1Dan'
}

export interface Type_187_PromoteTo2Dan {
    __kind: 'PromoteTo2Dan'
}

export interface Type_187_PromoteTo3Dan {
    __kind: 'PromoteTo3Dan'
}

export interface Type_187_PromoteTo4Dan {
    __kind: 'PromoteTo4Dan'
}

export interface Type_187_PromoteTo5Dan {
    __kind: 'PromoteTo5Dan'
}

export interface Type_187_PromoteTo6Dan {
    __kind: 'PromoteTo6Dan'
}

export interface Type_187_RetainAt1Dan {
    __kind: 'RetainAt1Dan'
}

export interface Type_187_RetainAt2Dan {
    __kind: 'RetainAt2Dan'
}

export interface Type_187_RetainAt3Dan {
    __kind: 'RetainAt3Dan'
}

export interface Type_187_RetainAt4Dan {
    __kind: 'RetainAt4Dan'
}

export interface Type_187_RetainAt5Dan {
    __kind: 'RetainAt5Dan'
}

export interface Type_187_RetainAt6Dan {
    __kind: 'RetainAt6Dan'
}

export type Type_185 = Type_185_Relay | Type_185_SiblingParachain

export interface Type_185_Relay {
    __kind: 'Relay'
}

export interface Type_185_SiblingParachain {
...
export const OriginCaller: sts.Type<OriginCaller> = sts.closedEnum(() => {
    return  {
        AllianceMotion: Type_186,
        CumulusXcm: Type_185,
        FellowshipOrigins: Type_187,
        PolkadotXcm: Origin,
        Void: Void,
        system: RawOrigin,
    }
