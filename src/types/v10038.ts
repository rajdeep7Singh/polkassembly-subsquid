...
export type Type_656 = Type_656_Casting | Type_656_Delegating

export interface Type_656_Casting {
    __kind: 'Casting'
    value: Casting
}

export interface Type_656_Delegating {
    __kind: 'Delegating'
    value: Delegating
}
...
export interface Delegating {
    ...
    target: AccountId32
    conviction: Type_360
    delegations: Type_661
    prior: [number, bigint]
}

export interface Type_661 {
    votes: bigint
    capital: bigint
}

export type Type_360 = Type_360_Locked1x | Type_360_Locked2x | Type_360_Locked3x | Type_360_Locked4x | Type_360_Locked5x | Type_360_Locked6x | Type_360_None

export interface Type_360_Locked1x {
    __kind: 'Locked1x'
}

export interface Type_360_Locked2x {
    __kind: 'Locked2x'
}

export interface Type_360_Locked3x {
    __kind: 'Locked3x'
}

export interface Type_360_Locked4x {
    __kind: 'Locked4x'
}

export interface Type_360_Locked5x {
    __kind: 'Locked5x'
}

export interface Type_360_Locked6x {
    __kind: 'Locked6x'
}

export interface Type_360_None {
    __kind: 'None'
}

export interface Casting {
    votes: [number, Type_358][]
    delegations: Type_661
    prior: [number, bigint]
}

export type Type_358 = Type_358_Split | Type_358_SplitAbstain | Type_358_Standard

export interface Type_358_Split {
    __kind: 'Split'
    aye: bigint
    nay: bigint
}

export interface Type_358_SplitAbstain {
    __kind: 'SplitAbstain'
    aye: bigint
    nay: bigint
    abstain: bigint
...
export interface Type_358_Standard {
    __kind: 'Standard'
    vote: number
    balance: bigint
}

export const Type_656: sts.Type<Type_656> = sts.closedEnum(() => {
    return  {
        Casting: Casting,
...
export const Type_661: sts.Type<Type_661> = sts.struct(() => {
    return  {
        votes: sts.bigint(),
        capital: sts.bigint(),
    }
...
export const Casting: sts.Type<Casting> = sts.struct(() => {
    return  {
        votes: sts.array(() => sts.tuple(() => [sts.number(), Type_358])),
        delegations: Type_661,
        prior: sts.tuple(() => [sts.number(), sts.bigint()]),
    }
})

export type Type_637 = Type_637_Approved | Type_637_Cancelled | Type_637_Killed | Type_637_Ongoing | Type_637_Rejected | Type_637_TimedOut

export interface Type_637_Approved {
    __kind: 'Approved'
    value: [number, (Deposit | undefined), (Deposit | undefined)]
}

export interface Type_637_Cancelled {
    __kind: 'Cancelled'
    value: [number, (Deposit | undefined), (Deposit | undefined)]
}

export interface Type_637_Killed {
    __kind: 'Killed'
    value: number
}

export interface Type_637_Ongoing {
    __kind: 'Ongoing'
    value: Type_638
}

export interface Type_637_Rejected {
    __kind: 'Rejected'
    value: [number, (Deposit | undefined), (Deposit | undefined)]
}

export interface Type_637_TimedOut {
    __kind: 'TimedOut'
    value: [number, (Deposit | undefined), (Deposit | undefined)]
}

export interface Type_638 {
    track: number
    origin: OriginCaller
    proposal: Bounded
...
export type OriginCaller = OriginCaller_Council | OriginCaller_CumulusXcm | OriginCaller_Origins | OriginCaller_PolkadotXcm | OriginCaller_ReleaseCommittee | OriginCaller_TechnicalCommittee | OriginCaller_Void | OriginCaller_system
...
export type Type_294 = Type_294_WhitelistedCaller

export interface Type_294_WhitelistedCaller {
    __kind: 'WhitelistedCaller'
}

export type Type_293 = Type_293_Relay | Type_293_SiblingParachain

export interface Type_293_Relay {
    __kind: 'Relay'
}

export interface Type_293_SiblingParachain {
...
export type Type_289 = Type_289_Member | Type_289_Members | Type_289__Phantom
...
export const Type_638: sts.Type<Type_638> = sts.struct(() => {
    return  {
        track: sts.number(),
        origin: OriginCaller,
        proposal: Bounded,
...
export const OriginCaller: sts.Type<OriginCaller> = sts.closedEnum(() => {
    return  {
        ...
        Origins: Type_294,
        PolkadotXcm: Origin,
        ReleaseCommittee: Type_291,
        TechnicalCommittee: Type_290,
        Void: Void,
        system: RawOrigin,
    }
})
...
export type Call = Call_AssetTxPayment | Call_AssetsRegistry | Call_AssetsTransactorRouter | Call_Balances | Call_BondedFinance | Call_CallFilter | Call_CollatorSelection | Call_ConvictionVoting | Call_Cosmwasm | Call_Council | Call_CouncilMembership | Call_CrowdloanRewards | Call_CumulusXcm | Call_CurrencyFactory | Call_Democracy | Call_DmpQueue | Call_Farming | Call_FarmingRewards | Call_Ibc | Call_Ics20Fee | Call_Identity | Call_Indices | Call_Multisig | Call_OpenGovBalances | Call_Oracle | Call_Pablo | Call_PalletMultihopXcmIbc | Call_ParachainInfo | Call_ParachainSystem | Call_PolkadotXcm | Call_Preimage | Call_Proxy | Call_Referenda | Call_ReleaseCommittee | Call_ReleaseMembership | Call_Scheduler | Call_Session | Call_Sudo | Call_System | Call_TechnicalCommittee | Call_TechnicalCommitteeMembership | Call_Timestamp | Call_Tokens | Call_Treasury | Call_UnknownTokens | Call_Utility | Call_Vesting | Call_Whitelist | Call_XTokens | Call_XcmpQueue
...
export interface Call_OpenGovBalances {
    __kind: 'OpenGovBalances'
    value: OpenGovBalancesCall
}
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type ReleaseCommitteeCall = ReleaseCommitteeCall_close | ReleaseCommitteeCall_close_old_weight | ReleaseCommitteeCall_disapprove_proposal | ReleaseCommitteeCall_execute | ReleaseCommitteeCall_propose | ReleaseCommitteeCall_set_members | ReleaseCommitteeCall_vote
...
export type Type_313 = Type_313_V2 | Type_313_V3
...
export interface Type_313_V3 {
    __kind: 'V3'
    value: Type_320[]
}

export type Type_320 = Type_320_AliasOrigin | Type_320_BurnAsset | Type_320_BuyExecution | Type_320_ClaimAsset | Type_320_ClearError | Type_320_ClearOrigin | Type_320_ClearTopic | Type_320_ClearTransactStatus | Type_320_DepositAsset | Type_320_DepositReserveAsset | Type_320_DescendOrigin | Type_320_ExchangeAsset | Type_320_ExpectAsset | Type_320_ExpectError | Type_320_ExpectOrigin | Type_320_ExpectPallet | Type_320_ExpectTransactStatus | Type_320_ExportMessage | Type_320_HrmpChannelAccepted | Type_320_HrmpChannelClosing | Type_320_HrmpNewChannelOpenRequest | Type_320_InitiateReserveWithdraw | Type_320_InitiateTeleport | Type_320_LockAsset | Type_320_NoteUnlockable | Type_320_QueryPallet | Type_320_QueryResponse | Type_320_ReceiveTeleportedAsset | Type_320_RefundSurplus | Type_320_ReportError | Type_320_ReportHolding | Type_320_ReportTransactStatus | Type_320_RequestUnlock | Type_320_ReserveAssetDeposited | Type_320_SetAppendix | Type_320_SetErrorHandler | Type_320_SetFeesMode | Type_320_SetTopic | Type_320_SubscribeVersion | Type_320_Transact | Type_320_TransferAsset | Type_320_TransferReserveAsset | Type_320_Trap | Type_320_UniversalOrigin | Type_320_UnlockAsset | Type_320_UnpaidExecution | Type_320_UnsubscribeVersion | Type_320_WithdrawAsset

export interface Type_320_AliasOrigin {
    __kind: 'AliasOrigin'
    value: V3MultiLocation
}

export interface Type_320_BurnAsset {
    __kind: 'BurnAsset'
    value: V3MultiAsset[]
}
...
export interface Type_320_ClearTopic {
    __kind: 'ClearTopic'
}

export interface Type_320_ClearTransactStatus {
    __kind: 'ClearTransactStatus'
}
...
export interface Type_320_ExpectAsset {
    __kind: 'ExpectAsset'
    value: V3MultiAsset[]
}

export interface Type_320_ExpectError {
    __kind: 'ExpectError'
    value?: ([number, V3Error] | undefined)
}

export interface Type_320_ExpectOrigin {
    __kind: 'ExpectOrigin'
    value?: (V3MultiLocation | undefined)
}

export interface Type_320_ExpectPallet {
    __kind: 'ExpectPallet'
    index: number
    name: Bytes
    moduleName: Bytes
...
export interface Type_320_ExpectTransactStatus {
    __kind: 'ExpectTransactStatus'
    value: V3MaybeErrorCode
}

export interface Type_320_ExportMessage {
    __kind: 'ExportMessage'
    network: V3NetworkId
    destination: V3Junctions
    xcm: V3Instruction[]
...
export interface Type_320_LockAsset {
    __kind: 'LockAsset'
    asset: V3MultiAsset
    unlocker: V3MultiLocation
}

export interface Type_320_NoteUnlockable {
    __kind: 'NoteUnlockable'
    asset: V3MultiAsset
    owner: V3MultiLocation
}

export interface Type_320_QueryPallet {
    __kind: 'QueryPallet'
    moduleName: Bytes
    responseInfo: V3QueryResponseInfo
}
...
export interface Type_320_ReportHolding {
    __kind: 'ReportHolding'
    responseInfo: V3QueryResponseInfo
    assets: V3MultiAssetFilter
}

export interface Type_320_ReportTransactStatus {
    __kind: 'ReportTransactStatus'
    value: V3QueryResponseInfo
}

export interface Type_320_RequestUnlock {
    __kind: 'RequestUnlock'
    asset: V3MultiAsset
    locker: V3MultiLocation
}
...
export interface Type_320_SetFeesMode {
    __kind: 'SetFeesMode'
    jitWithdraw: boolean
}

export interface Type_320_SetTopic {
    __kind: 'SetTopic'
    value: Bytes
}
...
export interface Type_320_UniversalOrigin {
    __kind: 'UniversalOrigin'
    value: V3Junction
}

export interface Type_320_UnlockAsset {
    __kind: 'UnlockAsset'
    asset: V3MultiAsset
    target: V3MultiLocation
}

export interface Type_320_UnpaidExecution {
    __kind: 'UnpaidExecution'
    weightLimit: V3WeightLimit
    checkOrigin?: (V3MultiLocation | undefined)
}
...
export interface Type_317 {
    encoded: Bytes
}

export type Type_316 = Type_316_BuyExecution | Type_316_ClaimAsset | Type_316_ClearError | Type_316_ClearOrigin | Type_316_DepositAsset | Type_316_DepositReserveAsset | Type_316_DescendOrigin | Type_316_ExchangeAsset | Type_316_HrmpChannelAccepted | Type_316_HrmpChannelClosing | Type_316_HrmpNewChannelOpenRequest | Type_316_InitiateReserveWithdraw | Type_316_InitiateTeleport | Type_316_QueryHolding | Type_316_QueryResponse | Type_316_ReceiveTeleportedAsset | Type_316_RefundSurplus | Type_316_ReportError | Type_316_ReserveAssetDeposited | Type_316_SetAppendix | Type_316_SetErrorHandler | Type_316_SubscribeVersion | Type_316_Transact | Type_316_TransferAsset | Type_316_TransferReserveAsset | Type_316_Trap | Type_316_UnsubscribeVersion | Type_316_WithdrawAsset
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type OpenGovBalancesCall = OpenGovBalancesCall_force_transfer | OpenGovBalancesCall_force_unreserve | OpenGovBalancesCall_set_balance | OpenGovBalancesCall_transfer | OpenGovBalancesCall_transfer_all | OpenGovBalancesCall_transfer_keep_alive
 ...
 */
export interface OpenGovBalancesCall_force_transfer {
    __kind: 'force_transfer'
    source: MultiAddress
    dest: MultiAddress
    value: bigint
 ...
 */
export interface OpenGovBalancesCall_force_unreserve {
 ...
 * The dispatch origin for this call is `root`.
 */
export interface OpenGovBalancesCall_set_balance {
    __kind: 'set_balance'
    who: MultiAddress
    newFree: bigint
    newReserved: bigint
 ...
 */
export interface OpenGovBalancesCall_transfer {
    __kind: 'transfer'
    dest: MultiAddress
    value: bigint
}
 ...
 */
export interface OpenGovBalancesCall_transfer_all {
    __kind: 'transfer_all'
    dest: MultiAddress
    keepAlive: boolean
}
 ...
 */
export interface OpenGovBalancesCall_transfer_keep_alive {
    __kind: 'transfer_keep_alive'
    dest: MultiAddress
    value: bigint
}
...
export type Type_383 = Type_383_Id | Type_383_Raw

export interface Type_383_Id {
    __kind: 'Id'
    value: AccountId32
}

export interface Type_383_Raw {
    __kind: 'Raw'
    value: Bytes
}
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type BondedFinanceCall = BondedFinanceCall_bond | BondedFinanceCall_cancel | BondedFinanceCall_offer
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type AssetsTransactorRouterCall = AssetsTransactorRouterCall_burn_from | AssetsTransactorRouterCall_force_transfer | AssetsTransactorRouterCall_force_transfer_native | AssetsTransactorRouterCall_mint_into | AssetsTransactorRouterCall_transfer | AssetsTransactorRouterCall_transfer_all | AssetsTransactorRouterCall_transfer_all_native | AssetsTransactorRouterCall_transfer_native
...
export interface Type_171_Set {
    __kind: 'Set'
    value?: (Type_165 | undefined)
}

export interface Type_165 {
    inner: Bytes
}
...
export type Type_151 = Type_151_V3

export interface Type_151_V3 {
    __kind: 'V3'
    value: V3MultiLocation
}
...
export const Call: sts.Type<Call> = sts.closedEnum(() => {
    return  {
        ...
        AssetsTransactorRouter: AssetsTransactorRouterCall,
        Balances: BalancesCall,
        BondedFinance: BondedFinanceCall,
        ...
        CurrencyFactory: CurrencyFactoryCall,
        ...
        OpenGovBalances: OpenGovBalancesCall,
        Oracle: OracleCall,
        Pablo: PabloCall,
...
export const Type_313: sts.Type<Type_313> = sts.closedEnum(() => {
    return  {
        V2: sts.array(() => Type_316),
        V3: sts.array(() => Type_320),
    }
})
...
export const Type_317: sts.Type<Type_317> = sts.struct(() => {
    return  {
        encoded: sts.bytes(),
    }
})
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export const OpenGovBalancesCall: sts.Type<OpenGovBalancesCall> = sts.closedEnum(() => {
    return  {
        force_transfer: sts.enumStruct({
            source: MultiAddress,
            dest: MultiAddress,
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export const CurrencyFactoryCall: sts.Type<CurrencyFactoryCall> = sts.closedEnum(() => {
    return  {
        add_range: sts.enumStruct({
            length: sts.bigint(),
        }),
        set_metadata: sts.enumStruct({
            assetId: CurrencyId,
...
export const BasicAssetMetadata: sts.Type<BasicAssetMetadata> = sts.struct(() => {
    return  {
        symbol: Type_329,
        name: Type_330,
    }
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export const BondedFinanceCall: sts.Type<BondedFinanceCall> = sts.closedEnum(() => {
    return  {
        bond: sts.enumStruct({
            offerId: sts.bigint(),
            nbOfBonds: sts.bigint(),
            keepAlive: sts.boolean(),
        }),
        cancel: sts.enumStruct({
            offerId: sts.bigint(),
        }),
        offer: sts.enumStruct({
            offer: BondOffer,
            keepAlive: sts.boolean(),
        }),
    }
...
export const BondOffer: sts.Type<BondOffer> = sts.struct(() => {
    return  {
        beneficiary: AccountId32,
        asset: CurrencyId,
        bondPrice: sts.bigint(),
        nbOfBonds: sts.bigint(),
        maturity: BondDuration,
        reward: BondOfferReward,
    }
...
export const BondOfferReward: sts.Type<BondOfferReward> = sts.struct(() => {
    return  {
        asset: CurrencyId,
        amount: sts.bigint(),
        maturity: sts.number(),
...
export const BondDuration: sts.Type<BondDuration> = sts.closedEnum(() => {
    return  {
        Finite: sts.enumStruct({
            returnIn: sts.number(),
        }),
        Infinite: sts.unit(),
    }
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export const AssetsTransactorRouterCall: sts.Type<AssetsTransactorRouterCall> = sts.closedEnum(() => {
    return  {
...
export const Type_171: sts.Type<Type_171> = sts.closedEnum(() => {
    return  {
        Ignore: sts.unit(),
        Set: sts.option(() => Type_165),
    }
})

export const Type_165: sts.Type<Type_165> = sts.struct(() => {
    return  {
        inner: sts.bytes(),
    }
})
