...
export const proposalOf =  {
     ...
     *  Actual proposal for a given hash, if it's current.
     */
    v6: new StorageType('Council.ProposalOf', 'Optional', [v6.H256], v6.Call) as ProposalOfV6,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
     ...
     *  Actual proposal for a given hash, if it's current.
     */
    v8: new StorageType('Council.ProposalOf', 'Optional', [v8.H256], v8.Call) as ProposalOfV8,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
     ...
     *  Actual proposal for a given hash, if it's current.
     */
    v13: new StorageType('Council.ProposalOf', 'Optional', [v13.H256], v13.Call) as ProposalOfV13,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    v14: new StorageType('Council.ProposalOf', 'Optional', [v14.H256], v14.Call) as ProposalOfV14,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
     ...
     *  Actual proposal for a given hash, if it's current.
     */
    v19: new StorageType('Council.ProposalOf', 'Optional', [v19.H256], v19.Call) as ProposalOfV19,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    v20: new StorageType('Council.ProposalOf', 'Optional', [v20.H256], v20.Call) as ProposalOfV20,
}
