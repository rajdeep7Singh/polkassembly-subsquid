...
export const proposalOf =  {
     ...
     *  Actual proposal for a given hash, if it's current.
     */
    v9310: new StorageType('Council.ProposalOf', 'Optional', [v9310.H256], v9310.Call) as ProposalOfV9310,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    v9321: new StorageType('Council.ProposalOf', 'Optional', [v9321.H256], v9321.Call) as ProposalOfV9321,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
     ...
     *  Actual proposal for a given hash, if it's current.
     */
    v9380: new StorageType('Council.ProposalOf', 'Optional', [v9380.H256], v9380.Call) as ProposalOfV9380,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    v9390: new StorageType('Council.ProposalOf', 'Optional', [v9390.H256], v9390.Call) as ProposalOfV9390,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
     ...
     *  Actual proposal for a given hash, if it's current.
     */
    v102000: new StorageType('Council.ProposalOf', 'Optional', [v102000.H256], v102000.Call) as ProposalOfV102000,
}
...
export const proposalCount =  {
     ...
     *  Proposals so far.
     */
    v9300: new StorageType('Council.ProposalCount', 'Default', [], sts.number()) as ProposalCountV9300,
}

/**
 *  Proposals so far.
 */
export interface ProposalCountV9300  {
    is(block: RuntimeCtx): boolean
...
export const members =  {
     ...
     */
    v9300: new StorageType('Council.Members', 'Default', [], sts.array(() => v9300.AccountId32)) as MembersV9300,
}

/**
 *  The current members of the collective. This is stored sorted (just by value).
 */
export interface MembersV9300  {
    is(block: RuntimeCtx): boolean
    getDefault(block: Block): v9300.AccountId32[]
    get(block: Block): Promise<(v9300.AccountId32[] | undefined)>
}
