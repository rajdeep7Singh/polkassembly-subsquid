...
export const proposalOf =  {
     ...
     */
    v268: new StorageType('Instance1Collective.ProposalOf', 'Optional', [v268.Hash], v268.Proposal) as ProposalOfV268,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    v273: new StorageType('Instance1Collective.ProposalOf', 'Optional', [v273.Hash], v273.Proposal) as ProposalOfV273,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    v274: new StorageType('Council.ProposalOf', 'Optional', [v274.H256], v274.Call) as ProposalOfV274,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    v276: new StorageType('Council.ProposalOf', 'Optional', [v276.H256], v276.Call) as ProposalOfV276,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    v277: new StorageType('Council.ProposalOf', 'Optional', [v277.H256], v277.Call) as ProposalOfV277,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    v278: new StorageType('Council.ProposalOf', 'Optional', [v278.H256], v278.Call) as ProposalOfV278,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    v280: new StorageType('Council.ProposalOf', 'Optional', [v280.H256], v280.Call) as ProposalOfV280,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    v281: new StorageType('Council.ProposalOf', 'Optional', [v281.H256], v281.Call) as ProposalOfV281,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    v283: new StorageType('Council.ProposalOf', 'Optional', [v283.H256], v283.Call) as ProposalOfV283,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    v287: new StorageType('Council.ProposalOf', 'Optional', [v287.H256], v287.Call) as ProposalOfV287,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    v312: new StorageType('Council.ProposalOf', 'Optional', [v312.H256], v312.Call) as ProposalOfV312,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    v317: new StorageType('Council.ProposalOf', 'Optional', [v317.H256], v317.Call) as ProposalOfV317,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    v318: new StorageType('Council.ProposalOf', 'Optional', [v318.H256], v318.Call) as ProposalOfV318,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    v326: new StorageType('Council.ProposalOf', 'Optional', [v326.H256], v326.Call) as ProposalOfV326,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    v328: new StorageType('Council.ProposalOf', 'Optional', [v328.H256], v328.Call) as ProposalOfV328,
}
...
export const proposalCount =  {
     ...
     *  Proposals so far.
     */
    v268: new StorageType('Instance1Collective.ProposalCount', 'Default', [], sts.number()) as ProposalCountV268,
}

/**
 *  Proposals so far.
 */
export interface ProposalCountV268  {
    is(block: RuntimeCtx): boolean
...
export const members =  {
     ...
     */
    v268: new StorageType('Instance1Collective.Members', 'Default', [], sts.array(() => v268.AccountId)) as MembersV268,
}

/**
 *  The current members of the collective. This is stored sorted (just by value).
 */
export interface MembersV268  {
    is(block: RuntimeCtx): boolean
    getDefault(block: Block): v268.AccountId[]
    get(block: Block): Promise<(v268.AccountId[] | undefined)>
}
