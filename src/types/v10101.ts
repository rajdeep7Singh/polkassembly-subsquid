...
export type Call = Call_System | Call_Timestamp | Call_Indices | Call_Balances | Call_Sudo | Call_Authorship | Call_ParachainStaking | Call_Session | Call_Democracy | Call_Council | Call_TechnicalCommittee | Call_TechnicalMembership | Call_Treasury | Call_Utility | Call_Vesting | Call_Scheduler | Call_KiltLaunch | Call_Ctype | Call_Attestation | Call_Delegation | Call_Did | Call_CrowdloanContributors | Call_ParachainSystem
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type DelegationCall = DelegationCall_create_hierarchy | DelegationCall_add_delegation | DelegationCall_revoke_delegation | DelegationCall_remove_delegation
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type CrowdloanContributorsCall = CrowdloanContributorsCall_set_registrar_account | CrowdloanContributorsCall_set_reserve_accounts | CrowdloanContributorsCall_set_config | CrowdloanContributorsCall_set_contribution | CrowdloanContributorsCall_remove_contribution | CrowdloanContributorsCall_receive_gratitude
