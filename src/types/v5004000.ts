 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type SystemCall = SystemCall_kill_prefix | SystemCall_kill_storage | SystemCall_placeholder_fill_block | SystemCall_remark | SystemCall_remark_with_event | SystemCall_set_code | SystemCall_set_code_without_checks | SystemCall_set_heap_pages | SystemCall_set_storage
 ...
 * Each variant of this enum maps to a dispatchable function from the associated module.
 */
export type SettlementCall = SettlementCall_add_and_affirm_instruction | SettlementCall_add_and_affirm_instruction_with_memo | SettlementCall_add_and_affirm_instruction_with_memo_v2 | SettlementCall_add_instruction | SettlementCall_add_instruction_with_memo | SettlementCall_add_instruction_with_memo_v2 | SettlementCall_affirm_instruction | SettlementCall_affirm_instruction_v2 | SettlementCall_affirm_with_receipts | SettlementCall_allow_venues | SettlementCall_change_receipt_validity | SettlementCall_create_venue | SettlementCall_disallow_venues | SettlementCall_execute_manual_instruction | SettlementCall_execute_scheduled_instruction | SettlementCall_execute_scheduled_instruction_v2 | SettlementCall_placeholder_claim_receipt | SettlementCall_placeholder_unclaim_receipt | SettlementCall_reject_instruction | SettlementCall_reject_instruction_v2 | SettlementCall_reschedule_instruction | SettlementCall_set_venue_filtering | SettlementCall_update_venue_details | SettlementCall_update_venue_signers | SettlementCall_update_venue_type | SettlementCall_withdraw_affirmation | SettlementCall_withdraw_affirmation_v2
 ...
 * Each variant of this enum maps to a dispatchable function from the associated module.
 */
export type PortfolioCall = PortfolioCall_accept_portfolio_custody | PortfolioCall_create_portfolio | PortfolioCall_delete_portfolio | PortfolioCall_move_portfolio_funds | PortfolioCall_move_portfolio_funds_v2 | PortfolioCall_quit_portfolio_custody | PortfolioCall_rename_portfolio
...
export const InvestorUid = sts.bytes()
...
export const SystemCall: sts.Type<SystemCall> = sts.closedEnum(() => {
    return  {
        ...
        placeholder_fill_block: sts.unit(),
...
export const SettlementCall: sts.Type<SettlementCall> = sts.closedEnum(() => {
    return  {
        ...
        add_and_affirm_instruction_with_memo_v2: sts.enumStruct({
            venueId: VenueId,
            settlementType: SettlementType,
            tradeDate: sts.option(() => sts.bigint()),
            valueDate: sts.option(() => sts.bigint()),
            legs: sts.array(() => LegV2),
            portfolios: sts.array(() => PortfolioId),
            instructionMemo: sts.option(() => InstructionMemo),
        }),
        ...
        add_instruction_with_memo_v2: sts.enumStruct({
            venueId: VenueId,
            settlementType: SettlementType,
            tradeDate: sts.option(() => sts.bigint()),
            valueDate: sts.option(() => sts.bigint()),
        ...
        affirm_instruction_v2: sts.enumStruct({
            id: InstructionId,
            portfolios: sts.array(() => PortfolioId),
        ...
        execute_scheduled_instruction_v2: sts.enumStruct({
            id: InstructionId,
            fungibleTransfers: sts.number(),
            nftsTransfers: sts.number(),
        }),
        placeholder_claim_receipt: sts.unit(),
        placeholder_unclaim_receipt: sts.unit(),
        reject_instruction: sts.enumStruct({
            id: InstructionId,
            portfolio: PortfolioId,
            numOfLegs: sts.number(),
        }),
        reject_instruction_v2: sts.enumStruct({
            id: InstructionId,
            portfolio: PortfolioId,
            fungibleTransfers: sts.number(),
            nftsTransfers: sts.number(),
        ...
        withdraw_affirmation_v2: sts.enumStruct({
            id: InstructionId,
            portfolios: sts.array(() => PortfolioId),
            fungibleTransfers: sts.number(),
            nftsTransfers: sts.number(),
...
export const LegV2: sts.Type<LegV2> = sts.struct(() => {
    return  {
        from: PortfolioId,
        to: PortfolioId,
        asset: LegAsset,
...
export const LegAsset: sts.Type<LegAsset> = sts.closedEnum(() => {
    return  {
...
export const PortfolioCall: sts.Type<PortfolioCall> = sts.closedEnum(() => {
    return  {
        ...
        move_portfolio_funds_v2: sts.enumStruct({
            from: PortfolioId,
            to: PortfolioId,
...
export const Type_478: sts.Type<Type_478> = sts.struct(() => {
    return  {
        roundNumber: sts.bigint(),
        identity: Public,
