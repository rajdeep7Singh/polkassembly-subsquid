...
export type Call = Call_System | Call_Babe | Call_Timestamp | Call_Indices | Call_Authorship | Call_Balances | Call_Identity | Call_CddServiceProviders | Call_PolymeshCommittee | Call_CommitteeMembership | Call_TechnicalCommittee | Call_TechnicalCommitteeMembership | Call_UpgradeCommittee | Call_UpgradeCommitteeMembership | Call_MultiSig | Call_Bridge | Call_Staking | Call_Session | Call_Grandpa | Call_ImOnline | Call_Sudo | Call_Asset | Call_CapitalDistribution | Call_Checkpoint | Call_ComplianceManager | Call_CorporateAction | Call_CorporateBallot | Call_Pips | Call_Portfolio | Call_ProtocolFee | Call_Scheduler | Call_Settlement | Call_Statistics | Call_Sto | Call_Treasury | Call_Utility | Call_Base | Call_ExternalAgents | Call_Relayer | Call_Rewards | Call_Contracts | Call_PolymeshContracts | Call_Preimage | Call_Nft
 ...
 */
export type SystemCall = SystemCall_placeholder_fill_block | SystemCall_remark | SystemCall_set_heap_pages | SystemCall_set_code | SystemCall_set_code_without_checks | SystemCall_set_storage | SystemCall_kill_storage | SystemCall_kill_prefix | SystemCall_remark_with_event

/**
 * Placeholder for removed `fill_block`.
 */
export interface SystemCall_placeholder_fill_block {
    __kind: 'placeholder_fill_block'
}
 ...
 * Each variant of this enum maps to a dispatchable function from the associated module.
 */
export type IdentityCall = IdentityCall_cdd_register_did | IdentityCall_invalidate_cdd_claims | IdentityCall_remove_secondary_keys_old | IdentityCall_accept_primary_key | IdentityCall_change_cdd_requirement_for_mk_rotation | IdentityCall_join_identity_as_key | IdentityCall_leave_identity_as_key | IdentityCall_add_claim | IdentityCall_revoke_claim | IdentityCall_set_permission_to_signer | IdentityCall_placeholder_legacy_set_permission_to_signer | IdentityCall_freeze_secondary_keys | IdentityCall_unfreeze_secondary_keys | IdentityCall_add_authorization | IdentityCall_remove_authorization | IdentityCall_add_secondary_keys_with_authorization_old | IdentityCall_add_investor_uniqueness_claim | IdentityCall_gc_add_cdd_claim | IdentityCall_gc_revoke_cdd_claim | IdentityCall_add_investor_uniqueness_claim_v2 | IdentityCall_revoke_claim_by_index | IdentityCall_rotate_primary_key_to_secondary | IdentityCall_add_secondary_keys_with_authorization | IdentityCall_set_secondary_key_permissions | IdentityCall_remove_secondary_keys | IdentityCall_register_custom_claim_type | IdentityCall_cdd_register_did_with_cdd
...
export interface AssetCall_create_asset {
    ...
    fundingRound: (Uint8Array | undefined)
    disableIu: boolean
}
 ...
 * * Portfolio
 */
export interface AssetCall_redeem_from_portfolio {
    __kind: 'redeem_from_portfolio'
    ticker: Uint8Array
    value: bigint
 ...
 * Each variant of this enum maps to a dispatchable function from the associated module.
 */
export type CorporateActionCall = CorporateActionCall_set_max_details_length | CorporateActionCall_set_default_targets | CorporateActionCall_set_default_withholding_tax | CorporateActionCall_set_did_withholding_tax | CorporateActionCall_initiate_corporate_action | CorporateActionCall_link_ca_doc | CorporateActionCall_remove_ca | CorporateActionCall_change_record_date | CorporateActionCall_initiate_corporate_action_and_distribute
 ...
 * Each variant of this enum maps to a dispatchable function from the associated module.
 */
export type PortfolioCall = PortfolioCall_create_portfolio | PortfolioCall_delete_portfolio | PortfolioCall_move_portfolio_funds | PortfolioCall_rename_portfolio | PortfolioCall_quit_portfolio_custody | PortfolioCall_accept_portfolio_custody | PortfolioCall_move_portfolio_funds_v2
 ...
 * * Portfolio
 */
export interface PortfolioCall_move_portfolio_funds_v2 {
    __kind: 'move_portfolio_funds_v2'
    from: PortfolioId
    to: PortfolioId
    funds: Fund[]
}
 ...
 * Each variant of this enum maps to a dispatchable function from the associated module.
 */
export type SettlementCall = SettlementCall_create_venue | SettlementCall_update_venue_details | SettlementCall_update_venue_type | SettlementCall_add_instruction | SettlementCall_add_and_affirm_instruction | SettlementCall_affirm_instruction | SettlementCall_withdraw_affirmation | SettlementCall_reject_instruction | SettlementCall_affirm_with_receipts | SettlementCall_placeholder_claim_receipt | SettlementCall_placeholder_unclaim_receipt | SettlementCall_set_venue_filtering | SettlementCall_allow_venues | SettlementCall_disallow_venues | SettlementCall_change_receipt_validity | SettlementCall_execute_scheduled_instruction | SettlementCall_reschedule_instruction | SettlementCall_update_venue_signers | SettlementCall_add_instruction_with_memo | SettlementCall_add_and_affirm_instruction_with_memo | SettlementCall_execute_manual_instruction | SettlementCall_add_instruction_with_memo_v2 | SettlementCall_add_and_affirm_instruction_with_memo_v2 | SettlementCall_affirm_instruction_v2 | SettlementCall_withdraw_affirmation_v2 | SettlementCall_reject_instruction_v2 | SettlementCall_execute_scheduled_instruction_v2
 ...
 */
export interface SettlementCall_placeholder_claim_receipt {
    __kind: 'placeholder_claim_receipt'
}

/**
 * Placeholder for removed `unclaim_receipt`
 */
export interface SettlementCall_placeholder_unclaim_receipt {
    __kind: 'placeholder_unclaim_receipt'
}
...
export interface SettlementCall_add_instruction_with_memo {
    ...
    valueDate: (bigint | undefined)
    legs: Leg[]
    instructionMemo: (Uint8Array | undefined)
}
 ...
 * `950_000_000 + 1_000_000 * legs.len()`
 */
export interface SettlementCall_add_instruction_with_memo_v2 {
    __kind: 'add_instruction_with_memo_v2'
    venueId: bigint
    settlementType: SettlementType
    tradeDate: (bigint | undefined)
    valueDate: (bigint | undefined)
 ...
 * * Portfolio
 */
export interface SettlementCall_add_and_affirm_instruction_with_memo_v2 {
    __kind: 'add_and_affirm_instruction_with_memo_v2'
    venueId: bigint
    settlementType: SettlementType
    tradeDate: (bigint | undefined)
    valueDate: (bigint | undefined)
 ...
 * * Portfolio
 */
export interface SettlementCall_affirm_instruction_v2 {
    __kind: 'affirm_instruction_v2'
    id: bigint
    portfolios: PortfolioId[]
 ...
 * * Portfolio
 */
export interface SettlementCall_withdraw_affirmation_v2 {
    __kind: 'withdraw_affirmation_v2'
    id: bigint
    portfolios: PortfolioId[]
    fungibleTransfers: number
    nftsTransfers: number
 ...
 * * Portfolio
 */
export interface SettlementCall_reject_instruction_v2 {
    __kind: 'reject_instruction_v2'
    id: bigint
    portfolio: PortfolioId
    fungibleTransfers: number
    nftsTransfers: number
 ...
 * Root callable extrinsic, used as an internal call to execute a scheduled settlement instruction.
 */
export interface SettlementCall_execute_scheduled_instruction_v2 {
    __kind: 'execute_scheduled_instruction_v2'
    id: bigint
    fungibleTransfers: number
    nftsTransfers: number
}
 ...
 * Each variant of this enum maps to a dispatchable function from the associated module.
 */
export type StatisticsCall = StatisticsCall_set_active_asset_stats | StatisticsCall_batch_update_asset_stats | StatisticsCall_set_asset_transfer_compliance | StatisticsCall_set_entities_exempt
 ...
 * Each variant of this enum maps to a dispatchable function from the associated module.
 */
export type ExternalAgentsCall = ExternalAgentsCall_create_group | ExternalAgentsCall_set_group_permissions | ExternalAgentsCall_remove_agent | ExternalAgentsCall_abdicate | ExternalAgentsCall_change_group | ExternalAgentsCall_accept_become_agent | ExternalAgentsCall_create_group_and_add_auth | ExternalAgentsCall_create_and_change_custom_group
...
export type Claim = Claim_Accredited | Claim_Affiliate | Claim_BuyLockup | Claim_SellLockup | Claim_CustomerDueDiligence | Claim_KnowYourCustomer | Claim_Jurisdiction | Claim_Exempted | Claim_Blocked | Claim_InvestorUniqueness | Claim_NoData | Claim_InvestorUniquenessV2 | Claim_Custom
...
export type ClaimType = ClaimType_Accredited | ClaimType_Affiliate | ClaimType_BuyLockup | ClaimType_SellLockup | ClaimType_CustomerDueDiligence | ClaimType_KnowYourCustomer | ClaimType_Jurisdiction | ClaimType_Exempted | ClaimType_Blocked | ClaimType_InvestorUniqueness | ClaimType_NoType | ClaimType_InvestorUniquenessV2 | ClaimType_Custom
...
export type RewardDestination = RewardDestination_Staked | RewardDestination_Stash | RewardDestination_Controller | RewardDestination_Account
...
export type AssetType = AssetType_EquityCommon | AssetType_EquityPreferred | AssetType_Commodity | AssetType_FixedIncome | AssetType_REIT | AssetType_Fund | AssetType_RevenueShareAgreement | AssetType_StructuredProduct | AssetType_Derivative | AssetType_Custom | AssetType_StableCoin | AssetType_NonFungible
...
export type AssetIdentifier = AssetIdentifier_CUSIP | AssetIdentifier_CINS | AssetIdentifier_ISIN | AssetIdentifier_LEI | AssetIdentifier_FIGI
...
export type SettlementType = SettlementType_SettleOnAffirmation | SettlementType_SettleOnBlock | SettlementType_SettleManual
...
export interface StatType {
    op: StatOpType
    claimIssuer: ([ClaimType, Uint8Array] | undefined)
}
...
export type TransferCondition = TransferCondition_MaxInvestorCount | TransferCondition_MaxInvestorOwnership | TransferCondition_ClaimCount | TransferCondition_ClaimOwnership
...
export interface TransferCondition_ClaimCount {
    __kind: 'ClaimCount'
    value: [StatClaim, Uint8Array, bigint, (bigint | undefined)]
}

export interface TransferCondition_ClaimOwnership {
    __kind: 'ClaimOwnership'
    value: [StatClaim, Uint8Array, number, number]
}
...
export type Type_46 = Type_46_Whole | Type_46_These | Type_46_Except
...
export type NonFungibleType = NonFungibleType_Derivative | NonFungibleType_FixedIncome | NonFungibleType_Invoice | NonFungibleType_Custom
...
export type SubsetRestriction = SubsetRestriction_Whole | SubsetRestriction_These | SubsetRestriction_Except
...
export type Type_55 = Type_55_Whole | Type_55_These | Type_55_Except
...
export type AssetMetadataLockStatus = AssetMetadataLockStatus_Unlocked | AssetMetadataLockStatus_Locked | AssetMetadataLockStatus_LockedUntil
...
export type LegAsset = LegAsset_Fungible | LegAsset_NonFungible

export interface LegAsset_Fungible {
    __kind: 'Fungible'
    ticker: Uint8Array
    amount: bigint
}

export interface LegAsset_NonFungible {
    __kind: 'NonFungible'
    value: NFTs
}

export type StatOpType = StatOpType_Count | StatOpType_Balance
...
export type Stat2ndKey = Stat2ndKey_NoClaimStat | Stat2ndKey_Claim
...
export type Type_49 = Type_49_Whole | Type_49_These | Type_49_Except
