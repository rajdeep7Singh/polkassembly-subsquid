...
export type Call = Call_System | Call_Timestamp | Call_Indices | Call_Balances | Call_Session | Call_ParachainStaking | Call_Authorship | Call_Democracy | Call_Council | Call_TechnicalCommittee | Call_TechnicalMembership | Call_Treasury | Call_Utility | Call_Vesting | Call_Scheduler | Call_Proxy | Call_Preimage | Call_TipsMembership | Call_Tips | Call_Ctype | Call_Attestation | Call_Delegation | Call_Did | Call_DidLookup | Call_Web3Names | Call_PublicCredentials | Call_ParachainSystem | Call_XcmpQueue | Call_PolkadotXcm | Call_DmpQueue
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type AttestationCall = AttestationCall_add | AttestationCall_revoke | AttestationCall_remove | AttestationCall_reclaim_deposit | AttestationCall_change_deposit_owner | AttestationCall_update_deposit
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type DelegationCall = DelegationCall_create_hierarchy | DelegationCall_add_delegation | DelegationCall_revoke_delegation | DelegationCall_remove_delegation | DelegationCall_reclaim_deposit | DelegationCall_change_deposit_owner | DelegationCall_update_deposit
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type DidLookupCall = DidLookupCall_associate_account | DidLookupCall_associate_sender | DidLookupCall_remove_sender_association | DidLookupCall_remove_account_association | DidLookupCall_reclaim_deposit | DidLookupCall_change_deposit_owner | DidLookupCall_update_deposit
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type Web3NamesCall = Web3NamesCall_claim | Web3NamesCall_release_by_owner | Web3NamesCall_reclaim_deposit | Web3NamesCall_ban | Web3NamesCall_unban | Web3NamesCall_change_deposit_owner | Web3NamesCall_update_deposit
...
export interface Web3NamesCall_update_deposit {
    __kind: 'update_deposit'
    nameInput: Uint8Array
}

/**
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type PublicCredentialsCall = PublicCredentialsCall_add | PublicCredentialsCall_revoke | PublicCredentialsCall_unrevoke | PublicCredentialsCall_remove | PublicCredentialsCall_reclaim_deposit | PublicCredentialsCall_change_deposit_owner | PublicCredentialsCall_update_deposit
...
export type Type_120 = Type_120_Concrete | Type_120_Abstract

export interface Type_120_Concrete {
    __kind: 'Concrete'
    value: V1MultiLocation
}

export interface Type_120_Abstract {
    __kind: 'Abstract'
    value: Uint8Array
}
