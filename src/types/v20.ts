...
export type Call = Call_System | Call_Utility | Call_Timestamp | Call_Identity | Call_Multisig | Call_ParachainSystem | Call_Balances | Call_Vesting | Call_Assets | Call_Treasury | Call_Scheduler | Call_TechnicalCommittee | Call_TechnicalMembership | Call_Democracy | Call_Preimage | Call_Datalog | Call_Launch | Call_Staking | Call_DigitalTwin | Call_RWS | Call_Liability | Call_Lighthouse | Call_XcmpQueue | Call_PolkadotXcm | Call_DmpQueue
