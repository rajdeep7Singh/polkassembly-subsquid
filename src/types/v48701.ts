...
export type Type_300 = Type_300_Approve | Type_300_Rebid | Type_300_Reject

export interface Type_300_Approve {
    __kind: 'Approve'
}

export interface Type_300_Rebid {
    __kind: 'Rebid'
}

export interface Type_300_Reject {
    __kind: 'Reject'
}
...
export interface NominationPoolsCall_set_configs {
    __kind: 'set_configs'
    minJoinBond: Type_317
    minCreateBond: Type_317
    maxPools: Type_318
    maxMembers: Type_318
    maxMembersPerPool: Type_318
}
...
export interface NominationPoolsCall_update_roles {
    ...
    poolId: number
    newRoot: Type_319
    newNominator: Type_319
    newStateToggler: Type_319
}
