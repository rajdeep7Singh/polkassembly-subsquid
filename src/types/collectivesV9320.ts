 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type AllianceCall = AllianceCall_add_unscrupulous_items | AllianceCall_announce | AllianceCall_close | AllianceCall_close_old_weight | AllianceCall_disband | AllianceCall_elevate_ally | AllianceCall_give_retirement_notice | AllianceCall_init_members | AllianceCall_join_alliance | AllianceCall_kick_member | AllianceCall_nominate_ally | AllianceCall_propose | AllianceCall_remove_announcement | AllianceCall_remove_unscrupulous_items | AllianceCall_retire | AllianceCall_set_rule | AllianceCall_veto | AllianceCall_vote
 ...
 */
export interface AllianceCall_veto {
    __kind: 'veto'
    proposalHash: H256
}
...
export const AllianceCall: sts.Type<AllianceCall> = sts.closedEnum(() => {
    return  {
        ...
        init_members: sts.enumStruct({
            founders: sts.array(() => AccountId32),
