...
export type Type_294 = Type_294_Response | Type_294_Xcm
...
export const OriginCaller: sts.Type<OriginCaller> = sts.closedEnum(() => {
    return  {
        AdvisoryCommittee: Type_290,
        Council: Type_291,
        CumulusXcm: Origin,
        PolkadotXcm: Type_294,
