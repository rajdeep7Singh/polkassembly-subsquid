...
export type Call = Call_System | Call_ParachainSystem | Call_Timestamp | Call_Preimage | Call_Multisig | Call_Proxy | Call_Scheduler | Call_Utility | Call_Balances | Call_Vesting | Call_Treasury | Call_Democracy | Call_Council | Call_TechnicalCommittee | Call_XcmpQueue | Call_PolkadotXcm | Call_CumulusXcm | Call_DmpQueue | Call_XTokens | Call_OrmlXcm | Call_XcmTransactor | Call_Teerex | Call_Claims | Call_Teeracle | Call_Sidechain
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type TeeracleCall = TeeracleCall_add_to_whitelist | TeeracleCall_remove_from_whitelist | TeeracleCall_update_oracle | TeeracleCall_update_exchange_rate
