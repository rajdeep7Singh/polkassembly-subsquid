...
export type Type_440 = Type_440_Casting | Type_440_Delegating

export interface Type_440_Casting {
    __kind: 'Casting'
    value: Casting
}

export interface Type_440_Delegating {
    __kind: 'Delegating'
    value: Delegating
}

export type Call = Call_System | Call_ParachainSystem | Call_Utility | Call_Timestamp | Call_Identity | Call_Recovery | Call_Scheduler | Call_Sudo | Call_Indices | Call_Balances | Call_Authorship | Call_CollatorSelection | Call_Session | Call_Democracy | Call_XcmpQueue | Call_PolkadotXcm | Call_DmpQueue | Call_Council | Call_TechnicalCommittee | Call_Elections | Call_TechnicalMembership | Call_Treasury | Call_Bounties | Call_ChildBounties | Call_Tips | Call_Assets | Call_Preimage | Call_Proxy | Call_Multisig | Call_Referenda | Call_ConvictionVoting
...
export type Type_427 = Type_427_Ongoing | Type_427_Approved | Type_427_Rejected | Type_427_Cancelled | Type_427_TimedOut | Type_427_Killed

export interface Type_427_Ongoing {
    __kind: 'Ongoing'
    value: Type_428
}

export interface Type_427_Approved {
    __kind: 'Approved'
    value: [number, Deposit, (Deposit | undefined)]
}

export interface Type_427_Rejected {
    __kind: 'Rejected'
    value: [number, Deposit, (Deposit | undefined)]
}

export interface Type_427_Cancelled {
    __kind: 'Cancelled'
    value: [number, Deposit, (Deposit | undefined)]
}

export interface Type_427_TimedOut {
    __kind: 'TimedOut'
    value: [number, Deposit, (Deposit | undefined)]
}

export interface Type_427_Killed {
    __kind: 'Killed'
    value: number
}
...
export type Type_240 = Type_240_V0 | Type_240_V1 | Type_240_V2

export interface Type_240_V0 {
    __kind: 'V0'
    value: Type_241
}

export interface Type_240_V1 {
    __kind: 'V1'
    value: Type_246
}

export interface Type_240_V2 {
    __kind: 'V2'
    value: Type_252[]
}
...
export type AtOrAfter = AtOrAfter_At | AtOrAfter_After

export interface AtOrAfter_At {
    __kind: 'At'
    value: number
}

export interface AtOrAfter_After {
    __kind: 'After'
    value: number
}
...
export type Type_275 = Type_275_Relay | Type_275_SiblingParachain

export interface Type_275_Relay {
    __kind: 'Relay'
}

export interface Type_275_SiblingParachain {
...
export type Type_241 = Type_241_WithdrawAsset | Type_241_ReserveAssetDeposit | Type_241_TeleportAsset | Type_241_QueryResponse | Type_241_TransferAsset | Type_241_TransferReserveAsset | Type_241_Transact | Type_241_HrmpNewChannelOpenRequest | Type_241_HrmpChannelAccepted | Type_241_HrmpChannelClosing | Type_241_RelayedFrom
...
export interface Type_241_ReserveAssetDeposit {
    __kind: 'ReserveAssetDeposit'
    assets: V0MultiAsset[]
    effects: Type_243[]
}

export interface Type_241_TeleportAsset {
    __kind: 'TeleportAsset'
    assets: V0MultiAsset[]
    effects: Type_243[]
}
...
export interface Type_241_RelayedFrom {
    __kind: 'RelayedFrom'
    who: V0MultiLocation
    message: Type_241
}

export type Type_246 = Type_246_WithdrawAsset | Type_246_ReserveAssetDeposited | Type_246_ReceiveTeleportedAsset | Type_246_QueryResponse | Type_246_TransferAsset | Type_246_TransferReserveAsset | Type_246_Transact | Type_246_HrmpNewChannelOpenRequest | Type_246_HrmpChannelAccepted | Type_246_HrmpChannelClosing | Type_246_RelayedFrom | Type_246_SubscribeVersion | Type_246_UnsubscribeVersion
...
export interface Type_246_ReserveAssetDeposited {
    __kind: 'ReserveAssetDeposited'
    assets: V1MultiAsset[]
    effects: Type_248[]
}

export interface Type_246_ReceiveTeleportedAsset {
    __kind: 'ReceiveTeleportedAsset'
    assets: V1MultiAsset[]
    effects: Type_248[]
}
...
export interface Type_246_SubscribeVersion {
    __kind: 'SubscribeVersion'
    queryId: bigint
    maxResponseWeight: bigint
}

export interface Type_246_UnsubscribeVersion {
    __kind: 'UnsubscribeVersion'
}

export type Type_252 = Type_252_WithdrawAsset | Type_252_ReserveAssetDeposited | Type_252_ReceiveTeleportedAsset | Type_252_QueryResponse | Type_252_TransferAsset | Type_252_TransferReserveAsset | Type_252_Transact | Type_252_HrmpNewChannelOpenRequest | Type_252_HrmpChannelAccepted | Type_252_HrmpChannelClosing | Type_252_ClearOrigin | Type_252_DescendOrigin | Type_252_ReportError | Type_252_DepositAsset | Type_252_DepositReserveAsset | Type_252_ExchangeAsset | Type_252_InitiateReserveWithdraw | Type_252_InitiateTeleport | Type_252_QueryHolding | Type_252_BuyExecution | Type_252_RefundSurplus | Type_252_SetErrorHandler | Type_252_SetAppendix | Type_252_ClearError | Type_252_ClaimAsset | Type_252_Trap | Type_252_SubscribeVersion | Type_252_UnsubscribeVersion
...
export interface Type_252_ClearOrigin {
    __kind: 'ClearOrigin'
}

export interface Type_252_DescendOrigin {
    __kind: 'DescendOrigin'
    value: V1Junctions
}

export interface Type_252_ReportError {
    __kind: 'ReportError'
    queryId: bigint
    dest: V1MultiLocation
    maxResponseWeight: bigint
...
export interface Type_252_RefundSurplus {
    __kind: 'RefundSurplus'
}

export interface Type_252_SetErrorHandler {
    __kind: 'SetErrorHandler'
    value: Type_252[]
}

export interface Type_252_SetAppendix {
    __kind: 'SetAppendix'
    value: Type_252[]
}

export interface Type_252_ClearError {
    __kind: 'ClearError'
}

export interface Type_252_ClaimAsset {
    __kind: 'ClaimAsset'
    assets: V1MultiAsset[]
    ticket: V1MultiLocation
}

export interface Type_252_Trap {
    __kind: 'Trap'
    value: bigint
}
...
export type Type_243 = Type_243_Null | Type_243_DepositAsset | Type_243_DepositReserveAsset | Type_243_ExchangeAsset | Type_243_InitiateReserveWithdraw | Type_243_InitiateTeleport | Type_243_QueryHolding | Type_243_BuyExecution

export interface Type_243_Null {
    __kind: 'Null'
}
...
export type Type_248 = Type_248_Noop | Type_248_DepositAsset | Type_248_DepositReserveAsset | Type_248_ExchangeAsset | Type_248_InitiateReserveWithdraw | Type_248_InitiateTeleport | Type_248_QueryHolding | Type_248_BuyExecution

export interface Type_248_Noop {
    __kind: 'Noop'
}
