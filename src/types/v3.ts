...
export type Call = Call_Authorship | Call_Balances | Call_Bounties | Call_ChildBounties | Call_CollatorSelection | Call_Council | Call_Currencies | Call_Democracy | Call_DmpQueue | Call_Multisig | Call_ParachainStaking | Call_ParachainSystem | Call_PolkadotXcm | Call_Preimage | Call_Scheduler | Call_Session | Call_Sudo | Call_System | Call_TechnicalCommittee | Call_Timestamp | Call_Tokens | Call_Treasury | Call_Utility | Call_Vesting | Call_XcmpQueue
...
export type Type_238 = Type_238_Relay | Type_238_SiblingParachain

export interface Type_238_Relay {
    __kind: 'Relay'
}

export interface Type_238_SiblingParachain {
...
export type ForeignCurrencyId = ForeignCurrencyId_AUSD | ForeignCurrencyId_BNC | ForeignCurrencyId_GENS | ForeignCurrencyId_HKO | ForeignCurrencyId_KAR | ForeignCurrencyId_KBTC | ForeignCurrencyId_KILT | ForeignCurrencyId_KINT | ForeignCurrencyId_KSM | ForeignCurrencyId_MOVR | ForeignCurrencyId_PHA | ForeignCurrencyId_SDN | ForeignCurrencyId_TEER | ForeignCurrencyId_USD | ForeignCurrencyId_VsKSM | ForeignCurrencyId_XOR | ForeignCurrencyId_ZTG
...
export type Type_215 = Type_215_V0 | Type_215_V1 | Type_215_V2

export interface Type_215_V0 {
    __kind: 'V0'
    value: Type_216
}

export interface Type_215_V1 {
    __kind: 'V1'
    value: Type_221
}
...
export type Type_227 = Type_227_BuyExecution | Type_227_ClaimAsset | Type_227_ClearError | Type_227_ClearOrigin | Type_227_DepositAsset | Type_227_DepositReserveAsset | Type_227_DescendOrigin | Type_227_ExchangeAsset | Type_227_HrmpChannelAccepted | Type_227_HrmpChannelClosing | Type_227_HrmpNewChannelOpenRequest | Type_227_InitiateReserveWithdraw | Type_227_InitiateTeleport | Type_227_QueryHolding | Type_227_QueryResponse | Type_227_ReceiveTeleportedAsset | Type_227_RefundSurplus | Type_227_ReportError | Type_227_ReserveAssetDeposited | Type_227_SetAppendix | Type_227_SetErrorHandler | Type_227_SubscribeVersion | Type_227_Transact | Type_227_TransferAsset | Type_227_TransferReserveAsset | Type_227_Trap | Type_227_UnsubscribeVersion | Type_227_WithdrawAsset
...
export interface Type_227_ClaimAsset {
    __kind: 'ClaimAsset'
    assets: V1MultiAsset[]
    ticket: V1MultiLocation
}

export interface Type_227_ClearError {
    __kind: 'ClearError'
}

export interface Type_227_ClearOrigin {
    __kind: 'ClearOrigin'
}
...
export interface Type_227_DescendOrigin {
    __kind: 'DescendOrigin'
    value: V1Junctions
}
...
export interface Type_227_RefundSurplus {
    __kind: 'RefundSurplus'
}

export interface Type_227_ReportError {
    __kind: 'ReportError'
    queryId: bigint
    dest: V1MultiLocation
    maxResponseWeight: bigint
...
export interface Type_227_SetAppendix {
    __kind: 'SetAppendix'
    value: Type_227[]
}

export interface Type_227_SetErrorHandler {
    __kind: 'SetErrorHandler'
    value: Type_227[]
}
...
export interface Type_227_Trap {
    __kind: 'Trap'
    value: bigint
}
...
export type Type_221 = Type_221_HrmpChannelAccepted | Type_221_HrmpChannelClosing | Type_221_HrmpNewChannelOpenRequest | Type_221_QueryResponse | Type_221_ReceiveTeleportedAsset | Type_221_RelayedFrom | Type_221_ReserveAssetDeposited | Type_221_SubscribeVersion | Type_221_Transact | Type_221_TransferAsset | Type_221_TransferReserveAsset | Type_221_UnsubscribeVersion | Type_221_WithdrawAsset
...
export type Type_223 = Type_223_BuyExecution | Type_223_DepositAsset | Type_223_DepositReserveAsset | Type_223_ExchangeAsset | Type_223_InitiateReserveWithdraw | Type_223_InitiateTeleport | Type_223_Noop | Type_223_QueryHolding
...
export type Type_216 = Type_216_HrmpChannelAccepted | Type_216_HrmpChannelClosing | Type_216_HrmpNewChannelOpenRequest | Type_216_QueryResponse | Type_216_RelayedFrom | Type_216_ReserveAssetDeposit | Type_216_TeleportAsset | Type_216_Transact | Type_216_TransferAsset | Type_216_TransferReserveAsset | Type_216_WithdrawAsset
...
export interface Type_216_RelayedFrom {
    __kind: 'RelayedFrom'
    who: V0MultiLocation
    message: Type_216
}

export interface Type_216_ReserveAssetDeposit {
    __kind: 'ReserveAssetDeposit'
    assets: V0MultiAsset[]
    effects: Type_218[]
}

export interface Type_216_TeleportAsset {
    __kind: 'TeleportAsset'
    assets: V0MultiAsset[]
    effects: Type_218[]
}
...
export type Type_218 = Type_218_BuyExecution | Type_218_DepositAsset | Type_218_DepositReserveAsset | Type_218_ExchangeAsset | Type_218_InitiateReserveWithdraw | Type_218_InitiateTeleport | Type_218_Null | Type_218_QueryHolding
...
export interface Type_218_Null {
    __kind: 'Null'
}
...
export const Type_227: sts.Type<Type_227> = sts.closedEnum(() => {
    return  {
        ...
        ReserveAssetDeposited: sts.array(() => V1MultiAsset),
        SetAppendix: sts.array(() => Type_227),
        SetErrorHandler: sts.array(() => Type_227),
        SubscribeVersion: sts.enumStruct({
            queryId: sts.bigint(),
            maxResponseWeight: sts.bigint(),
        }),
...
export const Type_223: sts.Type<Type_223> = sts.closedEnum(() => {
    return  {
        BuyExecution: sts.enumStruct({
            ...
            debt: sts.bigint(),
            haltOnError: sts.boolean(),
            instructions: sts.array(() => Type_221),
        }),
        DepositAsset: sts.enumStruct({
            assets: V1MultiAssetFilter,
            maxAssets: sts.number(),
