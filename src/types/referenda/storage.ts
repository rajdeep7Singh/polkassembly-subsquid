...
import * as v1017000 from '../v1017000'
import * as v1018000 from '../v1018000'
...
export const referendumInfoFor =  {
     ...
     *  Information concerning any given referendum.
     */
    v1017000: new StorageType('Referenda.ReferendumInfoFor', 'Optional', [sts.number()], v1017000.ReferendumInfo) as ReferendumInfoForV1017000,
    /**
     *  Information concerning any given referendum.
     */
    v1018000: new StorageType('Referenda.ReferendumInfoFor', 'Optional', [sts.number()], v1018000.ReferendumInfo) as ReferendumInfoForV1018000,
}
 ...
 *  Information concerning any given referendum.
 */
export interface ReferendumInfoForV1017000  {
    is(block: RuntimeCtx): boolean
    get(block: Block, key: number): Promise<(v1017000.ReferendumInfo | undefined)>
    getMany(block: Block, keys: number[]): Promise<(v1017000.ReferendumInfo | undefined)[]>
    getKeys(block: Block): Promise<number[]>
    getKeys(block: Block, key: number): Promise<number[]>
    getKeysPaged(pageSize: number, block: Block): AsyncIterable<number[]>
    getKeysPaged(pageSize: number, block: Block, key: number): AsyncIterable<number[]>
    getPairs(block: Block): Promise<[k: number, v: (v1017000.ReferendumInfo | undefined)][]>
    getPairs(block: Block, key: number): Promise<[k: number, v: (v1017000.ReferendumInfo | undefined)][]>
    getPairsPaged(pageSize: number, block: Block): AsyncIterable<[k: number, v: (v1017000.ReferendumInfo | undefined)][]>
    getPairsPaged(pageSize: number, block: Block, key: number): AsyncIterable<[k: number, v: (v1017000.ReferendumInfo | undefined)][]>
}

/**
 *  Information concerning any given referendum.
 */
export interface ReferendumInfoForV1018000  {
    is(block: RuntimeCtx): boolean
    get(block: Block, key: number): Promise<(v1018000.ReferendumInfo | undefined)>
    getMany(block: Block, keys: number[]): Promise<(v1018000.ReferendumInfo | undefined)[]>
    getKeys(block: Block): Promise<number[]>
    getKeys(block: Block, key: number): Promise<number[]>
    getKeysPaged(pageSize: number, block: Block): AsyncIterable<number[]>
    getKeysPaged(pageSize: number, block: Block, key: number): AsyncIterable<number[]>
    getPairs(block: Block): Promise<[k: number, v: (v1018000.ReferendumInfo | undefined)][]>
    getPairs(block: Block, key: number): Promise<[k: number, v: (v1018000.ReferendumInfo | undefined)][]>
    getPairsPaged(pageSize: number, block: Block): AsyncIterable<[k: number, v: (v1018000.ReferendumInfo | undefined)][]>
    getPairsPaged(pageSize: number, block: Block, key: number): AsyncIterable<[k: number, v: (v1018000.ReferendumInfo | undefined)][]>
}
