...
export interface CdpEngineCall_set_collateral_params {
    ...
    maximumTotalDebitValue: Type_316
}
...
export type Type_316 = Type_316_NoChange | Type_316_NewValue

export interface Type_316_NoChange {
    __kind: 'NoChange'
}

export interface Type_316_NewValue {
    __kind: 'NewValue'
    value: bigint
}
