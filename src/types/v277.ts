 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type AssetHandlerCall = AssetHandlerCall_allowlist_token | AssetHandlerCall_create_asset | AssetHandlerCall_mint_asset | AssetHandlerCall_remove_allowlisted_token | AssetHandlerCall_set_block_delay | AssetHandlerCall_set_bridge_status | AssetHandlerCall_update_fee | AssetHandlerCall_withdraw
