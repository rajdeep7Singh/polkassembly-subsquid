 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type AssetHandlerCall = AssetHandlerCall_create_asset | AssetHandlerCall_mint_asset | AssetHandlerCall_set_bridge_status | AssetHandlerCall_set_block_delay | AssetHandlerCall_withdraw | AssetHandlerCall_update_fee | AssetHandlerCall_allowlist_token | AssetHandlerCall_remove_allowlisted_token
...
export type Type_216 = Type_216_Noop | Type_216_Set | Type_216_Remove
