...
/**
 * See [`Pallet::root_do_auction_closing`].
 */
export interface FundingCall_root_do_auction_closing {
    __kind: 'root_do_auction_closing'
    projectId: number
}
...
export const FundingCall: sts.Type<FundingCall> = sts.closedEnum(() => {
    return  {
        ...
        root_do_auction_closing: sts.enumStruct({
            projectId: sts.number(),
        }),
