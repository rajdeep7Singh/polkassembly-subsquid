...
export type ProxyType = ProxyType_Any | ProxyType_Loans | ProxyType_Staking | ProxyType_Crowdloans | ProxyType_Farming | ProxyType_Streaming | ProxyType_Governance | ProxyType_AMM
