...
export const OpenTip: sts.Type<OpenTip> = sts.struct(() => {
    return  {
        ...
        finder: AccountId32,
        deposit: sts.bigint(),
        closes: sts.option(() => sts.number()),
        tips: sts.array(() => sts.tuple(() => [AccountId32, sts.bigint()])),
...
export interface Type_436 {
    encoded: Bytes
}

export type Type_437 = Type_437_HrmpChannelAccepted | Type_437_HrmpChannelClosing | Type_437_HrmpNewChannelOpenRequest | Type_437_QueryResponse | Type_437_ReceiveTeleportedAsset | Type_437_RelayedFrom | Type_437_ReserveAssetDeposited | Type_437_SubscribeVersion | Type_437_Transact | Type_437_TransferAsset | Type_437_TransferReserveAsset | Type_437_UnsubscribeVersion | Type_437_WithdrawAsset
...
export type Type_439 = Type_439_BuyExecution | Type_439_DepositAsset | Type_439_DepositReserveAsset | Type_439_ExchangeAsset | Type_439_InitiateReserveWithdraw | Type_439_InitiateTeleport | Type_439_Noop | Type_439_QueryHolding
...
export type Type_434 = Type_434_BuyExecution | Type_434_DepositAsset | Type_434_DepositReserveAsset | Type_434_ExchangeAsset | Type_434_InitiateReserveWithdraw | Type_434_InitiateTeleport | Type_434_Null | Type_434_QueryHolding
...
export type Type_307 = Type_307_Response | Type_307_Xcm
...
export type Type_350 = Type_350_Approve | Type_350_Rebid | Type_350_Reject
...
export const Type_436: sts.Type<Type_436> = sts.struct(() => {
    return  {
        encoded: sts.bytes(),
    }
})
...
export const Type_439: sts.Type<Type_439> = sts.closedEnum(() => {
    return  {
        BuyExecution: sts.enumStruct({
            ...
            debt: sts.bigint(),
            haltOnError: sts.boolean(),
            instructions: sts.array(() => Type_437),
        }),
        DepositAsset: sts.enumStruct({
            assets: V1MultiAssetFilter,
            maxAssets: sts.number(),
