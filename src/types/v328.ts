...
export type Type_366 = Type_366_Member | Type_366_Members | Type_366__Phantom
 ...
 * Contains a variant per dispatchable extrinsic that this pallet has.
 */
export type TheaExecutorCall = TheaExecutorCall_burn_native_tokens | TheaExecutorCall_claim_deposit | TheaExecutorCall_evm_withdraw | TheaExecutorCall_parachain_withdraw | TheaExecutorCall_set_withdrawal_fee | TheaExecutorCall_update_asset_metadata | TheaExecutorCall_withdraw

/**
 * See [`Pallet::burn_native_tokens`].
 */
export interface TheaExecutorCall_burn_native_tokens {
    __kind: 'burn_native_tokens'
    who: AccountId32
    amount: bigint
}
...
/**
 * See [`Pallet::evm_withdraw`].
 */
export interface TheaExecutorCall_evm_withdraw {
    __kind: 'evm_withdraw'
    assetId: bigint
    amount: bigint
    beneficiary: H160
 ...
 * Contains a variant per dispatchable extrinsic that this pallet has.
 */
export type TheaCall = TheaCall_add_relayer_origin_for_network | TheaCall_add_thea_network | TheaCall_handle_misbehaviour | TheaCall_remove_thea_network | TheaCall_report_misbehaviour | TheaCall_send_thea_message | TheaCall_submit_incoming_message | TheaCall_submit_signed_outgoing_messages | TheaCall_update_incoming_nonce | TheaCall_update_outgoing_nonce

/**
 * See [`Pallet::add_relayer_origin_for_network`].
 */
export interface TheaCall_add_relayer_origin_for_network {
    __kind: 'add_relayer_origin_for_network'
    network: number
    relayer: AccountId32
}
...
export interface TheaCall_add_thea_network {
    ...
    forkPeriod: number
    minStake: bigint
    fishermanStake: bigint
}

/**
 * See [`Pallet::handle_misbehaviour`].
 */
export interface TheaCall_handle_misbehaviour {
    __kind: 'handle_misbehaviour'
    network: number
    nonce: bigint
    acceptance: boolean
}
...
/**
 * See [`Pallet::report_misbehaviour`].
 */
export interface TheaCall_report_misbehaviour {
    __kind: 'report_misbehaviour'
    network: number
    nonce: bigint
}
...
/**
 * See [`Pallet::submit_incoming_message`].
 */
export interface TheaCall_submit_incoming_message {
    __kind: 'submit_incoming_message'
    payload: Message
    stake: bigint
}

/**
 * See [`Pallet::submit_signed_outgoing_messages`].
 */
export interface TheaCall_submit_signed_outgoing_messages {
    __kind: 'submit_signed_outgoing_messages'
    authIndex: number
    id: bigint
    signatures: [number, bigint, Bytes][]
}
...
export type PayloadType = PayloadType_L1Deposit | PayloadType_ScheduledRotateValidators | PayloadType_ValidatorsRotated

export interface PayloadType_L1Deposit {
    __kind: 'L1Deposit'
}

export interface PayloadType_ScheduledRotateValidators {
    __kind: 'ScheduledRotateValidators'
}

export interface PayloadType_ValidatorsRotated {
    __kind: 'ValidatorsRotated'
}
...
export interface StakingCall_set_staking_configs {
    ...
    maxNominatorCount: Type_235
    maxValidatorCount: Type_235
    chillThreshold: Type_236
    minCommission: Type_237
}
...
export type Type_237 = Type_237_Noop | Type_237_Remove | Type_237_Set

export interface Type_237_Noop {
    __kind: 'Noop'
}

export interface Type_237_Remove {
    __kind: 'Remove'
}

export interface Type_237_Set {
    __kind: 'Set'
    value: Perbill
}

export type Type_236 = Type_236_Noop | Type_236_Remove | Type_236_Set

export interface Type_236_Noop {
    __kind: 'Noop'
}

export interface Type_236_Remove {
    __kind: 'Remove'
}

export interface Type_236_Set {
    __kind: 'Set'
    value: Percent
}
 ...
 * Contains a variant per dispatchable extrinsic that this pallet has.
 */
export type RewardsCall = RewardsCall_claim | RewardsCall_create_reward_cycle | RewardsCall_initialize_claim_rewards | RewardsCall_unsigned_claim | RewardsCall_unsigned_initialize_claim_rewards
...
/**
 * See [`Pallet::unsigned_claim`].
 */
export interface RewardsCall_unsigned_claim {
    __kind: 'unsigned_claim'
    payload: ExchangePayload
    signature: MultiSignature
}

/**
 * See [`Pallet::unsigned_initialize_claim_rewards`].
 */
export interface RewardsCall_unsigned_initialize_claim_rewards {
    __kind: 'unsigned_initialize_claim_rewards'
    payload: ExchangePayload
    signature: MultiSignature
}
...
export interface ExchangePayload {
    rewardId: number
    action: ExchangePayloadAction
    user: AccountId32
}

export type ExchangePayloadAction = ExchangePayloadAction_Claim | ExchangePayloadAction_Initialize

export interface ExchangePayloadAction_Claim {
    __kind: 'Claim'
}

export interface ExchangePayloadAction_Initialize {
    __kind: 'Initialize'
}
...
export const OriginCaller: sts.Type<OriginCaller> = sts.closedEnum(() => {
    return  {
        Council: Type_364,
        OrderbookCommittee: Type_366,
        TechnicalCommittee: Type_365,
        Void: Void,
        system: RawOrigin,
    }
})
...
export const TheaExecutorCall: sts.Type<TheaExecutorCall> = sts.closedEnum(() => {
    return  {
        burn_native_tokens: sts.enumStruct({
            who: AccountId32,
            amount: sts.bigint(),
        }),
...
export const TheaCall: sts.Type<TheaCall> = sts.closedEnum(() => {
    return  {
        add_relayer_origin_for_network: sts.enumStruct({
            network: sts.number(),
            relayer: AccountId32,
        }),
        add_thea_network: sts.enumStruct({
            network: sts.number(),
            isEvm: sts.boolean(),
            forkPeriod: sts.number(),
            minStake: sts.bigint(),
            fishermanStake: sts.bigint(),
        }),
        handle_misbehaviour: sts.enumStruct({
            network: sts.number(),
            nonce: sts.bigint(),
            acceptance: sts.boolean(),
        }),
        remove_thea_network: sts.enumStruct({
            network: sts.number(),
        }),
        report_misbehaviour: sts.enumStruct({
            network: sts.number(),
            nonce: sts.bigint(),
        }),
        ...
        submit_incoming_message: sts.enumStruct({
            payload: Message,
            stake: sts.bigint(),
        }),
        submit_signed_outgoing_messages: sts.enumStruct({
            authIndex: sts.number(),
            id: sts.bigint(),
            signatures: sts.array(() => sts.tuple(() => [sts.number(), sts.bigint(), sts.bytes()])),
        }),
...
export const PayloadType: sts.Type<PayloadType> = sts.closedEnum(() => {
    return  {
        L1Deposit: sts.unit(),
        ScheduledRotateValidators: sts.unit(),
        ValidatorsRotated: sts.unit(),
    }
})
...
export const RewardsCall: sts.Type<RewardsCall> = sts.closedEnum(() => {
    return  {
        ...
        unsigned_claim: sts.enumStruct({
            payload: ExchangePayload,
            signature: MultiSignature,
        }),
        unsigned_initialize_claim_rewards: sts.enumStruct({
            payload: ExchangePayload,
            signature: MultiSignature,
        }),
    }
...
export const ExchangePayload: sts.Type<ExchangePayload> = sts.struct(() => {
    return  {
        rewardId: sts.number(),
        action: ExchangePayloadAction,
        user: AccountId32,
...
export const ExchangePayloadAction: sts.Type<ExchangePayloadAction> = sts.closedEnum(() => {
    return  {
        Claim: sts.unit(),
        Initialize: sts.unit(),
    }
