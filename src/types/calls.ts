...
export class ChildBountiesAcceptCuratorCall {
     ...
     * - `child_bounty_id`: Index of child bounty.
     */
    get asV3(): {parentBountyId: number, childBountyId: number} {
        assert(this.isV3)
        return this._chain.decodeCall(this.call)
    }
}
...
export class ConvictionVotingDelegateCall {
     ...
     */
    get isV3(): boolean {
        return this._chain.getCallHash('ConvictionVoting.delegate') === '518fcfd91168be426cea8f8f3e5133461215db4e3cd93f680e147ea4bed43edf'
    }
     ...
     *   voted on. Weight is initially charged as if maximum votes, but is refunded later.
     */
    get asV3(): {class: number, to: Uint8Array, conviction: v3.Conviction, balance: bigint} {
        assert(this.isV3)
        return this._chain.decodeCall(this.call)
    }
     ...
     */
    get isV6(): boolean {
        return this._chain.getCallHash('ConvictionVoting.delegate') === 'bf33453d316ddb25fba7edc9cd47cafc42467c323d9d32c481f03ba49541eeca'
    }
     ...
     *   voted on. Weight is initially charged as if maximum votes, but is refunded later.
     */
    get asV6(): {class: number, to: v6.MultiAddress, conviction: v6.Conviction, balance: bigint} {
        assert(this.isV6)
        return this._chain.decodeCall(this.call)
    }
}
...
export class ConvictionVotingRemoveOtherVoteCall {
     ...
     */
    get isV3(): boolean {
        return this._chain.getCallHash('ConvictionVoting.remove_other_vote') === '38eb0efc2ff2c35be577c4cff30fe697930e3fcbbf8ad887fe2d3ab287a116f4'
    }
     ...
     *   Weight is calculated for the maximum number of vote.
     */
    get asV3(): {target: Uint8Array, class: number, index: number} {
        assert(this.isV3)
        return this._chain.decodeCall(this.call)
    }
     ...
     */
    get isV6(): boolean {
        return this._chain.getCallHash('ConvictionVoting.remove_other_vote') === 'a088b3cb0d03ec41f359f4bd548d969cf243260f2d97247ff7238e5c3bf9e3c0'
    }
     ...
     *   Weight is calculated for the maximum number of vote.
     */
    get asV6(): {target: v6.MultiAddress, class: number, index: number} {
        assert(this.isV6)
        return this._chain.decodeCall(this.call)
    }
}
...
export class ConvictionVotingRemoveVoteCall {
     ...
     */
    get isV3(): boolean {
        return this._chain.getCallHash('ConvictionVoting.remove_vote') === '819e3ee132b5e74043d56d0e37f5543d881cc8937199bbc9fe2ef9d2cd768758'
    }
     ...
     *   Weight is calculated for the maximum number of vote.
     */
    get asV3(): {class: (number | undefined), index: number} {
        assert(this.isV3)
        return this._chain.decodeCall(this.call)
    }
}
...
export class ConvictionVotingUndelegateCall {
     ...
     */
    get isV3(): boolean {
        return this._chain.getCallHash('ConvictionVoting.undelegate') === '7800fc406131881b4f8642f56efffc421df35869997bf0c008752d613d1b16d4'
    }
...
export class ConvictionVotingVoteCall {
     ...
     * Weight: `O(R)` where R is the number of polls the voter has voted on.
     */
    get asV3(): {pollIndex: number, vote: v3.AccountVote} {
        assert(this.isV3)
        return this._chain.decodeCall(this.call)
    }
}
...
export class DemocracyDelegateCall {
     ...
     *   voted on. Weight is charged as if maximum votes.
     */
    get asV3(): {to: Uint8Array, conviction: v3.Conviction, balance: bigint} {
        assert(this.isV3)
        return this._chain.decodeCall(this.call)
    }
...
export class DemocracyRemoveOtherVoteCall {
     ...
     *   Weight is calculated for the maximum number of vote.
     */
    get asV3(): {target: Uint8Array, index: number} {
        assert(this.isV3)
        return this._chain.decodeCall(this.call)
    }
...
export class DemocracyVoteCall {
     ...
     * Weight: `O(R)` where R is the number of referendums the voter has voted on.
     */
    get asV3(): {refIndex: number, vote: v3.AccountVote} {
        assert(this.isV3)
        return this._chain.decodeCall(this.call)
    }
}
...
export class TipsTipCall {
     ...
     * # </weight>
     */
    get asV3(): {hash: Uint8Array, tipValue: bigint} {
        assert(this.isV3)
        return this._chain.decodeCall(this.call)
    }
}
