...
export class DemocracyDelegateCall {
     ...
     *   voted on. Weight is charged as if maximum votes.
     */
    get asV1400(): {to: Uint8Array, conviction: v1400.Conviction, balance: bigint} {
        assert(this.isV1400)
     ...
     *   voted on. Weight is charged as if maximum votes.
     */
    get asV10009(): {to: v10009.MultiAddress, conviction: v10009.Conviction, balance: bigint} {
...
export class DemocracyRemoveOtherVoteCall {
     ...
     *   Weight is calculated for the maximum number of vote.
     */
    get asV1400(): {target: Uint8Array, index: number} {
        assert(this.isV1400)
        return this._chain.decodeCall(this.call)
    }
     ...
     *   Weight is calculated for the maximum number of vote.
     */
    get asV10009(): {target: v10009.MultiAddress, index: number} {
        assert(this.isV10009)
        return this._chain.decodeCall(this.call)
    }
}
...
export class DemocracyVoteCall {
     ...
     * Weight: `O(R)` where R is the number of referendums the voter has voted on.
     */
    get asV1400(): {refIndex: number, vote: v1400.AccountVote} {
        assert(this.isV1400)
        return this._chain.decodeCall(this.call)
    }
}
