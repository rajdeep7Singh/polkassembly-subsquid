...
export class DemocracyDelegateCall {
     ...
     *   voted on. Weight is charged as if maximum votes.
     */
    get asV172(): {to: Uint8Array, conviction: v172.Conviction, balance: bigint} {
        assert(this.isV172)
     ...
     *   voted on. Weight is charged as if maximum votes.
     */
    get asV194(): {to: v194.MultiAddress, conviction: v194.Conviction, balance: bigint} {
        assert(this.isV194)
        return this._chain.decodeCall(this.call)
    }
}
...
export class DemocracyRemoveOtherVoteCall {
     ...
     *   Weight is calculated for the maximum number of vote.
     */
    get asV172(): {target: Uint8Array, index: number} {
        assert(this.isV172)
        return this._chain.decodeCall(this.call)
    }
     ...
     *   Weight is calculated for the maximum number of vote.
     */
    get asV194(): {target: v194.MultiAddress, index: number} {
        assert(this.isV194)
        return this._chain.decodeCall(this.call)
    }
}
...
export class DemocracyVoteCall {
     ...
     * Weight: `O(R)` where R is the number of referendums the voter has voted on.
     */
    get asV172(): {refIndex: number, vote: v172.AccountVote} {
        assert(this.isV172)
        return this._chain.decodeCall(this.call)
    }
}
