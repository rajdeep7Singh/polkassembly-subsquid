...
export class AllianceMotionExecuteCall {
    ...
    get isV1000000(): boolean {
        return this._chain.getCallHash('AllianceMotion.execute') === 'ba0743eea08b6bceb0e45a0808e2067a32722b74065dd67392be7dff300e7aae'
    }

    /**
     * See [`Pallet::execute`].
     */
    get asV1000000(): {proposal: v1000000.Call, lengthBound: number} {
...
export class AllianceMotionProposeCall {
     ...
     */
    get isV1000000(): boolean {
        return this._chain.getCallHash('AllianceMotion.propose') === '8622c9a3cf90d773bddd919e0937361bf9219b8afef695982e7332856bd221bd'
    }

    /**
     * See [`Pallet::propose`].
     */
    get asV1000000(): {threshold: number, proposal: v1000000.Call, lengthBound: number} {
        assert(this.isV1000000)
        return this._chain.decodeCall(this.call)
    }
}
