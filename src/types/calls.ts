...
export class DemocracyDelegateCall {
     ...
     *   voted on. Weight is charged as if maximum votes.
     */
    get asV2000(): {to: Uint8Array, conviction: v2000.Conviction, balance: bigint} {
        assert(this.isV2000)
        return this._chain.decodeCall(this.call)
    }
...
export class DemocracyRemoveOtherVoteCall {
     ...
     *   Weight is calculated for the maximum number of vote.
     */
    get asV2000(): {target: Uint8Array, index: number} {
        assert(this.isV2000)
        return this._chain.decodeCall(this.call)
    }
...
export class TipsTipCall {
     ...
     * # </weight>
     */
    get asV2000(): {hash: Uint8Array, tipValue: bigint} {
        assert(this.isV2000)
        return this._chain.decodeCall(this.call)
    }
}
