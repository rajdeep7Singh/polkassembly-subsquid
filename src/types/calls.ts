...
export class ChildBountiesAcceptCuratorCall {
     ...
     * - `child_bounty_id`: Index of child bounty.
     */
    get asV299(): {parentBountyId: number, childBountyId: number} {
        assert(this.isV299)
        return this._chain.decodeCall(this.call)
    }
}
...
export class DemocracyDelegateCall {
     ...
     *  # </weight>
     */
    get asV266(): {to: Uint8Array, conviction: v266.Conviction, balance: bigint} {
        assert(this.isV266)
        return this._chain.decodeCall(this.call)
    }
     ...
     *   voted on. Weight is charged as if maximum votes.
     */
    get asV47000(): {to: v47000.MultiAddress, conviction: v47000.Conviction, balance: bigint} {
...
export class DemocracyRemoveOtherVoteCall {
     ...
     *  # </weight>
     */
    get asV266(): {target: Uint8Array, index: number} {
        assert(this.isV266)
        return this._chain.decodeCall(this.call)
    }
     ...
     *   Weight is calculated for the maximum number of vote.
     */
    get asV47000(): {target: v47000.MultiAddress, index: number} {
        assert(this.isV47000)
        return this._chain.decodeCall(this.call)
    }
}
...
export class DemocracyVoteCall {
     ...
     *  # </weight>
     */
    get asV266(): {refIndex: number, vote: v266.AccountVote} {
        assert(this.isV266)
        return this._chain.decodeCall(this.call)
    }
     ...
     * Weight: `O(R)` where R is the number of referendums the voter has voted on.
     */
    get asV295(): {refIndex: number, vote: v295.AccountVote} {
        assert(this.isV295)
        return this._chain.decodeCall(this.call)
    }
}
...
export class TipsTipCall {
     ...
     *  # </weight>
     */
    get asV283(): {hash: Uint8Array, tipValue: bigint} {
        assert(this.isV283)
        return this._chain.decodeCall(this.call)
    }
}
...
export class TreasuryTipCall {
     ...
     *  # </weight>
     */
    get asV266(): {hash: Uint8Array, tipValue: bigint} {
        assert(this.isV266)
        return this._chain.decodeCall(this.call)
    }
}
