...
export class DemocracyDelegateCall {
     ...
     *   voted on. Weight is charged as if maximum votes.
     */
    get asV12(): {to: v12.MultiAddress, conviction: v12.Conviction, balance: bigint} {
        assert(this.isV12)
...
export class DemocracyRemoveOtherVoteCall {
     ...
     *   Weight is calculated for the maximum number of vote.
     */
    get asV12(): {target: v12.MultiAddress, index: number} {
        assert(this.isV12)
        return this._chain.decodeCall(this.call)
    }
}
...
export class DemocracyVoteCall {
     ...
     * Weight: `O(R)` where R is the number of referendums the voter has voted on.
     */
    get asV12(): {refIndex: number, vote: v12.AccountVote} {
        assert(this.isV12)
        return this._chain.decodeCall(this.call)
    }
}
