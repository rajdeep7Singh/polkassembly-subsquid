...
export class ConvictionVotingDelegateCall {
     ...
     * See [`Pallet::delegate`].
     */
    get asV103000(): {class: number, to: v103000.MultiAddress, conviction: v103000.Conviction, balance: bigint} {
...
export class ConvictionVotingRemoveOtherVoteCall {
     ...
     * See [`Pallet::remove_other_vote`].
     */
    get asV103000(): {target: v103000.MultiAddress, class: number, index: number} {
        assert(this.isV103000)
        return this._chain.decodeCall(this.call)
    }
}
...
export class ConvictionVotingRemoveVoteCall {
     ...
     * See [`Pallet::remove_vote`].
     */
    get asV103000(): {class: (number | undefined), index: number} {
        assert(this.isV103000)
        return this._chain.decodeCall(this.call)
    }
}
...
export class ConvictionVotingVoteCall {
     ...
     * See [`Pallet::vote`].
     */
    get asV103000(): {pollIndex: number, vote: v103000.AccountVote} {
        assert(this.isV103000)
        return this._chain.decodeCall(this.call)
    }
}
...
export class FellowshipCollectiveVoteCall {
     ...
     * See [`Pallet::vote`].
     */
    get asV103000(): {poll: number, aye: boolean} {
        assert(this.isV103000)
        return this._chain.decodeCall(this.call)
    }
}
