...
export class DemocracyDelegateCall {
     ...
     *    voted on. Weight is charged as if maximum votes.
     */
    get asV25(): {to: Uint8Array, conviction: v25.Conviction, balance: bigint} {
        assert(this.isV25)
     ...
     *   voted on. Weight is charged as if maximum votes.
     */
    get asV10750(): {to: v10750.MultiAddress, conviction: v10750.Conviction, balance: bigint} {
...
export class DemocracyRemoveOtherVoteCall {
     ...
     *    Weight is calculated for the maximum number of vote.
     */
    get asV25(): {target: Uint8Array, index: number} {
        assert(this.isV25)
        return this._chain.decodeCall(this.call)
    }
     ...
     *   Weight is calculated for the maximum number of vote.
     */
    get asV10750(): {target: v10750.MultiAddress, index: number} {
        assert(this.isV10750)
        return this._chain.decodeCall(this.call)
    }
}
...
export class DemocracyVoteCall {
     ...
     * Weight: `O(R)` where R is the number of referendums the voter has voted on.
     */
    get asV2800(): {refIndex: number, vote: v2800.AccountVote} {
        assert(this.isV2800)
        return this._chain.decodeCall(this.call)
    }
}
...
export class TipsTipCall {
     ...
     * # </weight>
     */
    get asV10700(): {hash: Uint8Array, tipValue: bigint} {
