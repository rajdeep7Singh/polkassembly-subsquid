...
export class DemocracyDelegateCall {
     ...
     *    voted on. Weight is charged as if maximum votes.
     */
    get asV1001(): {to: Uint8Array, conviction: v1001.Conviction, balance: bigint} {
        assert(this.isV1001)
        return this._chain.decodeCall(this.call)
    }
    ...
    get asV2110(): {to: v2110.MultiAddress, conviction: v2110.Conviction, balance: bigint} {
        assert(this.isV2110)
        return this._chain.decodeCall(this.call)
    }
}
...
export class DemocracyRemoveOtherVoteCall {
     ...
     *    Weight is calculated for the maximum number of vote.
     */
    get asV1001(): {target: Uint8Array, index: number} {
        assert(this.isV1001)
        return this._chain.decodeCall(this.call)
    }
    ...
    get asV2110(): {target: v2110.MultiAddress, index: number} {
        assert(this.isV2110)
        return this._chain.decodeCall(this.call)
    }
}
...
export class TipsTipCall {
     ...
     *  # </weight>
     */
    get asV1000(): {hash: Uint8Array, tipValue: bigint} {
        assert(this.isV1000)
        return this._chain.decodeCall(this.call)
    }
}
