...
export class DemocracyDelegateCall {
     ...
     *   voted on. Weight is charged as if maximum votes.
     */
    get asV21(): {to: Uint8Array, conviction: v21.Conviction, balance: bigint} {
        assert(this.isV21)
     ...
     *   voted on. Weight is charged as if maximum votes.
     */
    get asV28(): {to: v28.MultiAddress, conviction: v28.Conviction, balance: bigint} {
        assert(this.isV28)
        return this._chain.decodeCall(this.call)
    }
}
...
export class DemocracyRemoveOtherVoteCall {
     ...
     *   Weight is calculated for the maximum number of vote.
     */
    get asV21(): {target: Uint8Array, index: number} {
        assert(this.isV21)
        return this._chain.decodeCall(this.call)
    }
     ...
     *   Weight is calculated for the maximum number of vote.
     */
    get asV28(): {target: v28.MultiAddress, index: number} {
        assert(this.isV28)
        return this._chain.decodeCall(this.call)
    }
}
...
export class DemocracyVoteCall {
     ...
     * Weight: `O(R)` where R is the number of referendums the voter has voted on.
     */
    get asV21(): {refIndex: number, vote: v21.AccountVote} {
        assert(this.isV21)
        return this._chain.decodeCall(this.call)
    }
}
