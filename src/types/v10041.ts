...
export type Call = Call_System | Call_Timestamp | Call_Sudo | Call_AssetTxPayment | Call_Indices | Call_Balances | Call_Identity | Call_Multisig | Call_ParachainSystem | Call_ParachainInfo | Call_CollatorSelection | Call_Session | Call_Council | Call_CouncilMembership | Call_Treasury | Call_TechnicalCommittee | Call_TechnicalCommitteeMembership | Call_ReleaseCommittee | Call_ReleaseMembership | Call_RelayerCommittee | Call_RelayerCommitteeMembership | Call_Scheduler | Call_Utility | Call_Preimage | Call_Proxy | Call_XcmpQueue | Call_PolkadotXcm | Call_CumulusXcm | Call_DmpQueue | Call_XTokens | Call_UnknownTokens | Call_Tokens | Call_CrowdloanRewards | Call_Vesting | Call_Assets | Call_AssetsRegistry | Call_Pablo | Call_Oracle | Call_FarmingRewards | Call_Farming | Call_Referenda | Call_ConvictionVoting | Call_Whitelist | Call_CallFilter | Call_Cosmwasm | Call_Ibc | Call_Ics20Fee | Call_PalletMultihopXcmIbc | Call_PalletXcmHelper | Call_PalletLiquidStaking | Call_RevenueIbc
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type ReleaseCommitteeCall = ReleaseCommitteeCall_set_members | ReleaseCommitteeCall_execute | ReleaseCommitteeCall_propose | ReleaseCommitteeCall_vote | ReleaseCommitteeCall_disapprove_proposal | ReleaseCommitteeCall_close
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type RelayerCommitteeCall = RelayerCommitteeCall_set_members | RelayerCommitteeCall_execute | RelayerCommitteeCall_propose | RelayerCommitteeCall_vote | RelayerCommitteeCall_disapprove_proposal | RelayerCommitteeCall_close
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type RelayerCommitteeMembershipCall = RelayerCommitteeMembershipCall_add_member | RelayerCommitteeMembershipCall_remove_member | RelayerCommitteeMembershipCall_swap_member | RelayerCommitteeMembershipCall_reset_members | RelayerCommitteeMembershipCall_change_key | RelayerCommitteeMembershipCall_set_prime | RelayerCommitteeMembershipCall_clear_prime
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type OracleCall = OracleCall_add_asset_and_info | OracleCall_set_signer | OracleCall_adjust_rewards | OracleCall_add_stake | OracleCall_remove_stake | OracleCall_reclaim_stake | OracleCall_submit_price | OracleCall_remove_signer
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type IbcCall = IbcCall_deliver | IbcCall_transfer | IbcCall_upgrade_client | IbcCall_freeze_client | IbcCall_increase_counters | IbcCall_add_channels_to_feeless_channel_list | IbcCall_remove_channels_from_feeless_channel_list | IbcCall_set_child_storage | IbcCall_substitute_client_state
...
export interface IbcCall_substitute_client_state {
    ...
    clientId: string
    height: Height
    clientStateBytes: Uint8Array
    consensusStateBytes: Uint8Array
}
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type PalletLiquidStakingCall = PalletLiquidStakingCall_stake | PalletLiquidStakingCall_unstake | PalletLiquidStakingCall_update_reserve_factor | PalletLiquidStakingCall_update_staking_ledger_cap | PalletLiquidStakingCall_bond | PalletLiquidStakingCall_bond_extra | PalletLiquidStakingCall_unbond | PalletLiquidStakingCall_rebond | PalletLiquidStakingCall_withdraw_unbonded | PalletLiquidStakingCall_nominate | PalletLiquidStakingCall_notification_received | PalletLiquidStakingCall_claim_for | PalletLiquidStakingCall_force_set_era_start_block | PalletLiquidStakingCall_force_set_current_era | PalletLiquidStakingCall_force_advance_era | PalletLiquidStakingCall_force_matching | PalletLiquidStakingCall_force_set_staking_ledger | PalletLiquidStakingCall_set_current_era | PalletLiquidStakingCall_set_staking_ledger | PalletLiquidStakingCall_reduce_reserves | PalletLiquidStakingCall_cancel_unstake | PalletLiquidStakingCall_update_commission_rate | PalletLiquidStakingCall_fast_match_unstake | PalletLiquidStakingCall_update_incentive | PalletLiquidStakingCall_initiate_exchange_rate | PalletLiquidStakingCall_relaychain_storage_proof_key | PalletLiquidStakingCall_set_members
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type RevenueIbcCall = RevenueIbcCall_set_period | RevenueIbcCall_set_memo | RevenueIbcCall_trigger_transfer | RevenueIbcCall_set_allowed | RevenueIbcCall_add_allowed | RevenueIbcCall_remove_allowed | RevenueIbcCall_set_disallowed | RevenueIbcCall_add_disallowed | RevenueIbcCall_remove_disallowed | RevenueIbcCall_set_channel | RevenueIbcCall_set_address | RevenueIbcCall_set_cvm_osmo_address | RevenueIbcCall_set_cvm_centauri_address
...
export type OriginCaller = OriginCaller_system | OriginCaller_Council | OriginCaller_TechnicalCommittee | OriginCaller_ReleaseCommittee | OriginCaller_RelayerCommittee | OriginCaller_PolkadotXcm | OriginCaller_CumulusXcm | OriginCaller_Origins | OriginCaller_Void
...
export type XcmCall = XcmCall_Bond | XcmCall_BondExtra | XcmCall_Unbond | XcmCall_Rebond | XcmCall_WithdrawUnbonded | XcmCall_Nominate
...
export type Type_280 = Type_280_Members | Type_280_Member | Type_280__Phantom
...
export type Type_286 = Type_286_WhitelistedCaller | Type_286_GeneralAdmin | Type_286_ReferendumCanceller | Type_286_ReferendumKiller
...
export type Type_308 = Type_308_WithdrawAsset | Type_308_ReserveAssetDeposited | Type_308_ReceiveTeleportedAsset | Type_308_QueryResponse | Type_308_TransferAsset | Type_308_TransferReserveAsset | Type_308_Transact | Type_308_HrmpNewChannelOpenRequest | Type_308_HrmpChannelAccepted | Type_308_HrmpChannelClosing | Type_308_ClearOrigin | Type_308_DescendOrigin | Type_308_ReportError | Type_308_DepositAsset | Type_308_DepositReserveAsset | Type_308_ExchangeAsset | Type_308_InitiateReserveWithdraw | Type_308_InitiateTeleport | Type_308_QueryHolding | Type_308_BuyExecution | Type_308_RefundSurplus | Type_308_SetErrorHandler | Type_308_SetAppendix | Type_308_ClearError | Type_308_ClaimAsset | Type_308_Trap | Type_308_SubscribeVersion | Type_308_UnsubscribeVersion
...
export type Type_312 = Type_312_WithdrawAsset | Type_312_ReserveAssetDeposited | Type_312_ReceiveTeleportedAsset | Type_312_QueryResponse | Type_312_TransferAsset | Type_312_TransferReserveAsset | Type_312_Transact | Type_312_HrmpNewChannelOpenRequest | Type_312_HrmpChannelAccepted | Type_312_HrmpChannelClosing | Type_312_ClearOrigin | Type_312_DescendOrigin | Type_312_ReportError | Type_312_DepositAsset | Type_312_DepositReserveAsset | Type_312_ExchangeAsset | Type_312_InitiateReserveWithdraw | Type_312_InitiateTeleport | Type_312_ReportHolding | Type_312_BuyExecution | Type_312_RefundSurplus | Type_312_SetErrorHandler | Type_312_SetAppendix | Type_312_ClearError | Type_312_ClaimAsset | Type_312_Trap | Type_312_SubscribeVersion | Type_312_UnsubscribeVersion | Type_312_BurnAsset | Type_312_ExpectAsset | Type_312_ExpectOrigin | Type_312_ExpectError | Type_312_ExpectTransactStatus | Type_312_QueryPallet | Type_312_ExpectPallet | Type_312_ReportTransactStatus | Type_312_ClearTransactStatus | Type_312_UniversalOrigin | Type_312_ExportMessage | Type_312_LockAsset | Type_312_UnlockAsset | Type_312_NoteUnlockable | Type_312_RequestUnlock | Type_312_SetFeesMode | Type_312_SetTopic | Type_312_ClearTopic | Type_312_AliasOrigin | Type_312_UnpaidExecution
...
export type ChainHop = ChainHop_SubstrateIbc | ChainHop_CosmosIbc | ChainHop_Xcm
