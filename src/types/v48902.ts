...
export type Type_304 = Type_304_Approve | Type_304_Rebid | Type_304_Reject

export interface Type_304_Approve {
    __kind: 'Approve'
}

export interface Type_304_Rebid {
    __kind: 'Rebid'
}

export interface Type_304_Reject {
    __kind: 'Reject'
}
...
export interface NominationPoolsCall_set_configs {
    __kind: 'set_configs'
    minJoinBond: Type_321
    minCreateBond: Type_321
    maxPools: Type_322
    maxMembers: Type_322
    maxMembersPerPool: Type_322
    globalMaxCommission: Type_323
}
