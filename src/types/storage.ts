...
export class CouncilProposalOfStorage {
   ...
   */
  get isV9350() {
    return this._chain.getStorageItemTypeHash('Council', 'ProposalOf') === '325aefbc233caff71e364b31bec3a78cdea40e407dacdb91f8743a0cd5529b7d'
  }

  /**
   *  Actual proposal for a given hash, if it's current.
   */
  async getAsV9350(key: Uint8Array): Promise<v9350.Call | undefined> {
    assert(this.isV9350)
    return this._chain.getStorage(this.blockHash, 'Council', 'ProposalOf', key)
  }

  async getManyAsV9350(keys: Uint8Array[]): Promise<(v9350.Call | undefined)[]> {
    assert(this.isV9350)
    return this._chain.queryStorage(this.blockHash, 'Council', 'ProposalOf', keys.map(k => [k]))
  }

  async getAllAsV9350(): Promise<(v9350.Call)[]> {
    assert(this.isV9350)
    return this._chain.queryStorage(this.blockHash, 'Council', 'ProposalOf')
  }
...
export class FellowshipReferendaReferendumInfoForStorage {
   ...
   */
  get isV9320() {
    return this._chain.getStorageItemTypeHash('FellowshipReferenda', 'ReferendumInfoFor') === '8a990b6f7846d554858f1d8393cc54fb83824334598c3e96b4c4724d09d3d6c2'
  }

  /**
   *  Information concerning any given referendum.
   */
  async getAsV9320(key: number): Promise<v9320.Type_643 | undefined> {
    assert(this.isV9320)
    return this._chain.getStorage(this.blockHash, 'FellowshipReferenda', 'ReferendumInfoFor', key)
  }

  async getManyAsV9320(keys: number[]): Promise<(v9320.Type_643 | undefined)[]> {
    assert(this.isV9320)
    return this._chain.queryStorage(this.blockHash, 'FellowshipReferenda', 'ReferendumInfoFor', keys.map(k => [k]))
  }

  async getAllAsV9320(): Promise<(v9320.Type_643)[]> {
    assert(this.isV9320)
   ...
   */
  get isV9350() {
    return this._chain.getStorageItemTypeHash('FellowshipReferenda', 'ReferendumInfoFor') === 'aabc81c1452cdb0de49a229561d543d385d7d642ee1e7780c9625a85ff113aa4'
  }

  /**
   *  Information concerning any given referendum.
   */
  async getAsV9350(key: number): Promise<v9350.Type_643 | undefined> {
    assert(this.isV9350)
    return this._chain.getStorage(this.blockHash, 'FellowshipReferenda', 'ReferendumInfoFor', key)
  }

  async getManyAsV9350(keys: number[]): Promise<(v9350.Type_643 | undefined)[]> {
    assert(this.isV9350)
    return this._chain.queryStorage(this.blockHash, 'FellowshipReferenda', 'ReferendumInfoFor', keys.map(k => [k]))
  }

  async getAllAsV9350(): Promise<(v9350.Type_643)[]> {
    assert(this.isV9350)
    return this._chain.queryStorage(this.blockHash, 'FellowshipReferenda', 'ReferendumInfoFor')
  }
...
export class ReferendaReferendumInfoForStorage {
   ...
   */
  get isV9350() {
    return this._chain.getStorageItemTypeHash('Referenda', 'ReferendumInfoFor') === '4adf07f2f69a8f559991f6f0e0723c30859a0ed73aeac6c1fb83b91e3f29a69c'
  }

  /**
   *  Information concerning any given referendum.
   */
  async getAsV9350(key: number): Promise<v9350.Type_620 | undefined> {
    assert(this.isV9350)
    return this._chain.getStorage(this.blockHash, 'Referenda', 'ReferendumInfoFor', key)
  }

  async getManyAsV9350(keys: number[]): Promise<(v9350.Type_620 | undefined)[]> {
    assert(this.isV9350)
    return this._chain.queryStorage(this.blockHash, 'Referenda', 'ReferendumInfoFor', keys.map(k => [k]))
  }

  async getAllAsV9350(): Promise<(v9350.Type_620)[]> {
    assert(this.isV9350)
    return this._chain.queryStorage(this.blockHash, 'Referenda', 'ReferendumInfoFor')
  }
...
export class TechnicalCommitteeProposalOfStorage {
   ...
   */
  get isV9350() {
    return this._chain.getStorageItemTypeHash('TechnicalCommittee', 'ProposalOf') === '325aefbc233caff71e364b31bec3a78cdea40e407dacdb91f8743a0cd5529b7d'
  }
