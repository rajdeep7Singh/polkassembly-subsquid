...
export class CouncilApprovedEvent {
     ...
     * A motion was approved by the required threshold.
     */
    get asV1400(): {proposalHash: Uint8Array} {
        assert(this.isV1400)
...
export class CouncilClosedEvent {
     ...
     * A proposal was closed because its threshold was reached or after its duration was up.
     */
    get asV1400(): {proposalHash: Uint8Array, yes: number, no: number} {
        assert(this.isV1400)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class CouncilExecutedEvent {
     ...
     * A motion was executed; result will be `Ok` if it returned without error.
     */
    get asV1400(): {proposalHash: Uint8Array, result: v1400.Type_28} {
        assert(this.isV1400)
        return this._chain.decodeEvent(this.event)
    }
...
export class CouncilProposedEvent {
     ...
     * `MemberCount`).
     */
    get asV1400(): {account: Uint8Array, proposalIndex: number, proposalHash: Uint8Array, threshold: number} {
        assert(this.isV1400)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class CouncilVotedEvent {
     ...
     * a tally (yes votes and no votes given respectively as `MemberCount`).
     */
    get asV1400(): {account: Uint8Array, proposalHash: Uint8Array, voted: boolean, yes: number, no: number} {
        assert(this.isV1400)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class DemocracyPreimageInvalidEvent {
     ...
     * A proposal could not be executed because its preimage was invalid.
     */
    get asV1400(): {proposalHash: Uint8Array, refIndex: number} {
        assert(this.isV1400)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class DemocracyPreimageNotedEvent {
     ...
     * A proposal's preimage was noted, and the deposit taken.
     */
    get asV1400(): {proposalHash: Uint8Array, who: Uint8Array, deposit: bigint} {
        assert(this.isV1400)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class DemocracyPreimageReapedEvent {
     ...
     * A registered preimage was removed and the deposit collected by the reaper.
     */
    get asV1400(): {proposalHash: Uint8Array, provider: Uint8Array, deposit: bigint, reaper: Uint8Array} {
        assert(this.isV1400)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class DemocracyPreimageUsedEvent {
     ...
     * A proposal preimage was removed and used (the deposit was returned).
     */
    get asV1400(): {proposalHash: Uint8Array, provider: Uint8Array, deposit: bigint} {
        assert(this.isV1400)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class DemocracyProposedEvent {
     ...
     * A motion has been proposed by a public account.
     */
    get asV1400(): {proposalIndex: number, deposit: bigint} {
        assert(this.isV1400)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class DemocracySecondedEvent {
     ...
     * An account has secconded a proposal
     */
    get asV1400(): {seconder: Uint8Array, propIndex: number} {
        assert(this.isV1400)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class DemocracyStartedEvent {
     ...
     * A referendum has begun.
     */
    get asV1400(): {refIndex: number, threshold: v1400.VoteThreshold} {
        assert(this.isV1400)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class DemocracyTabledEvent {
     ...
     * A public proposal has been tabled for referendum vote.
     */
    get asV1400(): {proposalIndex: number, deposit: bigint, depositors: Uint8Array[]} {
        assert(this.isV1400)
        return this._chain.decodeEvent(this.event)
    }
...
export class DemocracyVotedEvent {
     ...
     * An account has voted in a referendum
     */
    get asV1400(): {voter: Uint8Array, refIndex: number, vote: v1400.AccountVote} {
        assert(this.isV1400)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class TreasuryAwardedEvent {
     ...
     * Some funds have been allocated.
     */
    get asV1400(): {proposalIndex: number, award: bigint, account: Uint8Array} {
        assert(this.isV1400)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class TreasuryProposedEvent {
     ...
     * New proposal.
     */
    get asV1400(): {proposalIndex: number} {
        assert(this.isV1400)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class TreasuryRejectedEvent {
     ...
     * A proposal was rejected; funds were slashed.
     */
    get asV1400(): {proposalIndex: number, slashed: bigint} {
        assert(this.isV1400)
        return this._chain.decodeEvent(this.event)
    }
}
