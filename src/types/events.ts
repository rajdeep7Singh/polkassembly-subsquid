...
export class CouncilExecutedEvent {
     ...
     * A motion was executed; result will be `Ok` if it returned without error.
     */
    get asV1(): {proposalHash: Uint8Array, result: v1.Type_30} {
        assert(this.isV1)
        return this._chain.decodeEvent(this.event)
    }
    ...
    get asV11(): {proposalHash: Uint8Array, result: v11.Type_38} {
        assert(this.isV11)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class DemocracyExecutedEvent {
     ...
     * A proposal has been enacted.
     */
    get asV1(): {refIndex: number, result: v1.Type_30} {
        assert(this.isV1)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class DemocracyTabledEvent {
    ...
    get asV11(): {proposalIndex: number, deposit: bigint} {
        assert(this.isV11)
        return this._chain.decodeEvent(this.event)
    }
}
