...
export class BountiesBountyAwardedEvent {
     ...
     * A bounty is awarded to a beneficiary.
     */
    get asV2011(): {index: number, beneficiary: Uint8Array} {
        assert(this.isV2011)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class BountiesBountyClaimedEvent {
     ...
     * A bounty is claimed by beneficiary. \[index, payout, beneficiary\]
     */
    get asV2000(): [number, bigint, Uint8Array] {
        assert(this.isV2000)
        return this._chain.decodeEvent(this.event)
    }
     ...
     * A bounty is claimed by beneficiary.
     */
    get asV2011(): {index: number, payout: bigint, beneficiary: Uint8Array} {
        assert(this.isV2011)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class DemocracyExecutedEvent {
     ...
     * A proposal has been enacted. \[ref_index, result\]
     */
    get asV2000(): [number, v2000.Type_31] {
        assert(this.isV2000)
        return this._chain.decodeEvent(this.event)
    }
     ...
     * A proposal has been enacted.
     */
    get asV2011(): {refIndex: number, result: v2011.Type_28} {
        assert(this.isV2011)
        return this._chain.decodeEvent(this.event)
    }
...
export class DemocracyPreimageInvalidEvent {
     ...
     * A proposal could not be executed because its preimage was invalid.
     */
    get asV2011(): {proposalHash: Uint8Array, refIndex: number} {
        assert(this.isV2011)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class DemocracyPreimageNotedEvent {
     ...
     * A proposal's preimage was noted, and the deposit taken.
     */
    get asV2011(): {proposalHash: Uint8Array, who: Uint8Array, deposit: bigint} {
        assert(this.isV2011)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class DemocracyPreimageReapedEvent {
     ...
     * \[proposal_hash, provider, deposit, reaper\]
     */
    get asV2000(): [Uint8Array, Uint8Array, bigint, Uint8Array] {
        assert(this.isV2000)
        return this._chain.decodeEvent(this.event)
    }
     ...
     * A registered preimage was removed and the deposit collected by the reaper.
     */
    get asV2011(): {proposalHash: Uint8Array, provider: Uint8Array, deposit: bigint, reaper: Uint8Array} {
        assert(this.isV2011)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class DemocracyPreimageUsedEvent {
     ...
     * A proposal preimage was removed and used (the deposit was returned).
     */
    get asV2011(): {proposalHash: Uint8Array, provider: Uint8Array, deposit: bigint} {
        assert(this.isV2011)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class DemocracyTabledEvent {
     ...
     * A public proposal has been tabled for referendum vote.
     */
    get asV2011(): {proposalIndex: number, deposit: bigint, depositors: Uint8Array[]} {
        assert(this.isV2011)
        return this._chain.decodeEvent(this.event)
    }
...
export class TipsNewTipEvent {
     ...
     * A new tip suggestion has been opened.
     */
    get asV2011(): {tipHash: Uint8Array} {
        assert(this.isV2011)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class TipsTipClosedEvent {
     ...
     * A tip suggestion has been closed.
     */
    get asV2011(): {tipHash: Uint8Array, who: Uint8Array, payout: bigint} {
        assert(this.isV2011)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class TipsTipSlashedEvent {
     ...
     * A tip suggestion has been slashed.
     */
    get asV2011(): {tipHash: Uint8Array, finder: Uint8Array, deposit: bigint} {
        assert(this.isV2011)
        return this._chain.decodeEvent(this.event)
    }
}
