...
export class DemocracyExecutedEvent {
     ...
     * A proposal has been enacted.
     */
    get asV9(): {refIndex: number, result: v9.Type_26} {
        assert(this.isV9)
        return this._chain.decodeEvent(this.event)
    }
     ...
     * A proposal has been enacted.
     */
    get asV13(): {refIndex: number, result: v13.Type_27} {
        assert(this.isV13)
        return this._chain.decodeEvent(this.event)
    }
     ...
     * A proposal has been enacted.
     */
    get asV20(): {refIndex: number, result: v20.Type_28} {
        assert(this.isV20)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class DemocracyPreimageInvalidEvent {
     ...
     * A proposal could not be executed because its preimage was invalid.
     */
    get asV9(): {proposalHash: Uint8Array, refIndex: number} {
        assert(this.isV9)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class DemocracyPreimageNotedEvent {
     ...
     * A proposal's preimage was noted, and the deposit taken.
     */
    get asV9(): {proposalHash: Uint8Array, who: Uint8Array, deposit: bigint} {
        assert(this.isV9)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class DemocracyPreimageReapedEvent {
     ...
     * A registered preimage was removed and the deposit collected by the reaper.
     */
    get asV9(): {proposalHash: Uint8Array, provider: Uint8Array, deposit: bigint, reaper: Uint8Array} {
        assert(this.isV9)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class DemocracyPreimageUsedEvent {
     ...
     * A proposal preimage was removed and used (the deposit was returned).
     */
    get asV9(): {proposalHash: Uint8Array, provider: Uint8Array, deposit: bigint} {
        assert(this.isV9)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class DemocracyProposedEvent {
     ...
     * A motion has been proposed by a public account.
     */
    get asV9(): {proposalIndex: number, deposit: bigint} {
        assert(this.isV9)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class DemocracySecondedEvent {
     ...
     * An account has secconded a proposal
     */
    get asV13(): {seconder: Uint8Array, propIndex: number} {
        assert(this.isV13)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class DemocracyStartedEvent {
     ...
     * A referendum has begun.
     */
    get asV9(): {refIndex: number, threshold: v9.VoteThreshold} {
        assert(this.isV9)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class DemocracyTabledEvent {
     ...
     * A public proposal has been tabled for referendum vote.
     */
    get asV9(): {proposalIndex: number, deposit: bigint, depositors: Uint8Array[]} {
        assert(this.isV9)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class DemocracyVotedEvent {
     ...
     * An account has voted in a referendum
     */
    get asV13(): {voter: Uint8Array, refIndex: number, vote: v13.AccountVote} {
        assert(this.isV13)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class TechnicalCommitteeApprovedEvent {
     ...
     * A motion was approved by the required threshold.
     */
    get asV8(): {proposalHash: Uint8Array} {
        assert(this.isV8)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class TechnicalCommitteeClosedEvent {
     ...
     * A proposal was closed because its threshold was reached or after its duration was up.
     */
    get asV8(): {proposalHash: Uint8Array, yes: number, no: number} {
        assert(this.isV8)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class TechnicalCommitteeExecutedEvent {
     ...
     * \[proposal_hash, result\]
     */
    get asV5(): [Uint8Array, v5.Type_31] {
        assert(this.isV5)
        return this._chain.decodeEvent(this.event)
    }
     ...
     * A motion was executed; result will be `Ok` if it returned without error.
     */
    get asV8(): {proposalHash: Uint8Array, result: v8.Type_26} {
        assert(this.isV8)
        return this._chain.decodeEvent(this.event)
    }
     ...
     * A motion was executed; result will be `Ok` if it returned without error.
     */
    get asV13(): {proposalHash: Uint8Array, result: v13.Type_27} {
        assert(this.isV13)
        return this._chain.decodeEvent(this.event)
    }
     ...
     * A motion was executed; result will be `Ok` if it returned without error.
     */
    get asV20(): {proposalHash: Uint8Array, result: v20.Type_28} {
        assert(this.isV20)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class TechnicalCommitteeProposedEvent {
     ...
     * `MemberCount`).
     */
    get asV8(): {account: Uint8Array, proposalIndex: number, proposalHash: Uint8Array, threshold: number} {
        assert(this.isV8)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class TechnicalCommitteeVotedEvent {
     ...
     * a tally (yes votes and no votes given respectively as `MemberCount`).
     */
    get asV8(): {account: Uint8Array, proposalHash: Uint8Array, voted: boolean, yes: number, no: number} {
        assert(this.isV8)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class TreasuryAwardedEvent {
     ...
     * Some funds have been allocated. \[proposal_index, award, beneficiary\]
     */
    get asV5(): [number, bigint, Uint8Array] {
        assert(this.isV5)
        return this._chain.decodeEvent(this.event)
    }
     ...
     * Some funds have been allocated.
     */
    get asV13(): {proposalIndex: number, award: bigint, account: Uint8Array} {
        assert(this.isV13)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class TreasuryProposedEvent {
     ...
     * New proposal.
     */
    get asV13(): {proposalIndex: number} {
        assert(this.isV13)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class TreasuryRejectedEvent {
     ...
     * A proposal was rejected; funds were slashed.
     */
    get asV13(): {proposalIndex: number, slashed: bigint} {
        assert(this.isV13)
        return this._chain.decodeEvent(this.event)
    }
}
