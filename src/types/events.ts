...
export class CouncilExecutedEvent {
     ...
     * A motion was executed; result will be `Ok` if it returned without error.
     */
    get asV1(): {proposalHash: Uint8Array, result: v1.Type_29} {
        assert(this.isV1)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class DemocracyExecutedEvent {
     ...
     * A proposal has been enacted.
     */
    get asV1(): {refIndex: number, result: v1.Type_29} {
        assert(this.isV1)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class TipsTipClosedEvent {
     ...
     * A tip suggestion has been closed.
     */
    get asV1(): {tipHash: Uint8Array, who: Uint8Array, payout: bigint} {
        assert(this.isV1)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class TipsTipSlashedEvent {
     ...
     * A tip suggestion has been slashed.
     */
    get asV1(): {tipHash: Uint8Array, finder: Uint8Array, deposit: bigint} {
        assert(this.isV1)
        return this._chain.decodeEvent(this.event)
    }
}
