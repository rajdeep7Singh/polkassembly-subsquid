...
export class CouncilClosedEvent {
     ...
     * \[proposal_hash, yes, no\]
     */
    get asV200(): [Uint8Array, number, number] {
        assert(this.isV200)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class CouncilExecutedEvent {
     ...
     * \[proposal_hash, result\]
     */
    get asV200(): [Uint8Array, v200.Type_28] {
        assert(this.isV200)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class CouncilProposedEvent {
     ...
     * \[account, proposal_index, proposal_hash, threshold\]
     */
    get asV200(): [Uint8Array, number, Uint8Array, number] {
        assert(this.isV200)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class CouncilVotedEvent {
     ...
     * \[account, proposal_hash, voted, yes, no\]
     */
    get asV200(): [Uint8Array, Uint8Array, boolean, number, number] {
        assert(this.isV200)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class DemocracyExecutedEvent {
     ...
     * A proposal has been enacted. \[ref_index, result\]
     */
    get asV200(): [number, v200.Type_28] {
        assert(this.isV200)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class DemocracyPreimageNotedEvent {
     ...
     * A proposal's preimage was noted, and the deposit taken. \[proposal_hash, who, deposit\]
     */
    get asV200(): [Uint8Array, Uint8Array, bigint] {
        assert(this.isV200)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class DemocracyPreimageReapedEvent {
     ...
     * \[proposal_hash, provider, deposit, reaper\]
     */
    get asV200(): [Uint8Array, Uint8Array, bigint, Uint8Array] {
        assert(this.isV200)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class DemocracyStartedEvent {
     ...
     * A referendum has begun. \[ref_index, threshold\]
     */
    get asV200(): [number, v200.VoteThreshold] {
        assert(this.isV200)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class TipsTipClosedEvent {
     ...
     * A tip suggestion has been closed.
     */
    get asV200(): {tipHash: Uint8Array, who: Uint8Array, payout: bigint} {
        assert(this.isV200)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class TipsTipSlashedEvent {
     ...
     * A tip suggestion has been slashed.
     */
    get asV200(): {tipHash: Uint8Array, finder: Uint8Array, deposit: bigint} {
        assert(this.isV200)
        return this._chain.decodeEvent(this.event)
    }
}
