...
export class DemocracyExecutedEvent {
     ...
     * A proposal has been enacted.
     */
    get asV1605(): {refIndex: number, result: v1605.Type_47} {
        assert(this.isV1605)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class EthereumExecutedEvent {
     ...
     * An ethereum transaction was successfully executed.
     */
    get asV1801(): {from: Uint8Array, to: Uint8Array, transactionHash: Uint8Array, exitReason: v1801.ExitReason} {
        assert(this.isV1801)
        return this._chain.decodeEvent(this.event)
    }
...
export class ReferendaCancelledEvent {
     ...
     * A referendum has been cancelled.
     */
    get asV2100(): {index: number, tally: v2100.Tally} {
        assert(this.isV2100)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class ReferendaDecisionDepositPlacedEvent {
     ...
     * The decision deposit has been placed.
     */
    get asV2100(): {index: number, who: Uint8Array, amount: bigint} {
        assert(this.isV2100)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class ReferendaDecisionStartedEvent {
     ...
     * A referendum has moved into the deciding phase.
     */
    get asV2100(): {index: number, track: number, proposal: v2100.Bounded, tally: v2100.Tally} {
        assert(this.isV2100)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class ReferendaSubmittedEvent {
     ...
     * A referendum has being submitted.
     */
    get asV2100(): {index: number, track: number, proposal: v2100.Bounded} {
        assert(this.isV2100)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class SchedulerDispatchedEvent {
     ...
     *  Dispatched some task. \[task, id, result\]
     */
    get asV49(): [[number, number], (Uint8Array | undefined), v49.DispatchResult] {
        assert(this.isV49)
        return this._chain.decodeEvent(this.event)
    }
     ...
     * Dispatched some task.
     */
    get asV1605(): {task: [number, number], id: (Uint8Array | undefined), result: v1605.Type_47} {
        assert(this.isV1605)
        return this._chain.decodeEvent(this.event)
    }
...
export class TreasurySpendApprovedEvent {
     ...
     * A new spend proposal has been approved.
     */
    get asV1801(): {proposalIndex: number, amount: bigint, beneficiary: Uint8Array} {
        assert(this.isV1801)
        return this._chain.decodeEvent(this.event)
    }
}
