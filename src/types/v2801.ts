...
export type Type_534 = Type_534_Approved | Type_534_Cancelled | Type_534_Killed | Type_534_Ongoing | Type_534_Rejected | Type_534_TimedOut

export interface Type_534_Approved {
    __kind: 'Approved'
    value: [number, (Deposit | undefined), (Deposit | undefined)]
}

export interface Type_534_Cancelled {
    __kind: 'Cancelled'
    value: [number, (Deposit | undefined), (Deposit | undefined)]
}

export interface Type_534_Killed {
    __kind: 'Killed'
    value: number
}

export interface Type_534_Ongoing {
    __kind: 'Ongoing'
    value: Type_535
}

export interface Type_534_Rejected {
    __kind: 'Rejected'
    value: [number, (Deposit | undefined), (Deposit | undefined)]
}

export interface Type_534_TimedOut {
    __kind: 'TimedOut'
    value: [number, (Deposit | undefined), (Deposit | undefined)]
}
...
export type Type_126 = Type_126_Response | Type_126_Xcm

export interface Type_126_Response {
    __kind: 'Response'
    value: V3MultiLocation
}

export interface Type_126_Xcm {
    __kind: 'Xcm'
    value: V3MultiLocation
}
...
export type Type_135 = Type_135_XcmEthereumTransaction

export interface Type_135_XcmEthereumTransaction {
...
export type Type_125 = Type_125_Relay | Type_125_SiblingParachain

export interface Type_125_Relay {
    __kind: 'Relay'
}

export interface Type_125_SiblingParachain {
...
export const OriginCaller: sts.Type<OriginCaller> = sts.closedEnum(() => {
    return  {
        CumulusXcm: Type_125,
        Ethereum: Type_121,
        EthereumXcm: Type_135,
        OpenTechCommitteeCollective: Type_124,
        Origins: Origin,
        PolkadotXcm: Type_126,
        TreasuryCouncilCollective: Type_123,
        Void: Void,
        system: RawOrigin,
    }
})
