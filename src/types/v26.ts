...
export type Type_185 = Type_185_Member | Type_185_Members | Type_185__Phantom
...
export const SidechainHeader: sts.Type<SidechainHeader> = sts.struct(() => {
    return  {
        parentHash: H256,
