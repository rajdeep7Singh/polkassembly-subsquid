...
export type Call = Call_AssetTxPayment | Call_Assets | Call_AssetsRegistry | Call_AssetsTransactorRouter | Call_Balances | Call_BondedFinance | Call_CallFilter | Call_CollatorSelection | Call_Council | Call_CouncilMembership | Call_CrowdloanRewards | Call_CumulusXcm | Call_CurrencyFactory | Call_Democracy | Call_DmpQueue | Call_GovernanceRegistry | Call_Ibc | Call_Identity | Call_Indices | Call_Multisig | Call_Oracle | Call_Pablo | Call_ParachainInfo | Call_ParachainSystem | Call_PolkadotXcm | Call_Preimage | Call_Proxy | Call_ReleaseCommittee | Call_ReleaseMembership | Call_Scheduler | Call_Session | Call_Sudo | Call_System | Call_TechnicalCommittee | Call_TechnicalCommitteeMembership | Call_Timestamp | Call_Tokens | Call_Treasury | Call_UnknownTokens | Call_Utility | Call_Vesting | Call_XTokens | Call_XcmpQueue
...
export type ProxyType = ProxyType_Any | ProxyType_Bridge | ProxyType_CancelProxy | ProxyType_Governance
...
export type Type_338 = Type_338_AliasOrigin | Type_338_BurnAsset | Type_338_BuyExecution | Type_338_ClaimAsset | Type_338_ClearError | Type_338_ClearOrigin | Type_338_ClearTopic | Type_338_ClearTransactStatus | Type_338_DepositAsset | Type_338_DepositReserveAsset | Type_338_DescendOrigin | Type_338_ExchangeAsset | Type_338_ExpectAsset | Type_338_ExpectError | Type_338_ExpectOrigin | Type_338_ExpectPallet | Type_338_ExpectTransactStatus | Type_338_ExportMessage | Type_338_HrmpChannelAccepted | Type_338_HrmpChannelClosing | Type_338_HrmpNewChannelOpenRequest | Type_338_InitiateReserveWithdraw | Type_338_InitiateTeleport | Type_338_LockAsset | Type_338_NoteUnlockable | Type_338_QueryPallet | Type_338_QueryResponse | Type_338_ReceiveTeleportedAsset | Type_338_RefundSurplus | Type_338_ReportError | Type_338_ReportHolding | Type_338_ReportTransactStatus | Type_338_RequestUnlock | Type_338_ReserveAssetDeposited | Type_338_SetAppendix | Type_338_SetErrorHandler | Type_338_SetFeesMode | Type_338_SetTopic | Type_338_SubscribeVersion | Type_338_Transact | Type_338_TransferAsset | Type_338_TransferReserveAsset | Type_338_Trap | Type_338_UniversalOrigin | Type_338_UnlockAsset | Type_338_UnpaidExecution | Type_338_UnsubscribeVersion | Type_338_WithdrawAsset
...
export type Type_334 = Type_334_BuyExecution | Type_334_ClaimAsset | Type_334_ClearError | Type_334_ClearOrigin | Type_334_DepositAsset | Type_334_DepositReserveAsset | Type_334_DescendOrigin | Type_334_ExchangeAsset | Type_334_HrmpChannelAccepted | Type_334_HrmpChannelClosing | Type_334_HrmpNewChannelOpenRequest | Type_334_InitiateReserveWithdraw | Type_334_InitiateTeleport | Type_334_QueryHolding | Type_334_QueryResponse | Type_334_ReceiveTeleportedAsset | Type_334_RefundSurplus | Type_334_ReportError | Type_334_ReserveAssetDeposited | Type_334_SetAppendix | Type_334_SetErrorHandler | Type_334_SubscribeVersion | Type_334_Transact | Type_334_TransferAsset | Type_334_TransferReserveAsset | Type_334_Trap | Type_334_UnsubscribeVersion | Type_334_WithdrawAsset
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type OracleCall = OracleCall_add_asset_and_info | OracleCall_add_stake | OracleCall_adjust_rewards | OracleCall_reclaim_stake | OracleCall_remove_stake | OracleCall_set_signer | OracleCall_submit_price
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type IbcCall = IbcCall_deliver | IbcCall_freeze_client | IbcCall_increase_counters | IbcCall_transfer | IbcCall_upgrade_client
...
export interface CallFilterEntry {
    palletName: BoundedVec
    functionName: BoundedVec
}
...
export interface Type_169_Set {
    __kind: 'Set'
    value?: (Type_163 | undefined)
}

export interface Type_163 {
    inner: Bytes
}
...
export const Type_331: sts.Type<Type_331> = sts.closedEnum(() => {
    return  {
        V2: sts.array(() => Type_334),
        V3: sts.array(() => Type_338),
    }
})
...
export const Type_334: sts.Type<Type_334> = sts.closedEnum(() => {
    return  {
        ...
        ReserveAssetDeposited: sts.array(() => V2MultiAsset),
        SetAppendix: sts.array(() => Type_334),
        SetErrorHandler: sts.array(() => Type_334),
        SubscribeVersion: sts.enumStruct({
            queryId: sts.bigint(),
            maxResponseWeight: sts.bigint(),
        }),
...
export const Type_347: sts.Type<Type_347> = sts.struct(() => {
    return  {
        inner: sts.bytes(),
    }
})
...
export const Type_169: sts.Type<Type_169> = sts.closedEnum(() => {
    return  {
        Ignore: sts.unit(),
        Set: sts.option(() => Type_163),
    }
})

export const Type_163: sts.Type<Type_163> = sts.struct(() => {
    return  {
        inner: sts.bytes(),
    }
})
