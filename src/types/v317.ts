 ...
 * Contains a variant per dispatchable extrinsic that this pallet has.
 */
export type TheaExecutorCall = TheaExecutorCall_burn_native_tokens | TheaExecutorCall_claim_deposit | TheaExecutorCall_parachain_withdraw | TheaExecutorCall_set_withdrawal_fee | TheaExecutorCall_update_asset_metadata | TheaExecutorCall_withdraw
