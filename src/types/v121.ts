...
export type Call = Call_System | Call_Timestamp | Call_Authorship | Call_Babe | Call_Grandpa | Call_Balances | Call_ElectionProviderMultiPhase | Call_ImOnline | Call_BagsList | Call_Bounties | Call_ChildBounties | Call_Staking | Call_Session | Call_Democracy | Call_Council | Call_TechnicalCommittee | Call_Elections | Call_Treasury | Call_ConvictionVoting | Call_Referenda | Call_FellowshipCollective | Call_FellowshipReferenda | Call_Whitelist | Call_Sudo | Call_Scheduler | Call_Preimage | Call_NominationPools | Call_Identity | Call_Utility | Call_GearProgram | Call_Gear | Call_Airdrop
...
export type Type_527 = Type_527_Ongoing | Type_527_Approved | Type_527_Rejected | Type_527_Cancelled | Type_527_TimedOut | Type_527_Killed

export interface Type_527_Ongoing {
  __kind: 'Ongoing'
  value: Type_528
}

export interface Type_527_Approved {
  __kind: 'Approved'
  value: [number, (Deposit | undefined), (Deposit | undefined)]
}

export interface Type_527_Rejected {
  __kind: 'Rejected'
  value: [number, (Deposit | undefined), (Deposit | undefined)]
}

export interface Type_527_Cancelled {
  __kind: 'Cancelled'
  value: [number, (Deposit | undefined), (Deposit | undefined)]
}

export interface Type_527_TimedOut {
  __kind: 'TimedOut'
  value: [number, (Deposit | undefined), (Deposit | undefined)]
}

export interface Type_527_Killed {
  __kind: 'Killed'
  value: number
}

export type Type_504 = Type_504_Ongoing | Type_504_Approved | Type_504_Rejected | Type_504_Cancelled | Type_504_TimedOut | Type_504_Killed

export interface Type_504_Ongoing {
  __kind: 'Ongoing'
  value: Type_505
}

export interface Type_504_Approved {
  __kind: 'Approved'
  value: [number, (Deposit | undefined), (Deposit | undefined)]
}

export interface Type_504_Rejected {
  __kind: 'Rejected'
  value: [number, (Deposit | undefined), (Deposit | undefined)]
}

export interface Type_504_Cancelled {
  __kind: 'Cancelled'
  value: [number, (Deposit | undefined), (Deposit | undefined)]
}

export interface Type_504_TimedOut {
  __kind: 'TimedOut'
  value: [number, (Deposit | undefined), (Deposit | undefined)]
}

export interface Type_504_Killed {
  __kind: 'Killed'
  value: number
}
...
export interface StakingCall_set_staking_configs {
  ...
  maxNominatorCount: Type_188
  maxValidatorCount: Type_188
  chillThreshold: Type_189
  minCommission: Type_190
}
...
export interface NominationPoolsCall_update_roles {
  ...
  poolId: number
  newRoot: Type_230
  newNominator: Type_230
  newStateToggler: Type_230
}
...
export type Type_188 = Type_188_Noop | Type_188_Set | Type_188_Remove

export interface Type_188_Noop {
  __kind: 'Noop'
}

export interface Type_188_Set {
  __kind: 'Set'
  value: number
}

export interface Type_188_Remove {
  __kind: 'Remove'
}

export type Type_189 = Type_189_Noop | Type_189_Set | Type_189_Remove

export interface Type_189_Noop {
  __kind: 'Noop'
}

export interface Type_189_Set {
  __kind: 'Set'
  value: number
}

export interface Type_189_Remove {
  __kind: 'Remove'
}

export type Type_190 = Type_190_Noop | Type_190_Set | Type_190_Remove

export interface Type_190_Noop {
  __kind: 'Noop'
}

export interface Type_190_Set {
  __kind: 'Set'
  value: number
}

export interface Type_190_Remove {
  __kind: 'Remove'
}
...
export type Type_205 = Type_205_Standard | Type_205_Split | Type_205_SplitAbstain

export interface Type_205_Standard {
  __kind: 'Standard'
  vote: number
  balance: bigint
}

export interface Type_205_Split {
  __kind: 'Split'
  aye: bigint
  nay: bigint
}

export interface Type_205_SplitAbstain {
  __kind: 'SplitAbstain'
  aye: bigint
  nay: bigint
  abstain: bigint
...
export type OriginCaller = OriginCaller_system | OriginCaller_Council | OriginCaller_TechnicalCommittee | OriginCaller_Origins | OriginCaller_Void
...
export type Type_229 = Type_229_Noop | Type_229_Set | Type_229_Remove
...
export type Type_230 = Type_230_Noop | Type_230_Set | Type_230_Remove
