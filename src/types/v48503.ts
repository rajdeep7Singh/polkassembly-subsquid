...
export interface StakingCall_set_staking_configs {
    ...
    maxNominatorCount: Type_216
    maxValidatorCount: Type_216
    chillThreshold: Type_217
    minCommission: Type_218
}
...
export type Type_299 = Type_299_Approve | Type_299_Rebid | Type_299_Reject

export interface Type_299_Approve {
    __kind: 'Approve'
}

export interface Type_299_Rebid {
    __kind: 'Rebid'
}

export interface Type_299_Reject {
    __kind: 'Reject'
}
...
export interface NominationPoolsCall_set_configs {
    __kind: 'set_configs'
    minJoinBond: Type_316
    minCreateBond: Type_316
    maxPools: Type_317
    maxMembers: Type_317
    maxMembersPerPool: Type_317
}
