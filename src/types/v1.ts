...
export type Call = Call_Authorship | Call_Balances | Call_CollatorSelection | Call_Council | Call_Democracy | Call_DmpQueue | Call_Multisig | Call_ParachainSystem | Call_PolkadotXcm | Call_Preimage | Call_Scheduler | Call_Session | Call_Sudo | Call_System | Call_TechnicalCommittee | Call_Timestamp | Call_XcmpQueue
...
export type Type_197 = Type_197_V0 | Type_197_V1 | Type_197_V2

export interface Type_197_V0 {
    __kind: 'V0'
    value: Type_198
}

export interface Type_197_V1 {
    __kind: 'V1'
    value: Type_203
}

export interface Type_197_V2 {
    __kind: 'V2'
    value: Type_209[]
}
...
export interface Type_202 {
    encoded: Bytes
}

export type Type_203 = Type_203_HrmpChannelAccepted | Type_203_HrmpChannelClosing | Type_203_HrmpNewChannelOpenRequest | Type_203_QueryResponse | Type_203_ReceiveTeleportedAsset | Type_203_RelayedFrom | Type_203_ReserveAssetDeposited | Type_203_SubscribeVersion | Type_203_Transact | Type_203_TransferAsset | Type_203_TransferReserveAsset | Type_203_UnsubscribeVersion | Type_203_WithdrawAsset
...
export interface Type_203_ReceiveTeleportedAsset {
    __kind: 'ReceiveTeleportedAsset'
    assets: V1MultiAsset[]
    effects: Type_205[]
}
...
export interface Type_203_ReserveAssetDeposited {
    __kind: 'ReserveAssetDeposited'
    assets: V1MultiAsset[]
    effects: Type_205[]
}

export interface Type_203_SubscribeVersion {
    __kind: 'SubscribeVersion'
    queryId: bigint
    maxResponseWeight: bigint
}
...
export interface Type_203_UnsubscribeVersion {
    __kind: 'UnsubscribeVersion'
}
...
export type Type_205 = Type_205_BuyExecution | Type_205_DepositAsset | Type_205_DepositReserveAsset | Type_205_ExchangeAsset | Type_205_InitiateReserveWithdraw | Type_205_InitiateTeleport | Type_205_Noop | Type_205_QueryHolding
...
export type Type_198 = Type_198_HrmpChannelAccepted | Type_198_HrmpChannelClosing | Type_198_HrmpNewChannelOpenRequest | Type_198_QueryResponse | Type_198_RelayedFrom | Type_198_ReserveAssetDeposit | Type_198_TeleportAsset | Type_198_Transact | Type_198_TransferAsset | Type_198_TransferReserveAsset | Type_198_WithdrawAsset

export interface Type_198_HrmpChannelAccepted {
    __kind: 'HrmpChannelAccepted'
    recipient: number
}

export interface Type_198_HrmpChannelClosing {
    __kind: 'HrmpChannelClosing'
    initiator: number
    sender: number
    recipient: number
...
export interface Type_198_HrmpNewChannelOpenRequest {
    __kind: 'HrmpNewChannelOpenRequest'
    sender: number
    maxMessageSize: number
    maxCapacity: number
...
export interface Type_198_QueryResponse {
    __kind: 'QueryResponse'
    queryId: bigint
    response: V0Response
}

export interface Type_198_RelayedFrom {
    __kind: 'RelayedFrom'
    who: V0MultiLocation
    message: Type_198
}

export interface Type_198_ReserveAssetDeposit {
    __kind: 'ReserveAssetDeposit'
    assets: V0MultiAsset[]
    effects: Type_200[]
}

export interface Type_198_TeleportAsset {
    __kind: 'TeleportAsset'
    assets: V0MultiAsset[]
    effects: Type_200[]
}

export interface Type_198_Transact {
    __kind: 'Transact'
    originType: V0OriginKind
    requireWeightAtMost: bigint
    call: Type_202
...
export interface Type_198_TransferAsset {
    __kind: 'TransferAsset'
    assets: V0MultiAsset[]
    dest: V0MultiLocation
}

export interface Type_198_TransferReserveAsset {
    __kind: 'TransferReserveAsset'
    assets: V0MultiAsset[]
    dest: V0MultiLocation
    effects: V0Order[]
...
export interface Type_198_WithdrawAsset {
    __kind: 'WithdrawAsset'
    assets: V0MultiAsset[]
    effects: Type_200[]
}

export type Type_200 = Type_200_BuyExecution | Type_200_DepositAsset | Type_200_DepositReserveAsset | Type_200_ExchangeAsset | Type_200_InitiateReserveWithdraw | Type_200_InitiateTeleport | Type_200_Null | Type_200_QueryHolding
...
export interface Type_200_Null {
    __kind: 'Null'
}

export interface Type_200_QueryHolding {
    __kind: 'QueryHolding'
    queryId: bigint
    dest: V0MultiLocation
    assets: V0MultiAsset[]
...
export const Type_202: sts.Type<Type_202> = sts.struct(() => {
    return  {
        encoded: sts.bytes(),
    }
})
...
export const Type_205: sts.Type<Type_205> = sts.closedEnum(() => {
    return  {
        BuyExecution: sts.enumStruct({
            ...
            debt: sts.bigint(),
            haltOnError: sts.boolean(),
            instructions: sts.array(() => Type_203),
        }),
        DepositAsset: sts.enumStruct({
            assets: V1MultiAssetFilter,
            maxAssets: sts.number(),
