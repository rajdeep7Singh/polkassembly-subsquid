...
export type Call = Call_Authorship | Call_Balances | Call_CollatorSelection | Call_Council | Call_Democracy | Call_Messages | Call_Msa | Call_ParachainSystem | Call_Preimage | Call_Scheduler | Call_Schemas | Call_Session | Call_Sudo | Call_System | Call_TechnicalCommittee | Call_Timestamp | Call_Treasury | Call_Utility | Call_Vesting
...
export type Type_134 = Type_134_Member | Type_134_Members | Type_134__Phantom

export interface Type_134_Member {
    __kind: 'Member'
    value: AccountId32
}

export interface Type_134_Members {
    __kind: 'Members'
    value: [number, number]
}

export interface Type_134__Phantom {
    __kind: '_Phantom'
}

export type Type_133 = Type_133_Member | Type_133_Members | Type_133__Phantom

export interface Type_133_Member {
    __kind: 'Member'
    value: AccountId32
}

export interface Type_133_Members {
    __kind: 'Members'
    value: [number, number]
}

export interface Type_133__Phantom {
    __kind: '_Phantom'
}
