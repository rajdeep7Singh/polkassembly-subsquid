...
export type Call = Call_System | Call_Utility | Call_Timestamp | Call_Identity | Call_Multisig | Call_ParachainSystem | Call_ParachainInfo | Call_Balances | Call_Vesting | Call_Assets | Call_Treasury | Call_Scheduler | Call_TechnicalCommittee | Call_TechnicalMembership | Call_Democracy | Call_Preimage | Call_Datalog | Call_Launch | Call_Staking | Call_DigitalTwin | Call_RWS | Call_Liability | Call_Crowdloan | Call_Lighthouse | Call_XcmpQueue | Call_PolkadotXcm | Call_CumulusXcm | Call_DmpQueue
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type StakingCall = StakingCall_bond | StakingCall_bond_extra | StakingCall_unbond | StakingCall_withdraw_unbonded | StakingCall_claim_rewards | StakingCall_force_set_bonus
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type RWSCall = RWSCall_call | RWSCall_bid | RWSCall_set_devices | RWSCall_set_oracle | RWSCall_set_subscription | RWSCall_start_auction
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type CrowdloanCall = CrowdloanCall_reserve | CrowdloanCall_upload_head_code | CrowdloanCall_start | CrowdloanCall_swap

/**
 * Register new parachain ID using XCM.
 */
export interface CrowdloanCall_reserve {
    __kind: 'reserve'
}
 ...
 */
export interface CrowdloanCall_upload_head_code {
    __kind: 'upload_head_code'
    id: number
 ...
 */
export interface CrowdloanCall_start {
    __kind: 'start'
    index: number
    cap: bigint
    firstPeriod: number
 ...
 */
export interface CrowdloanCall_swap {
    __kind: 'swap'
    target: number
}
...
export type OriginCaller = OriginCaller_system | OriginCaller_TechnicalCommittee | OriginCaller_PolkadotXcm | OriginCaller_CumulusXcm | OriginCaller_Void
...
export type Subscription = Subscription_Lifetime | Subscription_Daily
...
export type Type_243 = Type_243_V0 | Type_243_V1 | Type_243_V2

export interface Type_243_V0 {
    __kind: 'V0'
    value: Type_244
}

export interface Type_243_V1 {
    __kind: 'V1'
    value: Type_249
}

export interface Type_243_V2 {
    __kind: 'V2'
    value: Type_255[]
}
...
export type Type_260 = Type_260_Members | Type_260_Member | Type_260__Phantom

export interface Type_260_Members {
    __kind: 'Members'
    value: [number, number]
}

export interface Type_260_Member {
    __kind: 'Member'
    value: Uint8Array
}

export interface Type_260__Phantom {
    __kind: '_Phantom'
}
...
export type Type_244 = Type_244_WithdrawAsset | Type_244_ReserveAssetDeposit | Type_244_TeleportAsset | Type_244_QueryResponse | Type_244_TransferAsset | Type_244_TransferReserveAsset | Type_244_Transact | Type_244_HrmpNewChannelOpenRequest | Type_244_HrmpChannelAccepted | Type_244_HrmpChannelClosing | Type_244_RelayedFrom
...
export interface Type_244_ReserveAssetDeposit {
    __kind: 'ReserveAssetDeposit'
    assets: V0MultiAsset[]
    effects: Type_246[]
}

export interface Type_244_TeleportAsset {
    __kind: 'TeleportAsset'
    assets: V0MultiAsset[]
    effects: Type_246[]
}
...
export type Type_246 = Type_246_Null | Type_246_DepositAsset | Type_246_DepositReserveAsset | Type_246_ExchangeAsset | Type_246_InitiateReserveWithdraw | Type_246_InitiateTeleport | Type_246_QueryHolding | Type_246_BuyExecution

export interface Type_246_Null {
    __kind: 'Null'
}
...
export type Type_251 = Type_251_Noop | Type_251_DepositAsset | Type_251_DepositReserveAsset | Type_251_ExchangeAsset | Type_251_InitiateReserveWithdraw | Type_251_InitiateTeleport | Type_251_QueryHolding | Type_251_BuyExecution
