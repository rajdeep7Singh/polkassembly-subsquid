...
export type Type_328 = Type_328_Relay | Type_328_SiblingParachain

export interface Type_328_Relay {
    __kind: 'Relay'
}

export interface Type_328_SiblingParachain {
...
export type Type_405 = Type_405_Id | Type_405_Raw

export interface Type_405_Id {
    __kind: 'Id'
    value: AccountId32
}

export interface Type_405_Raw {
    __kind: 'Raw'
    value: Bytes
}
...
export const OriginCaller: sts.Type<OriginCaller> = sts.closedEnum(() => {
    return  {
        ...
        CumulusXcm: Type_328,
        PolkadotXcm: Origin,
        ReleaseCommittee: Type_326,
        TechnicalCommittee: Type_325,
        Void: Void,
        system: RawOrigin,
    }
})
