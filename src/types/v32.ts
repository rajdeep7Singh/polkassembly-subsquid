...
export type OriginCaller = OriginCaller_CumulusXcm | OriginCaller_PolkadotXcm | OriginCaller_TechnicalCommittee | OriginCaller_Void | OriginCaller_system
 ...
 * Contains a variant per dispatchable extrinsic that this pallet has.
 */
export type RWSCall = RWSCall_bid | RWSCall_call | RWSCall_set_devices | RWSCall_set_oracle | RWSCall_set_subscription | RWSCall_start_auction

/**
 * See [`Pallet::bid`].
 */
export interface RWSCall_bid {
    __kind: 'bid'
    index: number
    amount: bigint
}
...
/**
 * See [`Pallet::set_devices`].
 */
export interface RWSCall_set_devices {
    __kind: 'set_devices'
    devices: AccountId32[]
}

/**
 * See [`Pallet::set_oracle`].
 */
export interface RWSCall_set_oracle {
    __kind: 'set_oracle'
    new: MultiAddress
}

/**
 * See [`Pallet::set_subscription`].
 */
export interface RWSCall_set_subscription {
    __kind: 'set_subscription'
    target: AccountId32
 ...
 */
export interface RWSCall_start_auction {
    __kind: 'start_auction'
    kind: Subscription
}

export type Subscription = Subscription_Daily | Subscription_Lifetime

export interface Subscription_Daily {
    __kind: 'Daily'
    days: number
}
...
export type Type_255 = Type_255_V2 | Type_255_V3
...
export interface Type_255_V3 {
    __kind: 'V3'
    value: Type_262[]
}

export type Type_262 = Type_262_AliasOrigin | Type_262_BurnAsset | Type_262_BuyExecution | Type_262_ClaimAsset | Type_262_ClearError | Type_262_ClearOrigin | Type_262_ClearTopic | Type_262_ClearTransactStatus | Type_262_DepositAsset | Type_262_DepositReserveAsset | Type_262_DescendOrigin | Type_262_ExchangeAsset | Type_262_ExpectAsset | Type_262_ExpectError | Type_262_ExpectOrigin | Type_262_ExpectPallet | Type_262_ExpectTransactStatus | Type_262_ExportMessage | Type_262_HrmpChannelAccepted | Type_262_HrmpChannelClosing | Type_262_HrmpNewChannelOpenRequest | Type_262_InitiateReserveWithdraw | Type_262_InitiateTeleport | Type_262_LockAsset | Type_262_NoteUnlockable | Type_262_QueryPallet | Type_262_QueryResponse | Type_262_ReceiveTeleportedAsset | Type_262_RefundSurplus | Type_262_ReportError | Type_262_ReportHolding | Type_262_ReportTransactStatus | Type_262_RequestUnlock | Type_262_ReserveAssetDeposited | Type_262_SetAppendix | Type_262_SetErrorHandler | Type_262_SetFeesMode | Type_262_SetTopic | Type_262_SubscribeVersion | Type_262_Transact | Type_262_TransferAsset | Type_262_TransferReserveAsset | Type_262_Trap | Type_262_UniversalOrigin | Type_262_UnlockAsset | Type_262_UnpaidExecution | Type_262_UnsubscribeVersion | Type_262_WithdrawAsset

export interface Type_262_AliasOrigin {
    __kind: 'AliasOrigin'
    value: V3MultiLocation
}

export interface Type_262_BurnAsset {
    __kind: 'BurnAsset'
    value: V3MultiAsset[]
}
...
export interface Type_262_ClaimAsset {
    __kind: 'ClaimAsset'
    assets: V3MultiAsset[]
    ticket: V3MultiLocation
}

export interface Type_262_ClearError {
    __kind: 'ClearError'
}

export interface Type_262_ClearOrigin {
    __kind: 'ClearOrigin'
}

export interface Type_262_ClearTopic {
    __kind: 'ClearTopic'
}

export interface Type_262_ClearTransactStatus {
    __kind: 'ClearTransactStatus'
}
...
export interface Type_262_DescendOrigin {
    __kind: 'DescendOrigin'
    value: V3Junctions
}
...
export interface Type_262_ExpectAsset {
    __kind: 'ExpectAsset'
    value: V3MultiAsset[]
}

export interface Type_262_ExpectError {
    __kind: 'ExpectError'
    value?: ([number, V3Error] | undefined)
}

export interface Type_262_ExpectOrigin {
    __kind: 'ExpectOrigin'
    value?: (V3MultiLocation | undefined)
}

export interface Type_262_ExpectPallet {
    __kind: 'ExpectPallet'
    index: number
    name: Bytes
    moduleName: Bytes
...
export interface Type_262_ExpectTransactStatus {
    __kind: 'ExpectTransactStatus'
    value: V3MaybeErrorCode
}

export interface Type_262_ExportMessage {
    __kind: 'ExportMessage'
    network: V3NetworkId
    destination: V3Junctions
    xcm: V3Instruction[]
...
export interface Type_262_LockAsset {
    __kind: 'LockAsset'
    asset: V3MultiAsset
    unlocker: V3MultiLocation
}

export interface Type_262_NoteUnlockable {
    __kind: 'NoteUnlockable'
    asset: V3MultiAsset
    owner: V3MultiLocation
}

export interface Type_262_QueryPallet {
    __kind: 'QueryPallet'
    moduleName: Bytes
    responseInfo: V3QueryResponseInfo
}
...
export interface Type_262_RefundSurplus {
    __kind: 'RefundSurplus'
}

export interface Type_262_ReportError {
    __kind: 'ReportError'
    value: V3QueryResponseInfo
}

export interface Type_262_ReportHolding {
    __kind: 'ReportHolding'
    responseInfo: V3QueryResponseInfo
    assets: V3MultiAssetFilter
}

export interface Type_262_ReportTransactStatus {
    __kind: 'ReportTransactStatus'
    value: V3QueryResponseInfo
}

export interface Type_262_RequestUnlock {
    __kind: 'RequestUnlock'
    asset: V3MultiAsset
    locker: V3MultiLocation
}
...
export interface Type_262_SetAppendix {
    __kind: 'SetAppendix'
    value: Type_262[]
}

export interface Type_262_SetErrorHandler {
    __kind: 'SetErrorHandler'
    value: Type_262[]
}

export interface Type_262_SetFeesMode {
    __kind: 'SetFeesMode'
    jitWithdraw: boolean
}

export interface Type_262_SetTopic {
    __kind: 'SetTopic'
    value: Bytes
}
...
export interface Type_262_Trap {
    __kind: 'Trap'
    value: bigint
}

export interface Type_262_UniversalOrigin {
    __kind: 'UniversalOrigin'
    value: V3Junction
}

export interface Type_262_UnlockAsset {
    __kind: 'UnlockAsset'
    asset: V3MultiAsset
    target: V3MultiLocation
}

export interface Type_262_UnpaidExecution {
    __kind: 'UnpaidExecution'
    weightLimit: V3WeightLimit
    checkOrigin?: (V3MultiLocation | undefined)
}
...
export type Type_258 = Type_258_BuyExecution | Type_258_ClaimAsset | Type_258_ClearError | Type_258_ClearOrigin | Type_258_DepositAsset | Type_258_DepositReserveAsset | Type_258_DescendOrigin | Type_258_ExchangeAsset | Type_258_HrmpChannelAccepted | Type_258_HrmpChannelClosing | Type_258_HrmpNewChannelOpenRequest | Type_258_InitiateReserveWithdraw | Type_258_InitiateTeleport | Type_258_QueryHolding | Type_258_QueryResponse | Type_258_ReceiveTeleportedAsset | Type_258_RefundSurplus | Type_258_ReportError | Type_258_ReserveAssetDeposited | Type_258_SetAppendix | Type_258_SetErrorHandler | Type_258_SubscribeVersion | Type_258_Transact | Type_258_TransferAsset | Type_258_TransferReserveAsset | Type_258_Trap | Type_258_UnsubscribeVersion | Type_258_WithdrawAsset
 ...
 * Contains a variant per dispatchable extrinsic that this pallet has.
 */
export type DigitalTwinCall = DigitalTwinCall_create | DigitalTwinCall_set_source

/**
 * See [`Pallet::create`].
 */
export interface DigitalTwinCall_create {
    __kind: 'create'
}

/**
 * See [`Pallet::set_source`].
 */
export interface DigitalTwinCall_set_source {
    __kind: 'set_source'
    id: number
    topic: H256
    source: AccountId32
 ...
 * Contains a variant per dispatchable extrinsic that this pallet has.
 */
export const RWSCall: sts.Type<RWSCall> = sts.closedEnum(() => {
    return  {
        bid: sts.enumStruct({
            index: sts.number(),
            amount: sts.bigint(),
        ...
        set_devices: sts.enumStruct({
            devices: sts.array(() => AccountId32),
        }),
        set_oracle: sts.enumStruct({
            new: MultiAddress,
        }),
        set_subscription: sts.enumStruct({
            target: AccountId32,
            subscription: Subscription,
        }),
...
export const Subscription: sts.Type<Subscription> = sts.closedEnum(() => {
    return  {
        Daily: sts.enumStruct({
            days: sts.number(),
        }),
...
export const Type_255: sts.Type<Type_255> = sts.closedEnum(() => {
    return  {
        V2: sts.array(() => Type_258),
        V3: sts.array(() => Type_262),
    }
})
...
export const Type_262: sts.Type<Type_262> = sts.closedEnum(() => {
    return  {
        ...
        ReserveAssetDeposited: sts.array(() => V3MultiAsset),
        SetAppendix: sts.array(() => Type_262),
        SetErrorHandler: sts.array(() => Type_262),
        SetFeesMode: sts.enumStruct({
            jitWithdraw: sts.boolean(),
        }),
        SetTopic: sts.bytes(),
 ...
 * Contains a variant per dispatchable extrinsic that this pallet has.
 */
export const LighthouseCall: sts.Type<LighthouseCall> = sts.closedEnum(() => {
    return  {
        set: sts.enumStruct({
            lighthouse: AccountId32,
        }),
 ...
 * Contains a variant per dispatchable extrinsic that this pallet has.
 */
export const LaunchCall: sts.Type<LaunchCall> = sts.closedEnum(() => {
    return  {
 ...
 * Contains a variant per dispatchable extrinsic that this pallet has.
 */
export const DigitalTwinCall: sts.Type<DigitalTwinCall> = sts.closedEnum(() => {
    return  {
        create: sts.unit(),
        set_source: sts.enumStruct({
            id: sts.number(),
            topic: H256,
            source: AccountId32,
        }),
