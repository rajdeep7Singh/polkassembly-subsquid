...
export type Type_314 = Type_314_Relay | Type_314_SiblingParachain

export interface Type_314_Relay {
    __kind: 'Relay'
}

export interface Type_314_SiblingParachain {
...
export type Type_333 = Type_333_V2 | Type_333_V3
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type Ics20FeeCall = Ics20FeeCall_set_charge
...
export type Type_380 = Type_380_Id | Type_380_Raw

export interface Type_380_Id {
    __kind: 'Id'
    value: AccountId32
}

export interface Type_380_Raw {
    __kind: 'Raw'
    value: Bytes
}
...
export const Type_349: sts.Type<Type_349> = sts.struct(() => {
    return  {
        inner: sts.bytes(),
    }
})
