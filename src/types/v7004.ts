...
export type ProxyType = ProxyType_Any | ProxyType_Governance | ProxyType_IdentityJudgement | ProxyType_NonTransfer | ProxyType_Staking
...
export type Type_320 = Type_320_V2 | Type_320_V3
...
export type Type_354 = Type_354_Preimage

export interface Type_354_Preimage {
    __kind: 'Preimage'
}
...
export type Type_355 = Type_355_Evaluation | Type_355_Participation

export interface Type_355_Evaluation {
    __kind: 'Evaluation'
    value: number
}

export interface Type_355_Participation {
    __kind: 'Participation'
    value: number
}

export type Type_353 = Type_353_Candidacy

export interface Type_353_Candidacy {
    __kind: 'Candidacy'
}

export type Type_352 = Type_352_Proposal

export interface Type_352_Proposal {
    __kind: 'Proposal'
}
 ...
 * Contains a variant per dispatchable extrinsic that this pallet has.
 */
export type FundingCall = FundingCall_bid | FundingCall_community_contribute | FundingCall_confirm_migrations | FundingCall_create_project | FundingCall_decide_project_outcome | FundingCall_edit_project | FundingCall_evaluate | FundingCall_migrate_one_participant | FundingCall_migration_check_response | FundingCall_remaining_contribute | FundingCall_remove_project | FundingCall_root_do_auction_opening | FundingCall_root_do_community_funding | FundingCall_root_do_end_auction_closing | FundingCall_root_do_end_funding | FundingCall_root_do_evaluation_end | FundingCall_root_do_project_decision | FundingCall_root_do_remainder_funding | FundingCall_root_do_start_auction_closing | FundingCall_root_do_start_settlement | FundingCall_set_para_id_for_project | FundingCall_settle_failed_bid | FundingCall_settle_failed_contribution | FundingCall_settle_failed_evaluation | FundingCall_settle_successful_bid | FundingCall_settle_successful_contribution | FundingCall_settle_successful_evaluation | FundingCall_start_auction | FundingCall_start_evaluation | FundingCall_start_migration_readiness_check
...
/**
 * See [`Pallet::community_contribute`].
 */
export interface FundingCall_community_contribute {
    __kind: 'community_contribute'
    jwt: UntrustedToken
    projectId: number
    amount: bigint
    multiplier: Multiplier
...
/**
 * See [`Pallet::confirm_migrations`].
 */
export interface FundingCall_confirm_migrations {
    __kind: 'confirm_migrations'
    queryId: bigint
    response: V3Response
}
...
/**
 * See [`Pallet::decide_project_outcome`].
 */
export interface FundingCall_decide_project_outcome {
    __kind: 'decide_project_outcome'
    jwt: UntrustedToken
    projectId: number
...
/**
 * See [`Pallet::migrate_one_participant`].
 */
export interface FundingCall_migrate_one_participant {
    __kind: 'migrate_one_participant'
    projectId: number
    participant: AccountId32
}

/**
 * See [`Pallet::migration_check_response`].
 */
export interface FundingCall_migration_check_response {
    __kind: 'migration_check_response'
    queryId: bigint
    response: V3Response
}

/**
 * See [`Pallet::remaining_contribute`].
 */
export interface FundingCall_remaining_contribute {
    __kind: 'remaining_contribute'
    jwt: UntrustedToken
    projectId: number
    amount: bigint
    multiplier: Multiplier
...
/**
 * See [`Pallet::root_do_auction_opening`].
 */
export interface FundingCall_root_do_auction_opening {
    __kind: 'root_do_auction_opening'
    projectId: number
}

/**
 * See [`Pallet::root_do_community_funding`].
 */
export interface FundingCall_root_do_community_funding {
    __kind: 'root_do_community_funding'
    projectId: number
}

/**
 * See [`Pallet::root_do_end_auction_closing`].
 */
export interface FundingCall_root_do_end_auction_closing {
    __kind: 'root_do_end_auction_closing'
    projectId: number
}

/**
 * See [`Pallet::root_do_end_funding`].
 */
export interface FundingCall_root_do_end_funding {
    __kind: 'root_do_end_funding'
    projectId: number
}

/**
 * See [`Pallet::root_do_evaluation_end`].
 */
export interface FundingCall_root_do_evaluation_end {
    __kind: 'root_do_evaluation_end'
    projectId: number
}

/**
 * See [`Pallet::root_do_project_decision`].
 */
export interface FundingCall_root_do_project_decision {
    __kind: 'root_do_project_decision'
    projectId: number
    decision: FundingOutcomeDecision
}

/**
 * See [`Pallet::root_do_remainder_funding`].
 */
export interface FundingCall_root_do_remainder_funding {
    __kind: 'root_do_remainder_funding'
    projectId: number
}

/**
 * See [`Pallet::root_do_start_auction_closing`].
 */
export interface FundingCall_root_do_start_auction_closing {
    __kind: 'root_do_start_auction_closing'
    projectId: number
}

/**
 * See [`Pallet::root_do_start_settlement`].
 */
export interface FundingCall_root_do_start_settlement {
    __kind: 'root_do_start_settlement'
    projectId: number
}

/**
 * See [`Pallet::set_para_id_for_project`].
 */
export interface FundingCall_set_para_id_for_project {
    __kind: 'set_para_id_for_project'
    jwt: UntrustedToken
    projectId: number
    paraId: Id
}
...
/**
 * See [`Pallet::settle_failed_bid`].
 */
export interface FundingCall_settle_failed_bid {
    __kind: 'settle_failed_bid'
    projectId: number
    bidder: AccountId32
    bidId: number
}
...
/**
 * See [`Pallet::settle_failed_contribution`].
 */
export interface FundingCall_settle_failed_contribution {
    __kind: 'settle_failed_contribution'
    projectId: number
...
/**
 * See [`Pallet::settle_failed_evaluation`].
 */
export interface FundingCall_settle_failed_evaluation {
    __kind: 'settle_failed_evaluation'
    projectId: number
...
/**
 * See [`Pallet::settle_successful_bid`].
 */
export interface FundingCall_settle_successful_bid {
    __kind: 'settle_successful_bid'
    projectId: number
    bidder: AccountId32
    bidId: number
}
...
/**
 * See [`Pallet::settle_successful_contribution`].
 */
export interface FundingCall_settle_successful_contribution {
    __kind: 'settle_successful_contribution'
    projectId: number
    contributor: AccountId32
    contributionId: number
}
...
/**
 * See [`Pallet::settle_successful_evaluation`].
 */
export interface FundingCall_settle_successful_evaluation {
    __kind: 'settle_successful_evaluation'
    projectId: number
    evaluator: AccountId32
    evaluationId: number
}
...
/**
 * See [`Pallet::start_auction`].
 */
export interface FundingCall_start_auction {
    __kind: 'start_auction'
    jwt: UntrustedToken
    projectId: number
}

/**
 * See [`Pallet::start_evaluation`].
 */
...
/**
 * See [`Pallet::start_migration_readiness_check`].
 */
export interface FundingCall_start_migration_readiness_check {
    __kind: 'start_migration_readiness_check'
    jwt: UntrustedToken
    projectId: number
}

export type FundingOutcomeDecision = FundingOutcomeDecision_AcceptFunding | FundingOutcomeDecision_RejectFunding

export interface FundingOutcomeDecision_AcceptFunding {
    __kind: 'AcceptFunding'
}

export interface FundingOutcomeDecision_RejectFunding {
    __kind: 'RejectFunding'
}
...
export interface Header {
    ...
    certificateThumbprint?: (Type_295 | undefined)
    tokenType?: (string | undefined)
}

export type Type_295 = Type_295_Bytes | Type_295_String

export interface Type_295_Bytes {
    __kind: 'Bytes'
    value: Bytes
}

export interface Type_295_String {
    __kind: 'String'
    value: string
}
...
/**
 * See [`Pallet::set_dispense_amount`].
 */
...
export const Type_305: sts.Type<Type_305> = sts.struct(() => {
    return  {
        min: Perbill,
        ideal: Perbill,
        max: Perbill,
...
export const Type_355: sts.Type<Type_355> = sts.closedEnum(() => {
    return  {
        Evaluation: sts.number(),
        Participation: sts.number(),
    }
})
...
export const FundingCall: sts.Type<FundingCall> = sts.closedEnum(() => {
    return  {
        ...
        community_contribute: sts.enumStruct({
            jwt: UntrustedToken,
            projectId: sts.number(),
            amount: sts.bigint(),
            multiplier: Multiplier,
        ...
        confirm_migrations: sts.enumStruct({
            queryId: sts.bigint(),
            response: V3Response,
        }),
        ...
        decide_project_outcome: sts.enumStruct({
            jwt: UntrustedToken,
            projectId: sts.number(),
            outcome: FundingOutcomeDecision,
        }),
        ...
        migrate_one_participant: sts.enumStruct({
            projectId: sts.number(),
            participant: AccountId32,
        }),
        migration_check_response: sts.enumStruct({
            queryId: sts.bigint(),
            response: V3Response,
        }),
        remaining_contribute: sts.enumStruct({
            jwt: UntrustedToken,
            projectId: sts.number(),
            amount: sts.bigint(),
            multiplier: Multiplier,
        ...
        root_do_auction_opening: sts.enumStruct({
            projectId: sts.number(),
        }),
        root_do_community_funding: sts.enumStruct({
            projectId: sts.number(),
        }),
        root_do_end_auction_closing: sts.enumStruct({
            projectId: sts.number(),
        }),
        root_do_end_funding: sts.enumStruct({
            projectId: sts.number(),
        }),
        root_do_evaluation_end: sts.enumStruct({
            projectId: sts.number(),
        }),
        root_do_project_decision: sts.enumStruct({
            projectId: sts.number(),
            decision: FundingOutcomeDecision,
        }),
        root_do_remainder_funding: sts.enumStruct({
            projectId: sts.number(),
        }),
        root_do_start_auction_closing: sts.enumStruct({
            projectId: sts.number(),
        }),
        root_do_start_settlement: sts.enumStruct({
            projectId: sts.number(),
        }),
        set_para_id_for_project: sts.enumStruct({
            jwt: UntrustedToken,
            projectId: sts.number(),
            paraId: Id,
        }),
        settle_failed_bid: sts.enumStruct({
            projectId: sts.number(),
            bidder: AccountId32,
            bidId: sts.number(),
        }),
        settle_failed_contribution: sts.enumStruct({
            projectId: sts.number(),
            contributor: AccountId32,
            contributionId: sts.number(),
        }),
        settle_failed_evaluation: sts.enumStruct({
            projectId: sts.number(),
            evaluator: AccountId32,
            evaluationId: sts.number(),
        }),
        settle_successful_bid: sts.enumStruct({
            projectId: sts.number(),
            bidder: AccountId32,
            bidId: sts.number(),
        }),
        settle_successful_contribution: sts.enumStruct({
            projectId: sts.number(),
            contributor: AccountId32,
            contributionId: sts.number(),
        }),
        settle_successful_evaluation: sts.enumStruct({
            projectId: sts.number(),
            evaluator: AccountId32,
            evaluationId: sts.number(),
        }),
        start_auction: sts.enumStruct({
            jwt: UntrustedToken,
            projectId: sts.number(),
        }),
        ...
        start_migration_readiness_check: sts.enumStruct({
            jwt: UntrustedToken,
            projectId: sts.number(),
        }),
    }
...
export const FundingOutcomeDecision: sts.Type<FundingOutcomeDecision> = sts.closedEnum(() => {
    return  {
        AcceptFunding: sts.unit(),
        RejectFunding: sts.unit(),
    }
})
...
export const Header: sts.Type<Header> = sts.struct(() => {
    return  {
        ...
        certificateThumbprint: sts.option(() => Type_295),
