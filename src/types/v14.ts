...
export type Call = Call_AssetRegistry | Call_Balances | Call_Bounties | Call_ChildBounties | Call_ClientsInfo | Call_Contracts | Call_Council | Call_Currencies | Call_Democracy | Call_DiaOracleModule | Call_DmpQueue | Call_Farming | Call_Fee | Call_Identity | Call_Issue | Call_Multisig | Call_Nomination | Call_Oracle | Call_ParachainStaking | Call_ParachainSystem | Call_PolkadotXcm | Call_PooledVaultRewards | Call_Preimage | Call_Proxy | Call_Redeem | Call_Replace | Call_RewardDistribution | Call_Scheduler | Call_Security | Call_Session | Call_StellarRelay | Call_System | Call_TechnicalCommittee | Call_Timestamp | Call_TokenAllowance | Call_Tokens | Call_Treasury | Call_TreasuryBuyoutExtension | Call_Utility | Call_VaultRegistry | Call_Vesting | Call_VestingManager | Call_XTokens | Call_XcmpQueue | Call_ZenlinkProtocol
...
export type Type_287 = Type_287_V2 | Type_287_V3
...
export interface Type_287_V3 {
    __kind: 'V3'
    value: Type_294[]
}

export type Type_294 = Type_294_AliasOrigin | Type_294_BurnAsset | Type_294_BuyExecution | Type_294_ClaimAsset | Type_294_ClearError | Type_294_ClearOrigin | Type_294_ClearTopic | Type_294_ClearTransactStatus | Type_294_DepositAsset | Type_294_DepositReserveAsset | Type_294_DescendOrigin | Type_294_ExchangeAsset | Type_294_ExpectAsset | Type_294_ExpectError | Type_294_ExpectOrigin | Type_294_ExpectPallet | Type_294_ExpectTransactStatus | Type_294_ExportMessage | Type_294_HrmpChannelAccepted | Type_294_HrmpChannelClosing | Type_294_HrmpNewChannelOpenRequest | Type_294_InitiateReserveWithdraw | Type_294_InitiateTeleport | Type_294_LockAsset | Type_294_NoteUnlockable | Type_294_QueryPallet | Type_294_QueryResponse | Type_294_ReceiveTeleportedAsset | Type_294_RefundSurplus | Type_294_ReportError | Type_294_ReportHolding | Type_294_ReportTransactStatus | Type_294_RequestUnlock | Type_294_ReserveAssetDeposited | Type_294_SetAppendix | Type_294_SetErrorHandler | Type_294_SetFeesMode | Type_294_SetTopic | Type_294_SubscribeVersion | Type_294_Transact | Type_294_TransferAsset | Type_294_TransferReserveAsset | Type_294_Trap | Type_294_UniversalOrigin | Type_294_UnlockAsset | Type_294_UnpaidExecution | Type_294_UnsubscribeVersion | Type_294_WithdrawAsset

export interface Type_294_AliasOrigin {
    __kind: 'AliasOrigin'
    value: V3MultiLocation
}

export interface Type_294_BurnAsset {
    __kind: 'BurnAsset'
    value: V3MultiAsset[]
}
...
export interface Type_294_ClearTopic {
    __kind: 'ClearTopic'
}

export interface Type_294_ClearTransactStatus {
    __kind: 'ClearTransactStatus'
}
...
export interface Type_294_ExpectAsset {
    __kind: 'ExpectAsset'
    value: V3MultiAsset[]
}

export interface Type_294_ExpectError {
    __kind: 'ExpectError'
    value?: ([number, V3Error] | undefined)
}

export interface Type_294_ExpectOrigin {
    __kind: 'ExpectOrigin'
    value?: (V3MultiLocation | undefined)
}

export interface Type_294_ExpectPallet {
    __kind: 'ExpectPallet'
    index: number
    name: Bytes
    moduleName: Bytes
...
export interface Type_294_ExpectTransactStatus {
    __kind: 'ExpectTransactStatus'
    value: V3MaybeErrorCode
}

export interface Type_294_ExportMessage {
    __kind: 'ExportMessage'
    network: V3NetworkId
    destination: V3Junctions
    xcm: V3Instruction[]
...
export interface Type_294_LockAsset {
    __kind: 'LockAsset'
    asset: V3MultiAsset
    unlocker: V3MultiLocation
}

export interface Type_294_NoteUnlockable {
    __kind: 'NoteUnlockable'
    asset: V3MultiAsset
    owner: V3MultiLocation
}

export interface Type_294_QueryPallet {
    __kind: 'QueryPallet'
    moduleName: Bytes
    responseInfo: V3QueryResponseInfo
}
...
export interface Type_294_ReportHolding {
    __kind: 'ReportHolding'
    responseInfo: V3QueryResponseInfo
    assets: V3MultiAssetFilter
}

export interface Type_294_ReportTransactStatus {
    __kind: 'ReportTransactStatus'
    value: V3QueryResponseInfo
}

export interface Type_294_RequestUnlock {
    __kind: 'RequestUnlock'
    asset: V3MultiAsset
    locker: V3MultiLocation
}
...
export interface Type_294_SetFeesMode {
    __kind: 'SetFeesMode'
    jitWithdraw: boolean
}

export interface Type_294_SetTopic {
    __kind: 'SetTopic'
    value: Bytes
}
...
export interface Type_294_UniversalOrigin {
    __kind: 'UniversalOrigin'
    value: V3Junction
}

export interface Type_294_UnlockAsset {
    __kind: 'UnlockAsset'
    asset: V3MultiAsset
    target: V3MultiLocation
}

export interface Type_294_UnpaidExecution {
    __kind: 'UnpaidExecution'
    weightLimit: V3WeightLimit
    checkOrigin?: (V3MultiLocation | undefined)
}
...
export type Type_290 = Type_290_BuyExecution | Type_290_ClaimAsset | Type_290_ClearError | Type_290_ClearOrigin | Type_290_DepositAsset | Type_290_DepositReserveAsset | Type_290_DescendOrigin | Type_290_ExchangeAsset | Type_290_HrmpChannelAccepted | Type_290_HrmpChannelClosing | Type_290_HrmpNewChannelOpenRequest | Type_290_InitiateReserveWithdraw | Type_290_InitiateTeleport | Type_290_QueryHolding | Type_290_QueryResponse | Type_290_ReceiveTeleportedAsset | Type_290_RefundSurplus | Type_290_ReportError | Type_290_ReserveAssetDeposited | Type_290_SetAppendix | Type_290_SetErrorHandler | Type_290_SubscribeVersion | Type_290_Transact | Type_290_TransferAsset | Type_290_TransferReserveAsset | Type_290_Trap | Type_290_UnsubscribeVersion | Type_290_WithdrawAsset
...
export const Type_287: sts.Type<Type_287> = sts.closedEnum(() => {
    return  {
        V2: sts.array(() => Type_290),
        V3: sts.array(() => Type_294),
    }
})
