...
export const OriginCaller: sts.Type<OriginCaller> = sts.closedEnum(() => {
    return  {
        PolymeshCommittee: Type_529,
        TechnicalCommittee: Type_530,
        UpgradeCommittee: Type_531,
        Void: Void,
        system: RawOrigin,
    }
})
...
export const Type_459: sts.Type<Type_459> = sts.struct(() => {
    return  {
        setId: sts.bigint(),
        equivocation: Equivocation,
    }
