...
export type Type_530 = Type_530_Endorsed

export interface Type_530_Endorsed {
    __kind: 'Endorsed'
}

export type Type_529 = Type_529_Endorsed

export interface Type_529_Endorsed {
    __kind: 'Endorsed'
}

export type Type_528 = Type_528_Endorsed

export interface Type_528_Endorsed {
    __kind: 'Endorsed'
}
...
export const OriginCaller: sts.Type<OriginCaller> = sts.closedEnum(() => {
    return  {
        PolymeshCommittee: Type_528,
        TechnicalCommittee: Type_529,
        UpgradeCommittee: Type_530,
        Void: Void,
        system: RawOrigin,
    }
})
...
export const Type_528: sts.Type<Type_528> = sts.closedEnum(() => {
    return  {
        Endorsed: sts.unit(),
    }
})
...
export const Type_458: sts.Type<Type_458> = sts.struct(() => {
    return  {
        setId: sts.bigint(),
        equivocation: Equivocation,
    }
...
export const Type_465: sts.Type<Type_465> = sts.struct(() => {
    return  {
        roundNumber: sts.bigint(),
        identity: Public,
