...
export const proposalOf =  {
     ...
     */
    v0: new StorageType('TechnicalCommittee.ProposalOf', 'Optional', [v0.Hash], v0.Proposal) as ProposalOfV0,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    v5: new StorageType('TechnicalCommittee.ProposalOf', 'Optional', [v5.Hash], v5.Proposal) as ProposalOfV5,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    v6: new StorageType('TechnicalCommittee.ProposalOf', 'Optional', [v6.Hash], v6.Proposal) as ProposalOfV6,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    v7: new StorageType('TechnicalCommittee.ProposalOf', 'Optional', [v7.Hash], v7.Proposal) as ProposalOfV7,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    v9: new StorageType('TechnicalCommittee.ProposalOf', 'Optional', [v9.Hash], v9.Proposal) as ProposalOfV9,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    v10: new StorageType('TechnicalCommittee.ProposalOf', 'Optional', [v10.Hash], v10.Proposal) as ProposalOfV10,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    v11: new StorageType('TechnicalCommittee.ProposalOf', 'Optional', [v11.Hash], v11.Proposal) as ProposalOfV11,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    v13: new StorageType('TechnicalCommittee.ProposalOf', 'Optional', [v13.Hash], v13.Proposal) as ProposalOfV13,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    v14: new StorageType('TechnicalCommittee.ProposalOf', 'Optional', [v14.Hash], v14.Proposal) as ProposalOfV14,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    v15: new StorageType('TechnicalCommittee.ProposalOf', 'Optional', [v15.Hash], v15.Proposal) as ProposalOfV15,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    v17: new StorageType('TechnicalCommittee.ProposalOf', 'Optional', [v17.Hash], v17.Proposal) as ProposalOfV17,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    v18: new StorageType('TechnicalCommittee.ProposalOf', 'Optional', [v18.Hash], v18.Proposal) as ProposalOfV18,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    v23: new StorageType('TechnicalCommittee.ProposalOf', 'Optional', [v23.Hash], v23.Proposal) as ProposalOfV23,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    v24: new StorageType('TechnicalCommittee.ProposalOf', 'Optional', [v24.Hash], v24.Proposal) as ProposalOfV24,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
     ...
     *  Actual proposal for a given hash, if it's current.
     */
    v26: new StorageType('TechnicalCommittee.ProposalOf', 'Optional', [v26.Hash], v26.Proposal) as ProposalOfV26,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    v28: new StorageType('TechnicalCommittee.ProposalOf', 'Optional', [v28.Hash], v28.Proposal) as ProposalOfV28,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    v29: new StorageType('TechnicalCommittee.ProposalOf', 'Optional', [v29.Hash], v29.Proposal) as ProposalOfV29,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    v30: new StorageType('TechnicalCommittee.ProposalOf', 'Optional', [v30.Hash], v30.Proposal) as ProposalOfV30,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
