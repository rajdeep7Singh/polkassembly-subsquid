...
export const proposalOf =  {
     ...
     *  Actual proposal for a given hash, if it's current.
     */
    v22: new StorageType('TechnicalCommittee.ProposalOf', 'Optional', [v22.H256], v22.Call) as ProposalOfV22,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
     ...
     *  Actual proposal for a given hash, if it's current.
     */
    v29: new StorageType('TechnicalCommittee.ProposalOf', 'Optional', [v29.H256], v29.Call) as ProposalOfV29,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
