...
export type Type_296 = Type_296_Member | Type_296_Members | Type_296__Phantom

export interface Type_296_Member {
    __kind: 'Member'
    value: AccountId32
}

export interface Type_296_Members {
    __kind: 'Members'
    value: [number, number]
}

export interface Type_296__Phantom {
    __kind: '_Phantom'
}
