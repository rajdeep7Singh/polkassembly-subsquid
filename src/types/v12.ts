 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type TreasuryCall = TreasuryCall_colaterall_buyout | TreasuryCall_buyout | TreasuryCall_update_buyout_limit
 ...
 */
export interface TreasuryCall_colaterall_buyout {
    __kind: 'colaterall_buyout'
    asset: bigint
    amount: bigint
    maxPrice: bigint
}
...
/**
 * Send asset to parachain or relay chain, where given asset is native
 * 
...
export type AccountData = AccountData_V0

export interface AccountData_V0 {
    __kind: 'V0'
    lock: bigint
    balance: [bigint, SignedBalance][]
}
...
export type XcmTransferDealWithFee = XcmTransferDealWithFee_SovereignAccWillPay | XcmTransferDealWithFee_TargetChainAccWillPay | XcmTransferDealWithFee_ThisAccWillPay

export interface XcmTransferDealWithFee_SovereignAccWillPay {
    __kind: 'SovereignAccWillPay'
}

export interface XcmTransferDealWithFee_TargetChainAccWillPay {
    __kind: 'TargetChainAccWillPay'
}
