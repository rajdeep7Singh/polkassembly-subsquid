...
export type IncentivesCall = IncentivesCall_deposit_dex_share | IncentivesCall_withdraw_dex_share | IncentivesCall_claim_rewards | IncentivesCall_update_incentive_rewards | IncentivesCall_update_dex_saving_rewards | IncentivesCall_update_claim_reward_deduction_rates | IncentivesCall_migrate_share_and_withdrawn_reward | IncentivesCall_migrate_pending_rewards
...
export interface IncentivesCall_migrate_share_and_withdrawn_reward {
    __kind: 'migrate_share_and_withdrawn_reward'
    count: number
}

export interface IncentivesCall_migrate_pending_rewards {
    __kind: 'migrate_pending_rewards'
    count: number
}
