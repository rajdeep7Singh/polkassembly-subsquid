...
export type Call = Call_Attestation | Call_AuraExt | Call_Authorship | Call_Balances | Call_Council | Call_Ctype | Call_Delegation | Call_Democracy | Call_Did | Call_DidLookup | Call_DmpQueue | Call_Indices | Call_ParachainStaking | Call_ParachainSystem | Call_PolkadotXcm | Call_Preimage | Call_Proxy | Call_Scheduler | Call_Session | Call_System | Call_TechnicalCommittee | Call_TechnicalMembership | Call_Timestamp | Call_Tips | Call_TipsMembership | Call_Treasury | Call_Utility | Call_Vesting | Call_Web3Names | Call_XcmpQueue
...
export type Type_230 = Type_230_Member | Type_230_Members | Type_230__Phantom

export interface Type_230_Member {
    __kind: 'Member'
    value: AccountId32
}

export interface Type_230_Members {
    __kind: 'Members'
    value: [number, number]
}

export interface Type_230__Phantom {
    __kind: '_Phantom'
}
...
export type Type_229 = Type_229_Member | Type_229_Members | Type_229__Phantom

export interface Type_229_Member {
    __kind: 'Member'
    value: AccountId32
}
...
export interface Type_229__Phantom {
    __kind: '_Phantom'
}
...
export type Type_308 = Type_308_V0 | Type_308_V1 | Type_308_V2

export interface Type_308_V0 {
    __kind: 'V0'
    value: Type_309
}

export interface Type_308_V1 {
    __kind: 'V1'
    value: Type_314
}

export interface Type_308_V2 {
    __kind: 'V2'
    value: Type_320[]
}
...
export type Type_314 = Type_314_HrmpChannelAccepted | Type_314_HrmpChannelClosing | Type_314_HrmpNewChannelOpenRequest | Type_314_QueryResponse | Type_314_ReceiveTeleportedAsset | Type_314_RelayedFrom | Type_314_ReserveAssetDeposited | Type_314_SubscribeVersion | Type_314_Transact | Type_314_TransferAsset | Type_314_TransferReserveAsset | Type_314_UnsubscribeVersion | Type_314_WithdrawAsset
...
export type Type_316 = Type_316_BuyExecution | Type_316_DepositAsset | Type_316_DepositReserveAsset | Type_316_ExchangeAsset | Type_316_InitiateReserveWithdraw | Type_316_InitiateTeleport | Type_316_Noop | Type_316_QueryHolding
...
export type Type_309 = Type_309_HrmpChannelAccepted | Type_309_HrmpChannelClosing | Type_309_HrmpNewChannelOpenRequest | Type_309_QueryResponse | Type_309_RelayedFrom | Type_309_ReserveAssetDeposit | Type_309_TeleportAsset | Type_309_Transact | Type_309_TransferAsset | Type_309_TransferReserveAsset | Type_309_WithdrawAsset
...
export interface Type_309_ReserveAssetDeposit {
    __kind: 'ReserveAssetDeposit'
    assets: V0MultiAsset[]
    effects: Type_311[]
}

export interface Type_309_TeleportAsset {
    __kind: 'TeleportAsset'
    assets: V0MultiAsset[]
    effects: Type_311[]
}
...
export type Type_311 = Type_311_BuyExecution | Type_311_DepositAsset | Type_311_DepositReserveAsset | Type_311_ExchangeAsset | Type_311_InitiateReserveWithdraw | Type_311_InitiateTeleport | Type_311_Null | Type_311_QueryHolding
...
export interface Type_311_Null {
    __kind: 'Null'
}
...
export const Type_316: sts.Type<Type_316> = sts.closedEnum(() => {
    return  {
        BuyExecution: sts.enumStruct({
            ...
            debt: sts.bigint(),
            haltOnError: sts.boolean(),
            instructions: sts.array(() => Type_314),
        }),
        DepositAsset: sts.enumStruct({
            assets: V1MultiAssetFilter,
            maxAssets: sts.number(),
