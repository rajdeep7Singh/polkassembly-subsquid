 ...
 * Contains a variant per dispatchable extrinsic that this pallet has.
 */
export type TheaExecutorCall = TheaExecutorCall_burn_native_tokens | TheaExecutorCall_claim_deposit | TheaExecutorCall_ethereum_withdraw | TheaExecutorCall_parachain_withdraw | TheaExecutorCall_set_withdrawal_fee | TheaExecutorCall_update_asset_metadata | TheaExecutorCall_withdraw
...
/**
 * See [`Pallet::ethereum_withdraw`].
 */
export interface TheaExecutorCall_ethereum_withdraw {
    __kind: 'ethereum_withdraw'
    assetId: bigint
    amount: bigint
    beneficiary: H160
 ...
 * Contains a variant per dispatchable extrinsic that this pallet has.
 */
export type TheaCall = TheaCall_add_thea_network | TheaCall_handle_misbehaviour | TheaCall_remove_thea_network | TheaCall_report_misbehaviour | TheaCall_send_thea_message | TheaCall_submit_incoming_message | TheaCall_submit_signed_outgoing_messages | TheaCall_update_incoming_nonce | TheaCall_update_outgoing_nonce
...
export const TheaExecutorCall: sts.Type<TheaExecutorCall> = sts.closedEnum(() => {
    return  {
        ...
        ethereum_withdraw: sts.enumStruct({
            assetId: sts.bigint(),
            amount: sts.bigint(),
            beneficiary: H160,
