...
export type Call = Call_System | Call_Timestamp | Call_Sudo | Call_AssetTxPayment | Call_Indices | Call_Balances | Call_Identity | Call_Multisig | Call_ParachainSystem | Call_ParachainInfo | Call_CollatorSelection | Call_Session | Call_Council | Call_CouncilMembership | Call_Treasury | Call_Democracy | Call_TechnicalCommittee | Call_TechnicalCommitteeMembership | Call_ReleaseCommittee | Call_ReleaseMembership | Call_Scheduler | Call_Utility | Call_Preimage | Call_Proxy | Call_XcmpQueue | Call_PolkadotXcm | Call_CumulusXcm | Call_DmpQueue | Call_XTokens | Call_UnknownTokens | Call_Tokens | Call_CrowdloanRewards | Call_Vesting | Call_Assets | Call_AssetsRegistry | Call_Pablo | Call_Oracle | Call_FarmingRewards | Call_Farming | Call_Referenda | Call_ConvictionVoting | Call_OpenGovBalances | Call_Whitelist | Call_CallFilter | Call_Cosmwasm | Call_Ibc | Call_Ics20Fee | Call_PalletMultihopXcmIbc
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type OpenGovBalancesCall = OpenGovBalancesCall_transfer_allow_death | OpenGovBalancesCall_set_balance_deprecated | OpenGovBalancesCall_force_transfer | OpenGovBalancesCall_transfer_keep_alive | OpenGovBalancesCall_transfer_all | OpenGovBalancesCall_force_unreserve | OpenGovBalancesCall_upgrade_accounts | OpenGovBalancesCall_transfer | OpenGovBalancesCall_force_set_balance
 ...
 * The dispatch origin for this call must be `Signed` by the transactor.
 */
export interface OpenGovBalancesCall_transfer_allow_death {
    __kind: 'transfer_allow_death'
    dest: MultiAddress
    value: bigint
}
 ...
 * WARNING: This call is DEPRECATED! Use `force_set_balance` instead.
 */
export interface OpenGovBalancesCall_set_balance_deprecated {
    __kind: 'set_balance_deprecated'
    who: MultiAddress
    newFree: bigint
    oldReserved: bigint
 ...
 * possibililty of churn).
 */
export interface OpenGovBalancesCall_upgrade_accounts {
    __kind: 'upgrade_accounts'
    who: Uint8Array[]
}
 ...
 * The dispatch origin for this call is `root`.
 */
export interface OpenGovBalancesCall_force_set_balance {
    __kind: 'force_set_balance'
    who: MultiAddress
    newFree: bigint
}
...
export type OriginCaller = OriginCaller_system | OriginCaller_Council | OriginCaller_TechnicalCommittee | OriginCaller_ReleaseCommittee | OriginCaller_PolkadotXcm | OriginCaller_CumulusXcm | OriginCaller_Origins | OriginCaller_Void
...
export type Type_309 = Type_309_V2 | Type_309_V3

export interface Type_309_V2 {
    __kind: 'V2'
    value: Type_312[]
}

export interface Type_309_V3 {
    __kind: 'V3'
    value: Type_316[]
}
...
export type Type_346 = Type_346_Standard | Type_346_Split | Type_346_SplitAbstain

export interface Type_346_Standard {
    __kind: 'Standard'
    vote: number
    balance: bigint
}

export interface Type_346_Split {
    __kind: 'Split'
    aye: bigint
    nay: bigint
}

export interface Type_346_SplitAbstain {
    __kind: 'SplitAbstain'
    aye: bigint
    nay: bigint
    abstain: bigint
...
export type Type_290 = Type_290_WhitelistedCaller

export interface Type_290_WhitelistedCaller {
...
export interface Type_312_QueryHolding {
    __kind: 'QueryHolding'
    queryId: bigint
    dest: V2MultiLocation
    assets: V2MultiAssetFilter
...
export type Type_316 = Type_316_WithdrawAsset | Type_316_ReserveAssetDeposited | Type_316_ReceiveTeleportedAsset | Type_316_QueryResponse | Type_316_TransferAsset | Type_316_TransferReserveAsset | Type_316_Transact | Type_316_HrmpNewChannelOpenRequest | Type_316_HrmpChannelAccepted | Type_316_HrmpChannelClosing | Type_316_ClearOrigin | Type_316_DescendOrigin | Type_316_ReportError | Type_316_DepositAsset | Type_316_DepositReserveAsset | Type_316_ExchangeAsset | Type_316_InitiateReserveWithdraw | Type_316_InitiateTeleport | Type_316_ReportHolding | Type_316_BuyExecution | Type_316_RefundSurplus | Type_316_SetErrorHandler | Type_316_SetAppendix | Type_316_ClearError | Type_316_ClaimAsset | Type_316_Trap | Type_316_SubscribeVersion | Type_316_UnsubscribeVersion | Type_316_BurnAsset | Type_316_ExpectAsset | Type_316_ExpectOrigin | Type_316_ExpectError | Type_316_ExpectTransactStatus | Type_316_QueryPallet | Type_316_ExpectPallet | Type_316_ReportTransactStatus | Type_316_ClearTransactStatus | Type_316_UniversalOrigin | Type_316_ExportMessage | Type_316_LockAsset | Type_316_UnlockAsset | Type_316_NoteUnlockable | Type_316_RequestUnlock | Type_316_SetFeesMode | Type_316_SetTopic | Type_316_ClearTopic | Type_316_AliasOrigin | Type_316_UnpaidExecution
...
export type Type_371 = Type_371_Id | Type_371_Raw

export interface Type_371_Id {
    __kind: 'Id'
    value: Uint8Array
}

export interface Type_371_Raw {
    __kind: 'Raw'
    value: Uint8Array
}
