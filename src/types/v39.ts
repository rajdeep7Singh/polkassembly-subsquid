...
export type Call = Call_AdvisoryCommittee | Call_AdvisoryCommitteeMembership | Call_AssetManager | Call_AuthorFilter | Call_AuthorInherent | Call_AuthorMapping | Call_Authorized | Call_Balances | Call_Council | Call_CouncilMembership | Call_Court | Call_Crowdloan | Call_Democracy | Call_DmpQueue | Call_Identity | Call_LiquidityMining | Call_MultiSig | Call_ParachainStaking | Call_ParachainSystem | Call_PolkadotXcm | Call_PredictionMarkets | Call_Preimage | Call_Proxy | Call_Scheduler | Call_Styx | Call_Swaps | Call_System | Call_TechnicalCommittee | Call_TechnicalCommitteeMembership | Call_Timestamp | Call_Treasury | Call_Utility | Call_Vesting | Call_XcmpQueue
...
export const OriginCaller: sts.Type<OriginCaller> = sts.closedEnum(() => {
    return  {
        AdvisoryCommittee: Type_252,
        Council: Type_253,
        CumulusXcm: Origin,
        PolkadotXcm: Type_256,
