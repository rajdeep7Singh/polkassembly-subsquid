...
export type Call = Call_System | Call_Timestamp | Call_Sudo | Call_AssetTxPayment | Call_Indices | Call_Balances | Call_Identity | Call_Multisig | Call_ParachainSystem | Call_ParachainInfo | Call_Authorship | Call_CollatorSelection | Call_Session | Call_Council | Call_CouncilMembership | Call_Treasury | Call_Democracy | Call_TechnicalCollective | Call_TechnicalMembership | Call_Scheduler | Call_Utility | Call_Preimage | Call_XcmpQueue | Call_RelayerXcm | Call_CumulusXcm | Call_DmpQueue | Call_XTokens | Call_UnknownTokens | Call_Tokens | Call_CurrencyFactory | Call_GovernanceRegistry | Call_Assets | Call_CrowdloanRewards | Call_Vesting | Call_BondedFinance | Call_AssetsRegistry | Call_CallFilter
...
export interface Call_TechnicalCollective {
    __kind: 'TechnicalCollective'
    value: TechnicalCollectiveCall
}
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type TechnicalCollectiveCall = TechnicalCollectiveCall_set_members | TechnicalCollectiveCall_execute | TechnicalCollectiveCall_propose | TechnicalCollectiveCall_vote | TechnicalCollectiveCall_close | TechnicalCollectiveCall_disapprove_proposal
 ...
 * # </weight>
 */
export interface TechnicalCollectiveCall_set_members {
    __kind: 'set_members'
    newMembers: Uint8Array[]
    prime: (Uint8Array | undefined)
    oldCount: number
 ...
 * # </weight>
 */
export interface TechnicalCollectiveCall_execute {
    __kind: 'execute'
    proposal: Call
    lengthBound: number
}
 ...
 * # </weight>
 */
export interface TechnicalCollectiveCall_propose {
    __kind: 'propose'
    threshold: number
    proposal: Call
    lengthBound: number
 ...
 * # </weight>
 */
export interface TechnicalCollectiveCall_vote {
    __kind: 'vote'
    proposal: Uint8Array
    index: number
    approve: boolean
 ...
 * # </weight>
 */
export interface TechnicalCollectiveCall_close {
    __kind: 'close'
    proposalHash: Uint8Array
    index: number
    proposalWeightBound: bigint
 ...
 * # </weight>
 */
export interface TechnicalCollectiveCall_disapprove_proposal {
    __kind: 'disapprove_proposal'
    proposalHash: Uint8Array
}
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type CrowdloanRewardsCall = CrowdloanRewardsCall_initialize | CrowdloanRewardsCall_initialize_at | CrowdloanRewardsCall_populate | CrowdloanRewardsCall_associate | CrowdloanRewardsCall_claim | CrowdloanRewardsCall_unlock_rewards_for
...
export type OriginCaller = OriginCaller_system | OriginCaller_Council | OriginCaller_TechnicalCollective | OriginCaller_RelayerXcm | OriginCaller_CumulusXcm | OriginCaller_Void
...
export interface OriginCaller_TechnicalCollective {
    __kind: 'TechnicalCollective'
    value: Type_246
}
...
export type Type_248 = Type_248_Relay | Type_248_SiblingParachain

export interface Type_248_Relay {
    __kind: 'Relay'
}

export interface Type_248_SiblingParachain {
