...
export type Call = Call_System | Call_Utility | Call_Babe | Call_Timestamp | Call_Authorship | Call_Indices | Call_Balances | Call_ElectionProviderMultiPhase | Call_Staking | Call_Session | Call_Democracy | Call_Council | Call_TechnicalCommittee | Call_Elections | Call_TechnicalMembership | Call_Grandpa | Call_Treasury | Call_Contracts | Call_Sudo | Call_ImOnline | Call_Identity | Call_Society | Call_Recovery | Call_Vesting | Call_Scheduler | Call_Proxy | Call_Multisig | Call_Bounties | Call_Tips | Call_BagsList | Call_ChildBounties | Call_CereDDCModule | Call_ChainBridge | Call_Erc721 | Call_Erc20 | Call_DdcMetricsOffchainWorker
...
export interface StakingCall_set_staking_configs {
    ...
    maxNominatorCount: Type_206
    maxValidatorCount: Type_206
    chillThreshold: Type_207
    minCommission: Type_208
}
...
export type Type_284 = Type_284_Rebid | Type_284_Reject | Type_284_Approve

export interface Type_284_Rebid {
    __kind: 'Rebid'
}

export interface Type_284_Reject {
    __kind: 'Reject'
}

export interface Type_284_Approve {
    __kind: 'Approve'
}
