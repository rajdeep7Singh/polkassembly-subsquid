...
export type Type_171 = Type_171_Members | Type_171_Member | Type_171__Phantom

export interface Type_171_Members {
    __kind: 'Members'
    value: [number, number]
}

export interface Type_171_Member {
    __kind: 'Member'
    value: Uint8Array
}

export interface Type_171__Phantom {
    __kind: '_Phantom'
}
