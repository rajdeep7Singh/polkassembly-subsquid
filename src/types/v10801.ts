...
export type Call = Call_System | Call_Timestamp | Call_Indices | Call_Balances | Call_Session | Call_ParachainStaking | Call_Authorship | Call_Democracy | Call_Council | Call_TechnicalCommittee | Call_TechnicalMembership | Call_Treasury | Call_Utility | Call_Vesting | Call_Scheduler | Call_Proxy | Call_Preimage | Call_TipsMembership | Call_Tips | Call_Ctype | Call_Attestation | Call_Delegation | Call_Did | Call_DidLookup | Call_Web3Names | Call_ParachainSystem | Call_XcmpQueue | Call_PolkadotXcm | Call_DmpQueue
