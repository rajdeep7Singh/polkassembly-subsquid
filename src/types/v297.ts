...
export type Call = Call_System | Call_Utility | Call_Babe | Call_Timestamp | Call_Authorship | Call_Indices | Call_Balances | Call_ElectionProviderMultiPhase | Call_Staking | Call_Session | Call_Democracy | Call_Council | Call_TechnicalCommittee | Call_Elections | Call_TechnicalMembership | Call_Grandpa | Call_Treasury | Call_Contracts | Call_Sudo | Call_ImOnline | Call_Identity | Call_Society | Call_Recovery | Call_Vesting | Call_Scheduler | Call_Proxy | Call_Multisig | Call_Bounties | Call_Tips | Call_BagsList | Call_CereDDCModule | Call_ChainBridge | Call_Erc721 | Call_Erc20 | Call_DdcMetricsOffchainWorker
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type ContractsCall = ContractsCall_call | ContractsCall_instantiate_with_code | ContractsCall_instantiate
...
export type Type_277 = Type_277_Rebid | Type_277_Reject | Type_277_Approve

export interface Type_277_Rebid {
    __kind: 'Rebid'
}

export interface Type_277_Reject {
    __kind: 'Reject'
}

export interface Type_277_Approve {
    __kind: 'Approve'
}
