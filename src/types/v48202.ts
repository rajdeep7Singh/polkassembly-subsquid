...
export interface StakingCall_set_staking_configs {
    ...
    maxNominatorCount: Type_218
    maxValidatorCount: Type_218
    chillThreshold: Type_219
    minCommission: Type_220
}
...
export interface NominationPoolsCall_update_roles {
    ...
    poolId: number
    newRoot: Type_317
    newNominator: Type_317
    newStateToggler: Type_317
}
