...
export type Call = Call_Attestation | Call_AuraExt | Call_Authorship | Call_Balances | Call_Council | Call_Ctype | Call_Delegation | Call_Democracy | Call_Did | Call_DidLookup | Call_Indices | Call_ParachainStaking | Call_ParachainSystem | Call_Preimage | Call_Proxy | Call_Scheduler | Call_Session | Call_System | Call_TechnicalCommittee | Call_TechnicalMembership | Call_Timestamp | Call_Tips | Call_TipsMembership | Call_Treasury | Call_Utility | Call_Vesting | Call_Web3Names
...
export type Type_190 = Type_190_Member | Type_190_Members | Type_190__Phantom

export interface Type_190_Member {
    __kind: 'Member'
    value: AccountId32
}

export interface Type_190_Members {
    __kind: 'Members'
    value: [number, number]
}

export interface Type_190__Phantom {
    __kind: '_Phantom'
}
