...
export type Type_226 = Type_226_Relay | Type_226_SiblingParachain

export interface Type_226_Relay {
    __kind: 'Relay'
}

export interface Type_226_SiblingParachain {
...
export type Type_242 = Type_242_V0 | Type_242_V1 | Type_242_V2

export interface Type_242_V0 {
    __kind: 'V0'
    value: Type_243
}

export interface Type_242_V1 {
    __kind: 'V1'
    value: Type_248
}

export interface Type_242_V2 {
    __kind: 'V2'
    value: Type_254[]
}
...
export type Type_248 = Type_248_HrmpChannelAccepted | Type_248_HrmpChannelClosing | Type_248_HrmpNewChannelOpenRequest | Type_248_QueryResponse | Type_248_ReceiveTeleportedAsset | Type_248_RelayedFrom | Type_248_ReserveAssetDeposited | Type_248_SubscribeVersion | Type_248_Transact | Type_248_TransferAsset | Type_248_TransferReserveAsset | Type_248_UnsubscribeVersion | Type_248_WithdrawAsset
...
export interface Type_248_RelayedFrom {
    __kind: 'RelayedFrom'
    who: V1Junctions
    message: Type_248
}
...
export type Type_250 = Type_250_BuyExecution | Type_250_DepositAsset | Type_250_DepositReserveAsset | Type_250_ExchangeAsset | Type_250_InitiateReserveWithdraw | Type_250_InitiateTeleport | Type_250_Noop | Type_250_QueryHolding
...
export type Type_243 = Type_243_HrmpChannelAccepted | Type_243_HrmpChannelClosing | Type_243_HrmpNewChannelOpenRequest | Type_243_QueryResponse | Type_243_RelayedFrom | Type_243_ReserveAssetDeposit | Type_243_TeleportAsset | Type_243_Transact | Type_243_TransferAsset | Type_243_TransferReserveAsset | Type_243_WithdrawAsset
...
export interface Type_243_ReserveAssetDeposit {
    __kind: 'ReserveAssetDeposit'
    assets: V0MultiAsset[]
    effects: Type_245[]
}

export interface Type_243_TeleportAsset {
    __kind: 'TeleportAsset'
    assets: V0MultiAsset[]
    effects: Type_245[]
}
...
export type Type_245 = Type_245_BuyExecution | Type_245_DepositAsset | Type_245_DepositReserveAsset | Type_245_ExchangeAsset | Type_245_InitiateReserveWithdraw | Type_245_InitiateTeleport | Type_245_Null | Type_245_QueryHolding
...
export interface Type_245_Null {
    __kind: 'Null'
}
...
export const Type_250: sts.Type<Type_250> = sts.closedEnum(() => {
    return  {
        BuyExecution: sts.enumStruct({
            ...
            debt: sts.bigint(),
            haltOnError: sts.boolean(),
            instructions: sts.array(() => Type_248),
        }),
        DepositAsset: sts.enumStruct({
            assets: V1MultiAssetFilter,
            maxAssets: sts.number(),
