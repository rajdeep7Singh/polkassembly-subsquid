...
export type Type_350 = Type_350_V2 | Type_350_V3
...
export type Type_408 = Type_408_Id | Type_408_Raw

export interface Type_408_Id {
    __kind: 'Id'
    value: AccountId32
}

export interface Type_408_Raw {
    __kind: 'Raw'
    value: Bytes
}
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type GovernanceRegistryCall = GovernanceRegistryCall_grant_root | GovernanceRegistryCall_remove | GovernanceRegistryCall_set
...
export const Call: sts.Type<Call> = sts.closedEnum(() => {
    return  {
        ...
        GovernanceRegistry: GovernanceRegistryCall,
        Ibc: IbcCall,
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export const GovernanceRegistryCall: sts.Type<GovernanceRegistryCall> = sts.closedEnum(() => {
    return  {
        grant_root: sts.enumStruct({
            assetId: CurrencyId,
        }),
...
export const Type_367: sts.Type<Type_367> = sts.struct(() => {
    return  {
        inner: sts.bytes(),
    }
})
