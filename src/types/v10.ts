...
export type Call = Call_AssetRegistry | Call_Balances | Call_Bounties | Call_ChildBounties | Call_Contracts | Call_Council | Call_Currencies | Call_Democracy | Call_DiaOracleModule | Call_DmpQueue | Call_Farming | Call_Fee | Call_Identity | Call_Issue | Call_Multisig | Call_Nomination | Call_Oracle | Call_ParachainStaking | Call_ParachainSystem | Call_PolkadotXcm | Call_Preimage | Call_Redeem | Call_Replace | Call_Scheduler | Call_Security | Call_Session | Call_StellarRelay | Call_System | Call_TechnicalCommittee | Call_Timestamp | Call_Tokens | Call_Treasury | Call_Utility | Call_VaultRegistry | Call_VaultRewards | Call_Vesting | Call_VestingManager | Call_XTokens | Call_XcmpQueue | Call_ZenlinkProtocol
...
export interface Call_VaultRewards {
    __kind: 'VaultRewards'
    value: VaultRewardsCall
}
...
export type CurrencyId = CurrencyId_Native | CurrencyId_Stellar | CurrencyId_XCM | CurrencyId_ZenlinkLPToken
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type VaultRewardsCall = never
...
export type Type_273 = Type_273_V2 | Type_273_V3

export interface Type_273_V2 {
    __kind: 'V2'
    value: Type_276[]
}

export interface Type_273_V3 {
    __kind: 'V3'
    value: Type_280[]
}

export type Type_280 = Type_280_AliasOrigin | Type_280_BurnAsset | Type_280_BuyExecution | Type_280_ClaimAsset | Type_280_ClearError | Type_280_ClearOrigin | Type_280_ClearTopic | Type_280_ClearTransactStatus | Type_280_DepositAsset | Type_280_DepositReserveAsset | Type_280_DescendOrigin | Type_280_ExchangeAsset | Type_280_ExpectAsset | Type_280_ExpectError | Type_280_ExpectOrigin | Type_280_ExpectPallet | Type_280_ExpectTransactStatus | Type_280_ExportMessage | Type_280_HrmpChannelAccepted | Type_280_HrmpChannelClosing | Type_280_HrmpNewChannelOpenRequest | Type_280_InitiateReserveWithdraw | Type_280_InitiateTeleport | Type_280_LockAsset | Type_280_NoteUnlockable | Type_280_QueryPallet | Type_280_QueryResponse | Type_280_ReceiveTeleportedAsset | Type_280_RefundSurplus | Type_280_ReportError | Type_280_ReportHolding | Type_280_ReportTransactStatus | Type_280_RequestUnlock | Type_280_ReserveAssetDeposited | Type_280_SetAppendix | Type_280_SetErrorHandler | Type_280_SetFeesMode | Type_280_SetTopic | Type_280_SubscribeVersion | Type_280_Transact | Type_280_TransferAsset | Type_280_TransferReserveAsset | Type_280_Trap | Type_280_UniversalOrigin | Type_280_UnlockAsset | Type_280_UnpaidExecution | Type_280_UnsubscribeVersion | Type_280_WithdrawAsset

export interface Type_280_AliasOrigin {
    __kind: 'AliasOrigin'
    value: V3MultiLocation
}

export interface Type_280_BurnAsset {
    __kind: 'BurnAsset'
    value: V3MultiAsset[]
}
...
export interface Type_280_ClearTopic {
    __kind: 'ClearTopic'
}

export interface Type_280_ClearTransactStatus {
    __kind: 'ClearTransactStatus'
}
...
export interface Type_280_ExpectAsset {
    __kind: 'ExpectAsset'
    value: V3MultiAsset[]
}

export interface Type_280_ExpectError {
    __kind: 'ExpectError'
    value?: ([number, V3Error] | undefined)
}

export interface Type_280_ExpectOrigin {
    __kind: 'ExpectOrigin'
    value?: (V3MultiLocation | undefined)
}

export interface Type_280_ExpectPallet {
    __kind: 'ExpectPallet'
    index: number
    name: Bytes
    moduleName: Bytes
...
export interface Type_280_ExpectTransactStatus {
    __kind: 'ExpectTransactStatus'
    value: V3MaybeErrorCode
}

export interface Type_280_ExportMessage {
    __kind: 'ExportMessage'
    network: V3NetworkId
    destination: V3Junctions
    xcm: V3Instruction[]
...
export interface Type_280_LockAsset {
    __kind: 'LockAsset'
    asset: V3MultiAsset
    unlocker: V3MultiLocation
}

export interface Type_280_NoteUnlockable {
    __kind: 'NoteUnlockable'
    asset: V3MultiAsset
    owner: V3MultiLocation
}

export interface Type_280_QueryPallet {
    __kind: 'QueryPallet'
    moduleName: Bytes
    responseInfo: V3QueryResponseInfo
}
...
export interface Type_280_ReportHolding {
    __kind: 'ReportHolding'
    responseInfo: V3QueryResponseInfo
    assets: V3MultiAssetFilter
}

export interface Type_280_ReportTransactStatus {
    __kind: 'ReportTransactStatus'
    value: V3QueryResponseInfo
}

export interface Type_280_RequestUnlock {
    __kind: 'RequestUnlock'
    asset: V3MultiAsset
    locker: V3MultiLocation
}
...
export interface Type_280_SetFeesMode {
    __kind: 'SetFeesMode'
    jitWithdraw: boolean
}

export interface Type_280_SetTopic {
    __kind: 'SetTopic'
    value: Bytes
}
...
export interface Type_280_UniversalOrigin {
    __kind: 'UniversalOrigin'
    value: V3Junction
}

export interface Type_280_UnlockAsset {
    __kind: 'UnlockAsset'
    asset: V3MultiAsset
    target: V3MultiLocation
}

export interface Type_280_UnpaidExecution {
    __kind: 'UnpaidExecution'
    weightLimit: V3WeightLimit
    checkOrigin?: (V3MultiLocation | undefined)
}
...
export type Type_276 = Type_276_BuyExecution | Type_276_ClaimAsset | Type_276_ClearError | Type_276_ClearOrigin | Type_276_DepositAsset | Type_276_DepositReserveAsset | Type_276_DescendOrigin | Type_276_ExchangeAsset | Type_276_HrmpChannelAccepted | Type_276_HrmpChannelClosing | Type_276_HrmpNewChannelOpenRequest | Type_276_InitiateReserveWithdraw | Type_276_InitiateTeleport | Type_276_QueryHolding | Type_276_QueryResponse | Type_276_ReceiveTeleportedAsset | Type_276_RefundSurplus | Type_276_ReportError | Type_276_ReserveAssetDeposited | Type_276_SetAppendix | Type_276_SetErrorHandler | Type_276_SubscribeVersion | Type_276_Transact | Type_276_TransferAsset | Type_276_TransferReserveAsset | Type_276_Trap | Type_276_UnsubscribeVersion | Type_276_WithdrawAsset
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type FeeCall = FeeCall_set_issue_fee | FeeCall_set_issue_griefing_collateral | FeeCall_set_premium_redeem_fee | FeeCall_set_punishment_fee | FeeCall_set_redeem_fee | FeeCall_set_replace_griefing_collateral | FeeCall_withdraw_rewards
 ...
 * * `origin` - signing account
 */
export interface FeeCall_withdraw_rewards {
    __kind: 'withdraw_rewards'
    vaultId: VaultId
    index?: (number | undefined)
}
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export const VaultRewardsCall: sts.Type<VaultRewardsCall> = sts.closedEnum(() => {
    return  {
    }
})
...
export const Type_273: sts.Type<Type_273> = sts.closedEnum(() => {
    return  {
        V2: sts.array(() => Type_276),
        V3: sts.array(() => Type_280),
    }
})
...
export const Type_276: sts.Type<Type_276> = sts.closedEnum(() => {
    return  {
        ...
        ReserveAssetDeposited: sts.array(() => V2MultiAsset),
        SetAppendix: sts.array(() => Type_276),
        SetErrorHandler: sts.array(() => Type_276),
        SubscribeVersion: sts.enumStruct({
            queryId: sts.bigint(),
            maxResponseWeight: sts.bigint(),
        }),
...
export const FeeCall: sts.Type<FeeCall> = sts.closedEnum(() => {
    return  {
        ...
        withdraw_rewards: sts.enumStruct({
            vaultId: VaultId,
            index: sts.option(() => sts.number()),
        }),
    }
...
export const AssetRegistryCall: sts.Type<AssetRegistryCall> = sts.closedEnum(() => {
    return  {
        ...
        update_asset: sts.enumStruct({
            ...
            additional: sts.enumOption(() => sts.unit()),
        }),
    }
})
