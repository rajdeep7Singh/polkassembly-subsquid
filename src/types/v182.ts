 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type StreamingCall = StreamingCall_create_stream | StreamingCall_cancel_stream | StreamingCall_withdraw_from_stream
...
export type Type_299 = Type_299_Any | Type_299_NonTransfer | Type_299_Governance | Type_299_Staking

export interface Type_299_Any {
    __kind: 'Any'
}

export interface Type_299_NonTransfer {
    __kind: 'NonTransfer'
}

export interface Type_299_Governance {
    __kind: 'Governance'
}

export interface Type_299_Staking {
    __kind: 'Staking'
}
