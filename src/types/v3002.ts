...
export interface Type_145_TestUtils {
    __kind: 'TestUtils'
    value: TestUtilsCall
}
...
export interface Proposal_TestUtils {
    __kind: 'TestUtils'
    value: TestUtilsCall
}
