...
export type Call = Call_AdvisoryCommittee | Call_AdvisoryCommitteeMembership | Call_AssetManager | Call_AssetRegistry | Call_AuthorFilter | Call_AuthorInherent | Call_AuthorMapping | Call_Authorized | Call_Balances | Call_Bounties | Call_Contracts | Call_Council | Call_CouncilMembership | Call_Court | Call_Democracy | Call_DmpQueue | Call_GlobalDisputes | Call_Identity | Call_LiquidityMining | Call_Multisig | Call_ParachainStaking | Call_ParachainSystem | Call_PolkadotXcm | Call_PredictionMarkets | Call_Preimage | Call_Proxy | Call_Scheduler | Call_SimpleDisputes | Call_Styx | Call_Swaps | Call_System | Call_TechnicalCommittee | Call_TechnicalCommitteeMembership | Call_Timestamp | Call_Treasury | Call_Utility | Call_Vesting | Call_XTokens | Call_XcmpQueue
...
export type Type_289 = Type_289_Response | Type_289_Xcm

export interface Type_289_Response {
    __kind: 'Response'
    value: V3MultiLocation
}

export interface Type_289_Xcm {
    __kind: 'Xcm'
    value: V3MultiLocation
}
...
export const OriginCaller: sts.Type<OriginCaller> = sts.closedEnum(() => {
    return  {
        AdvisoryCommittee: Type_285,
        Council: Type_286,
        CumulusXcm: Origin,
        PolkadotXcm: Type_289,
