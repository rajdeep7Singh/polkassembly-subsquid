...
export type Type_157 = Type_157_Member | Type_157_Members | Type_157__Phantom

export interface Type_157_Member {
    __kind: 'Member'
    value: AccountId32
}

export interface Type_157_Members {
    __kind: 'Members'
    value: [number, number]
}

export interface Type_157__Phantom {
    __kind: '_Phantom'
}
...
export type SchemasCall = SchemasCall_create_schema | SchemasCall_create_schema_v2 | SchemasCall_create_schema_via_governance | SchemasCall_propose_to_create_schema | SchemasCall_set_max_schema_model_bytes
