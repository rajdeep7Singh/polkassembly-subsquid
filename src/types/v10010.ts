...
export type OriginCaller = OriginCaller_Council | OriginCaller_CumulusXcm | OriginCaller_RelayerXcm | OriginCaller_ReleaseCommittee | OriginCaller_TechnicalCommittee | OriginCaller_Void | OriginCaller_system
...
export type Type_316 = Type_316_HrmpChannelAccepted | Type_316_HrmpChannelClosing | Type_316_HrmpNewChannelOpenRequest | Type_316_QueryResponse | Type_316_ReceiveTeleportedAsset | Type_316_RelayedFrom | Type_316_ReserveAssetDeposited | Type_316_SubscribeVersion | Type_316_Transact | Type_316_TransferAsset | Type_316_TransferReserveAsset | Type_316_UnsubscribeVersion | Type_316_WithdrawAsset
...
export type Type_318 = Type_318_BuyExecution | Type_318_DepositAsset | Type_318_DepositReserveAsset | Type_318_ExchangeAsset | Type_318_InitiateReserveWithdraw | Type_318_InitiateTeleport | Type_318_Noop | Type_318_QueryHolding
...
export type Type_311 = Type_311_HrmpChannelAccepted | Type_311_HrmpChannelClosing | Type_311_HrmpNewChannelOpenRequest | Type_311_QueryResponse | Type_311_RelayedFrom | Type_311_ReserveAssetDeposit | Type_311_TeleportAsset | Type_311_Transact | Type_311_TransferAsset | Type_311_TransferReserveAsset | Type_311_WithdrawAsset
...
export type Type_313 = Type_313_BuyExecution | Type_313_DepositAsset | Type_313_DepositReserveAsset | Type_313_ExchangeAsset | Type_313_InitiateReserveWithdraw | Type_313_InitiateTeleport | Type_313_Null | Type_313_QueryHolding
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type IbcCall = IbcCall_deliver | IbcCall_freeze_client | IbcCall_set_params | IbcCall_transfer | IbcCall_upgrade_client
...
export interface IbcCall_set_params {
    __kind: 'set_params'
    params: PalletParams
}
...
export type Type_361 = Type_361_Id | Type_361_Raw

export interface Type_361_Id {
    __kind: 'Id'
    value: AccountId32
}

export interface Type_361_Raw {
    __kind: 'Raw'
    value: Bytes
}
...
export interface AssetsRegistryCall_register_asset {
    ...
    protocolId: Bytes
    nonce: bigint
    location?: (XcmAssetLocation | undefined)
    assetInfo: AssetInfo
}
...
export interface AssetInfoUpdate {
    ...
    symbol: Type_146
    decimals: Type_147
    existentialDeposit: Type_148
    ratio: Type_149
}

export type Type_149 = Type_149_Ignore | Type_149_Set

export interface Type_149_Ignore {
    __kind: 'Ignore'
}
...
export type Type_148 = Type_148_Ignore | Type_148_Set

export interface Type_148_Ignore {
    __kind: 'Ignore'
}
...
export type Type_147 = Type_147_Ignore | Type_147_Set

export interface Type_147_Ignore {
    __kind: 'Ignore'
}
...
export type Type_146 = Type_146_Ignore | Type_146_Set

export interface Type_146_Ignore {
    __kind: 'Ignore'
}

export interface Type_146_Set {
    __kind: 'Set'
    value?: (Type_140 | undefined)
}
...
export const OriginCaller: sts.Type<OriginCaller> = sts.closedEnum(() => {
    return  {
        ...
        CumulusXcm: Type_292,
        RelayerXcm: Origin,
        ReleaseCommittee: Type_290,
        TechnicalCommittee: Type_289,
        Void: Void,
        system: RawOrigin,
    }
})
...
export const Type_315: sts.Type<Type_315> = sts.struct(() => {
    return  {
        encoded: sts.bytes(),
    }
})
...
export const Type_318: sts.Type<Type_318> = sts.closedEnum(() => {
    return  {
        BuyExecution: sts.enumStruct({
            ...
            debt: sts.bigint(),
            haltOnError: sts.boolean(),
            instructions: sts.array(() => Type_316),
        }),
        DepositAsset: sts.enumStruct({
            assets: V1MultiAssetFilter,
            maxAssets: sts.number(),
...
export const PalletParams: sts.Type<PalletParams> = sts.struct(() => {
    return  {
...
export const AssetsRegistryCall: sts.Type<AssetsRegistryCall> = sts.closedEnum(() => {
    return  {
        register_asset: sts.enumStruct({
            ...
            nonce: sts.bigint(),
            location: sts.option(() => XcmAssetLocation),
            assetInfo: AssetInfo,
        }),
...
export const Type_146: sts.Type<Type_146> = sts.closedEnum(() => {
    return  {
        Ignore: sts.unit(),
        Set: sts.option(() => Type_140),
    }
})

export const Type_140: sts.Type<Type_140> = sts.struct(() => {
    return  {
        inner: sts.bytes(),
    }
})
