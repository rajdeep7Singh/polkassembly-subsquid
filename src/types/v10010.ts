...
export type Call = Call_System | Call_Timestamp | Call_Sudo | Call_AssetTxPayment | Call_Indices | Call_Balances | Call_Identity | Call_Multisig | Call_ParachainSystem | Call_ParachainInfo | Call_Authorship | Call_CollatorSelection | Call_Session | Call_Council | Call_CouncilMembership | Call_Treasury | Call_Democracy | Call_TechnicalCommittee | Call_TechnicalCommitteeMembership | Call_ReleaseCommittee | Call_ReleaseMembership | Call_Scheduler | Call_Utility | Call_Preimage | Call_Proxy | Call_XcmpQueue | Call_RelayerXcm | Call_CumulusXcm | Call_DmpQueue | Call_XTokens | Call_UnknownTokens | Call_Tokens | Call_CurrencyFactory | Call_GovernanceRegistry | Call_Assets | Call_CrowdloanRewards | Call_Vesting | Call_BondedFinance | Call_AssetsRegistry | Call_Pablo | Call_CallFilter | Call_Ibc
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type IbcCall = IbcCall_deliver | IbcCall_transfer | IbcCall_set_params | IbcCall_upgrade_client | IbcCall_freeze_client
