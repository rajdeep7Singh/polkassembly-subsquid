...
export type Call = Call_System | Call_Timestamp | Call_Indices | Call_Balances | Call_Authorship | Call_ParachainStaking | Call_Session | Call_Democracy | Call_Council | Call_TechnicalCommittee | Call_TechnicalMembership | Call_Treasury | Call_Utility | Call_Vesting | Call_Scheduler | Call_KiltLaunch | Call_Ctype | Call_Attestation | Call_Delegation | Call_Did | Call_CrowdloanContributors | Call_DidLookup | Call_ParachainSystem
