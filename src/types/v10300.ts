...
export type Call = Call_Attestation | Call_Authorship | Call_Balances | Call_Council | Call_CrowdloanContributors | Call_Ctype | Call_Delegation | Call_Democracy | Call_Did | Call_DidLookup | Call_Indices | Call_KiltLaunch | Call_ParachainStaking | Call_ParachainSystem | Call_Scheduler | Call_Session | Call_System | Call_TechnicalCommittee | Call_TechnicalMembership | Call_Timestamp | Call_Treasury | Call_Utility | Call_Vesting
