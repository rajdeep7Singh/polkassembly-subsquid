...
export type Call = Call_System | Call_Timestamp | Call_Utility | Call_Multisig | Call_Balances | Call_Assets | Call_Proxy | Call_Identity | Call_Sudo | Call_Democracy | Call_GeneralCouncil | Call_TechnicalCommittee | Call_Treasury | Call_Scheduler | Call_Preimage | Call_XcmpQueue | Call_DmpQueue | Call_PolkadotXcm | Call_CumulusXcm | Call_Authorship | Call_CollatorSelection | Call_Session | Call_Oracle | Call_XTokens | Call_OrmlXcm | Call_Vesting | Call_Loans | Call_Prices | Call_Crowdloans | Call_LiquidStaking | Call_GeneralCouncilMembership | Call_TechnicalCommitteeMembership | Call_OracleMembership | Call_LiquidStakingAgentsMembership | Call_BridgeMembership | Call_CrowdloansAutomatorsMembership | Call_AMM | Call_AMMRoute | Call_CurrencyAdapter | Call_Bridge | Call_EmergencyShutdown | Call_Farming | Call_XcmHelper | Call_ParachainSystem
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type LiquidStakingCall = LiquidStakingCall_stake | LiquidStakingCall_unstake | LiquidStakingCall_update_reserve_factor | LiquidStakingCall_update_market_cap | LiquidStakingCall_bond | LiquidStakingCall_bond_extra | LiquidStakingCall_unbond | LiquidStakingCall_rebond | LiquidStakingCall_withdraw_unbonded | LiquidStakingCall_nominate | LiquidStakingCall_notification_received | LiquidStakingCall_claim_for | LiquidStakingCall_force_set_era_start_block | LiquidStakingCall_force_set_current_era | LiquidStakingCall_force_advance_era | LiquidStakingCall_force_set_staking_ledger | LiquidStakingCall_set_current_era | LiquidStakingCall_set_staking_ledger
...
export type ProxyType = ProxyType_Any | ProxyType_Loans | ProxyType_Staking | ProxyType_Crowdloans | ProxyType_Farming
...
export type XcmCall = XcmCall_Bond | XcmCall_BondExtra | XcmCall_Unbond | XcmCall_Rebond | XcmCall_WithdrawUnbonded | XcmCall_Nominate | XcmCall_Contribute | XcmCall_Withdraw | XcmCall_AddMemo | XcmCall_TransferToSiblingchain
...
export type Type_243 = Type_243_WithdrawAsset | Type_243_ReserveAssetDeposit | Type_243_TeleportAsset | Type_243_QueryResponse | Type_243_TransferAsset | Type_243_TransferReserveAsset | Type_243_Transact | Type_243_HrmpNewChannelOpenRequest | Type_243_HrmpChannelAccepted | Type_243_HrmpChannelClosing | Type_243_RelayedFrom
...
export type Type_245 = Type_245_Null | Type_245_DepositAsset | Type_245_DepositReserveAsset | Type_245_ExchangeAsset | Type_245_InitiateReserveWithdraw | Type_245_InitiateTeleport | Type_245_QueryHolding | Type_245_BuyExecution
...
export type Type_250 = Type_250_Noop | Type_250_DepositAsset | Type_250_DepositReserveAsset | Type_250_ExchangeAsset | Type_250_InitiateReserveWithdraw | Type_250_InitiateTeleport | Type_250_QueryHolding | Type_250_BuyExecution
