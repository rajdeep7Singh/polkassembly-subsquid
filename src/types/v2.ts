...
export type Call = Call_System | Call_Timestamp | Call_Identity | Call_Sudo | Call_Indices | Call_ParachainSystem | Call_Balances | Call_Assets | Call_Vesting | Call_SimpleInflation | Call_FeesSplit | Call_Airdrop | Call_Contracts | Call_Ethereum | Call_EVM | Call_BaseFee | Call_DynamicFee | Call_Authorship | Call_CollatorSelection | Call_Session | Call_Treasury | Call_Bounties | Call_Tips | Call_Preimage | Call_Utility | Call_Scheduler | Call_Proxy | Call_Multisig | Call_Democracy | Call_Council | Call_TechnicalCommittee | Call_PhragmenElection | Call_CouncilMembership | Call_TechnicalMembership | Call_XcmpQueue | Call_PolkadotXcm | Call_DmpQueue
...
export interface Call_SimpleInflation {
    __kind: 'SimpleInflation'
    value: SimpleInflationCall
}

export interface Call_FeesSplit {
    __kind: 'FeesSplit'
    value: FeesSplitCall
}
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type SimpleInflationCall = SimpleInflationCall_set_issuing_amount

export interface SimpleInflationCall_set_issuing_amount {
    __kind: 'set_issuing_amount'
    new: bigint
}
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type FeesSplitCall = FeesSplitCall_set_treasury_cut_percent

export interface FeesSplitCall_set_treasury_cut_percent {
    __kind: 'set_treasury_cut_percent'
    val: number
}
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type AirdropCall = AirdropCall_dispatch_user_claim | AirdropCall_dispatch_exchange_claim | AirdropCall_set_airdrop_server_account | AirdropCall_change_merkle_root | AirdropCall_update_airdrop_state

/**
 * Dispatchable to be called by server with privileged account
 * dispatch claim
 */
export interface AirdropCall_dispatch_user_claim {
    __kind: 'dispatch_user_claim'
    iconAddress: Uint8Array
    iceAddress: Uint8Array
    message: Uint8Array
    iconSignature: Uint8Array
    iceSignature: Uint8Array
    totalAmount: bigint
    defiUser: boolean
    proofs: Uint8Array[]
}

export interface AirdropCall_dispatch_exchange_claim {
    __kind: 'dispatch_exchange_claim'
    iconAddress: Uint8Array
    iceAddress: Uint8Array
    totalAmount: bigint
    defiUser: boolean
...
export interface AirdropCall_set_airdrop_server_account {
    __kind: 'set_airdrop_server_account'
    newAccount: Uint8Array
}

export interface AirdropCall_change_merkle_root {
    __kind: 'change_merkle_root'
    newRoot: Uint8Array
}

export interface AirdropCall_update_airdrop_state {
    __kind: 'update_airdrop_state'
    newState: AirdropState
}
...
export interface AirdropState {
    blockClaimRequest: boolean
    blockExchangeRequest: boolean
}
...
export type OriginCaller = OriginCaller_system | OriginCaller_Ethereum | OriginCaller_Council | OriginCaller_TechnicalCommittee | OriginCaller_PolkadotXcm | OriginCaller_CumulusXcm | OriginCaller_Void
...
export type Type_311 = Type_311_V0 | Type_311_V1 | Type_311_V2

export interface Type_311_V0 {
    __kind: 'V0'
    value: Type_312
}

export interface Type_311_V1 {
    __kind: 'V1'
    value: Type_317
}

export interface Type_311_V2 {
    __kind: 'V2'
    value: Type_323[]
}
...
export type Type_275 = Type_275_EthereumTransaction

export interface Type_275_EthereumTransaction {
...
export type Type_277 = Type_277_Members | Type_277_Member | Type_277__Phantom
...
export type Type_279 = Type_279_Relay | Type_279_SiblingParachain

export interface Type_279_Relay {
    __kind: 'Relay'
}

export interface Type_279_SiblingParachain {
...
export type Type_312 = Type_312_WithdrawAsset | Type_312_ReserveAssetDeposit | Type_312_TeleportAsset | Type_312_QueryResponse | Type_312_TransferAsset | Type_312_TransferReserveAsset | Type_312_Transact | Type_312_HrmpNewChannelOpenRequest | Type_312_HrmpChannelAccepted | Type_312_HrmpChannelClosing | Type_312_RelayedFrom
...
export interface Type_312_ReserveAssetDeposit {
    __kind: 'ReserveAssetDeposit'
    assets: V0MultiAsset[]
    effects: Type_314[]
}

export interface Type_312_TeleportAsset {
    __kind: 'TeleportAsset'
    assets: V0MultiAsset[]
    effects: Type_314[]
}
...
export interface Type_312_RelayedFrom {
    __kind: 'RelayedFrom'
    who: V0MultiLocation
    message: Type_312
}

export type Type_317 = Type_317_WithdrawAsset | Type_317_ReserveAssetDeposited | Type_317_ReceiveTeleportedAsset | Type_317_QueryResponse | Type_317_TransferAsset | Type_317_TransferReserveAsset | Type_317_Transact | Type_317_HrmpNewChannelOpenRequest | Type_317_HrmpChannelAccepted | Type_317_HrmpChannelClosing | Type_317_RelayedFrom | Type_317_SubscribeVersion | Type_317_UnsubscribeVersion
...
export type Type_323 = Type_323_WithdrawAsset | Type_323_ReserveAssetDeposited | Type_323_ReceiveTeleportedAsset | Type_323_QueryResponse | Type_323_TransferAsset | Type_323_TransferReserveAsset | Type_323_Transact | Type_323_HrmpNewChannelOpenRequest | Type_323_HrmpChannelAccepted | Type_323_HrmpChannelClosing | Type_323_ClearOrigin | Type_323_DescendOrigin | Type_323_ReportError | Type_323_DepositAsset | Type_323_DepositReserveAsset | Type_323_ExchangeAsset | Type_323_InitiateReserveWithdraw | Type_323_InitiateTeleport | Type_323_QueryHolding | Type_323_BuyExecution | Type_323_RefundSurplus | Type_323_SetErrorHandler | Type_323_SetAppendix | Type_323_ClearError | Type_323_ClaimAsset | Type_323_Trap | Type_323_SubscribeVersion | Type_323_UnsubscribeVersion
...
export type Type_314 = Type_314_Null | Type_314_DepositAsset | Type_314_DepositReserveAsset | Type_314_ExchangeAsset | Type_314_InitiateReserveWithdraw | Type_314_InitiateTeleport | Type_314_QueryHolding | Type_314_BuyExecution

export interface Type_314_Null {
    __kind: 'Null'
}
...
export type Type_319 = Type_319_Noop | Type_319_DepositAsset | Type_319_DepositReserveAsset | Type_319_ExchangeAsset | Type_319_InitiateReserveWithdraw | Type_319_InitiateTeleport | Type_319_QueryHolding | Type_319_BuyExecution
