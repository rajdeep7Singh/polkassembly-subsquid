...
export type Call = Call_AssetTxPayment | Call_AssetsRegistry | Call_AssetsTransactorRouter | Call_Balances | Call_BondedFinance | Call_CallFilter | Call_CollatorSelection | Call_Cosmwasm | Call_Council | Call_CouncilMembership | Call_CrowdloanRewards | Call_CumulusXcm | Call_CurrencyFactory | Call_Democracy | Call_DmpQueue | Call_Farming | Call_FarmingRewards | Call_Ibc | Call_Ics20Fee | Call_Identity | Call_Indices | Call_Multisig | Call_Oracle | Call_Pablo | Call_PalletMultihopXcmIbc | Call_ParachainInfo | Call_ParachainSystem | Call_PolkadotXcm | Call_Preimage | Call_Proxy | Call_ReleaseCommittee | Call_ReleaseMembership | Call_Scheduler | Call_Session | Call_Sudo | Call_System | Call_TechnicalCommittee | Call_TechnicalCommitteeMembership | Call_Timestamp | Call_Tokens | Call_Treasury | Call_UnknownTokens | Call_Utility | Call_Vesting | Call_XTokens | Call_XcmpQueue
...
export type OriginCaller = OriginCaller_Council | OriginCaller_CumulusXcm | OriginCaller_PolkadotXcm | OriginCaller_ReleaseCommittee | OriginCaller_TechnicalCommittee | OriginCaller_Void | OriginCaller_system
...
export type Type_330 = Type_330_Relay | Type_330_SiblingParachain

export interface Type_330_Relay {
    __kind: 'Relay'
}

export interface Type_330_SiblingParachain {
...
export type Type_352 = Type_352_BuyExecution | Type_352_ClaimAsset | Type_352_ClearError | Type_352_ClearOrigin | Type_352_DepositAsset | Type_352_DepositReserveAsset | Type_352_DescendOrigin | Type_352_ExchangeAsset | Type_352_HrmpChannelAccepted | Type_352_HrmpChannelClosing | Type_352_HrmpNewChannelOpenRequest | Type_352_InitiateReserveWithdraw | Type_352_InitiateTeleport | Type_352_QueryHolding | Type_352_QueryResponse | Type_352_ReceiveTeleportedAsset | Type_352_RefundSurplus | Type_352_ReportError | Type_352_ReserveAssetDeposited | Type_352_SetAppendix | Type_352_SetErrorHandler | Type_352_SubscribeVersion | Type_352_Transact | Type_352_TransferAsset | Type_352_TransferReserveAsset | Type_352_Trap | Type_352_UnsubscribeVersion | Type_352_WithdrawAsset
...
export interface Type_352_ClaimAsset {
    __kind: 'ClaimAsset'
    assets: V2MultiAsset[]
    ticket: V2MultiLocation
}

export interface Type_352_ClearError {
    __kind: 'ClearError'
}

export interface Type_352_ClearOrigin {
    __kind: 'ClearOrigin'
}
...
export interface Type_352_DescendOrigin {
    __kind: 'DescendOrigin'
    value: V2Junctions
}
...
export interface Type_352_HrmpChannelAccepted {
    __kind: 'HrmpChannelAccepted'
    recipient: number
}

export interface Type_352_HrmpChannelClosing {
    __kind: 'HrmpChannelClosing'
    initiator: number
    sender: number
    recipient: number
...
export interface Type_352_HrmpNewChannelOpenRequest {
    __kind: 'HrmpNewChannelOpenRequest'
    sender: number
    maxMessageSize: number
    maxCapacity: number
...
export interface Type_352_QueryResponse {
    __kind: 'QueryResponse'
    queryId: bigint
    response: V2Response
    maxWeight: bigint
...
export interface Type_352_ReceiveTeleportedAsset {
    __kind: 'ReceiveTeleportedAsset'
    value: V2MultiAsset[]
}

export interface Type_352_RefundSurplus {
    __kind: 'RefundSurplus'
}

export interface Type_352_ReportError {
    __kind: 'ReportError'
    queryId: bigint
    dest: V2MultiLocation
    maxResponseWeight: bigint
...
export interface Type_352_ReserveAssetDeposited {
    __kind: 'ReserveAssetDeposited'
    value: V2MultiAsset[]
}

export interface Type_352_SetAppendix {
    __kind: 'SetAppendix'
    value: Type_352[]
}

export interface Type_352_SetErrorHandler {
    __kind: 'SetErrorHandler'
    value: Type_352[]
}

export interface Type_352_SubscribeVersion {
    __kind: 'SubscribeVersion'
    queryId: bigint
    maxResponseWeight: bigint
}

export interface Type_352_Transact {
    __kind: 'Transact'
    originType: V2OriginKind
    requireWeightAtMost: bigint
    call: Type_353
...
export interface Type_352_TransferAsset {
    __kind: 'TransferAsset'
    assets: V2MultiAsset[]
    beneficiary: V2MultiLocation
}

export interface Type_352_TransferReserveAsset {
    __kind: 'TransferReserveAsset'
    assets: V2MultiAsset[]
    dest: V2MultiLocation
    xcm: V2Instruction[]
...
export interface Type_352_Trap {
    __kind: 'Trap'
    value: bigint
}

export interface Type_352_UnsubscribeVersion {
    __kind: 'UnsubscribeVersion'
}

export interface Type_352_WithdrawAsset {
    __kind: 'WithdrawAsset'
    value: V2MultiAsset[]
}
...
export type Type_406 = Type_406_Id | Type_406_Raw

export interface Type_406_Id {
    __kind: 'Id'
    value: AccountId32
}

export interface Type_406_Raw {
    __kind: 'Raw'
    value: Bytes
}
...
export const Type_349: sts.Type<Type_349> = sts.closedEnum(() => {
    return  {
        V2: sts.array(() => Type_352),
        V3: sts.array(() => Type_356),
    }
})
...
export const Type_352: sts.Type<Type_352> = sts.closedEnum(() => {
    return  {
        ...
        ReserveAssetDeposited: sts.array(() => V2MultiAsset),
        SetAppendix: sts.array(() => Type_352),
        SetErrorHandler: sts.array(() => Type_352),
        SubscribeVersion: sts.enumStruct({
            queryId: sts.bigint(),
            maxResponseWeight: sts.bigint(),
        }),
