...
export interface StakingCall_set_staking_configs {
    ...
    maxNominatorCount: Type_221
    maxValidatorCount: Type_221
    chillThreshold: Type_222
    minCommission: Type_223
}
...
export type Type_221 = Type_221_Noop | Type_221_Remove | Type_221_Set
...
export type Type_305 = Type_305_Approve | Type_305_Rebid | Type_305_Reject

export interface Type_305_Approve {
    __kind: 'Approve'
}

export interface Type_305_Rebid {
    __kind: 'Rebid'
}

export interface Type_305_Reject {
    __kind: 'Reject'
}
...
export interface NominationPoolsCall_set_configs {
    __kind: 'set_configs'
    minJoinBond: Type_322
    minCreateBond: Type_322
    maxPools: Type_323
    maxMembers: Type_323
    maxMembersPerPool: Type_323
    globalMaxCommission: Type_324
}
...
export type Type_325 = Type_325_Noop | Type_325_Remove | Type_325_Set

export interface Type_325_Noop {
    __kind: 'Noop'
}

export interface Type_325_Remove {
    __kind: 'Remove'
}

export interface Type_325_Set {
    __kind: 'Set'
    value: AccountId32
}
...
export type Type_324 = Type_324_Noop | Type_324_Remove | Type_324_Set

export interface Type_324_Noop {
    __kind: 'Noop'
}

export interface Type_324_Remove {
    __kind: 'Remove'
}

export interface Type_324_Set {
    __kind: 'Set'
    value: Perbill
}

export type Type_323 = Type_323_Noop | Type_323_Remove | Type_323_Set

export interface Type_323_Noop {
    __kind: 'Noop'
}

export interface Type_323_Remove {
    __kind: 'Remove'
}

export interface Type_323_Set {
    __kind: 'Set'
    value: number
}

export type Type_322 = Type_322_Noop | Type_322_Remove | Type_322_Set

export interface Type_322_Noop {
    __kind: 'Noop'
}

export interface Type_322_Remove {
    __kind: 'Remove'
}

export interface Type_322_Set {
    __kind: 'Set'
    value: bigint
}
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type DdcCustomersCall = DdcCustomersCall_create_bucket | DdcCustomersCall_deposit | DdcCustomersCall_deposit_extra | DdcCustomersCall_set_bucket_params | DdcCustomersCall_unlock_deposit | DdcCustomersCall_withdraw_unlocked_deposit
