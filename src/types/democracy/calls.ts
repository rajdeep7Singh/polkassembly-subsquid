...
export const delegate =  {
    ...
    v25: new CallType(
        ...
        sts.struct({
            to: v25.AccountId,
            conviction: v25.Conviction,
            balance: v25.BalanceOf,
        })
    ),
    /**
     * Delegate the voting power (with some given conviction) of the sending account.
    ...
    v10750: new CallType(
        'Democracy.delegate',
        sts.struct({
            to: v10750.MultiAddress,
            conviction: v10750.Conviction,
            balance: sts.bigint(),
        })
    ),
}
