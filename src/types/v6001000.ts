...
export type Type_527 = Type_527_Endorsed

export interface Type_527_Endorsed {
    __kind: 'Endorsed'
}

export type Type_526 = Type_526_Endorsed

export interface Type_526_Endorsed {
    __kind: 'Endorsed'
}
...
export const OriginCaller: sts.Type<OriginCaller> = sts.closedEnum(() => {
    return  {
        PolymeshCommittee: Type_526,
        TechnicalCommittee: Type_527,
        UpgradeCommittee: Type_528,
        Void: Void,
        system: RawOrigin,
    }
})
...
export const Type_526: sts.Type<Type_526> = sts.closedEnum(() => {
    return  {
        Endorsed: sts.unit(),
    }
})
