...
export type Call = Call_AdvisoryCommittee | Call_AdvisoryCommitteeMembership | Call_AssetManager | Call_AssetRegistry | Call_AuthorFilter | Call_AuthorInherent | Call_AuthorMapping | Call_Authorized | Call_Balances | Call_Bounties | Call_Council | Call_CouncilMembership | Call_Court | Call_Crowdloan | Call_Democracy | Call_DmpQueue | Call_Identity | Call_LiquidityMining | Call_MultiSig | Call_ParachainStaking | Call_ParachainSystem | Call_PolkadotXcm | Call_PredictionMarkets | Call_Preimage | Call_Proxy | Call_Scheduler | Call_Styx | Call_Swaps | Call_System | Call_TechnicalCommittee | Call_TechnicalCommitteeMembership | Call_Timestamp | Call_Treasury | Call_Utility | Call_Vesting | Call_XTokens | Call_XcmpQueue
...
export type Type_276 = Type_276_Response | Type_276_Xcm

export interface Type_276_Response {
    __kind: 'Response'
    value: V1MultiLocation
}

export interface Type_276_Xcm {
    __kind: 'Xcm'
    value: V1MultiLocation
}
...
export type Type_272 = Type_272_Member | Type_272_Members | Type_272__Phantom
...
export type Type_328 = Type_328_HrmpChannelAccepted | Type_328_HrmpChannelClosing | Type_328_HrmpNewChannelOpenRequest | Type_328_QueryResponse | Type_328_ReceiveTeleportedAsset | Type_328_RelayedFrom | Type_328_ReserveAssetDeposited | Type_328_SubscribeVersion | Type_328_Transact | Type_328_TransferAsset | Type_328_TransferReserveAsset | Type_328_UnsubscribeVersion | Type_328_WithdrawAsset
...
export type Type_330 = Type_330_BuyExecution | Type_330_DepositAsset | Type_330_DepositReserveAsset | Type_330_ExchangeAsset | Type_330_InitiateReserveWithdraw | Type_330_InitiateTeleport | Type_330_Noop | Type_330_QueryHolding
...
export type Type_323 = Type_323_HrmpChannelAccepted | Type_323_HrmpChannelClosing | Type_323_HrmpNewChannelOpenRequest | Type_323_QueryResponse | Type_323_RelayedFrom | Type_323_ReserveAssetDeposit | Type_323_TeleportAsset | Type_323_Transact | Type_323_TransferAsset | Type_323_TransferReserveAsset | Type_323_WithdrawAsset
...
export type Type_325 = Type_325_BuyExecution | Type_325_DepositAsset | Type_325_DepositReserveAsset | Type_325_ExchangeAsset | Type_325_InitiateReserveWithdraw | Type_325_InitiateTeleport | Type_325_Null | Type_325_QueryHolding
...
export const OriginCaller: sts.Type<OriginCaller> = sts.closedEnum(() => {
    return  {
        AdvisoryCommittee: Type_272,
        Council: Type_273,
        CumulusXcm: Origin,
        PolkadotXcm: Type_276,
        TechnicalCommittee: Type_274,
        Void: Void,
        system: RawOrigin,
    }
})
...
export const Type_330: sts.Type<Type_330> = sts.closedEnum(() => {
    return  {
        BuyExecution: sts.enumStruct({
            ...
            debt: sts.bigint(),
            haltOnError: sts.boolean(),
            instructions: sts.array(() => Type_328),
        }),
        DepositAsset: sts.enumStruct({
            assets: V1MultiAssetFilter,
            maxAssets: sts.number(),
