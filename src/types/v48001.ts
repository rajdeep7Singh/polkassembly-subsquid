...
export type Type_290 = Type_290_Approve | Type_290_Rebid | Type_290_Reject

export interface Type_290_Approve {
    __kind: 'Approve'
}

export interface Type_290_Rebid {
    __kind: 'Rebid'
}

export interface Type_290_Reject {
    __kind: 'Reject'
}
...
export interface NominationPoolsCall_update_roles {
    ...
    poolId: number
    newRoot: Type_310
    newNominator: Type_310
    newStateToggler: Type_310
}
