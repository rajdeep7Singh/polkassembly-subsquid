...
export type Call = Call_Attestation | Call_Authorship | Call_Balances | Call_Council | Call_CrowdloanContributors | Call_Ctype | Call_Delegation | Call_Democracy | Call_Did | Call_Indices | Call_KiltLaunch | Call_ParachainStaking | Call_ParachainSystem | Call_Scheduler | Call_Session | Call_System | Call_TechnicalCommittee | Call_TechnicalMembership | Call_Timestamp | Call_Treasury | Call_Utility | Call_Vesting
...
export interface Call_CrowdloanContributors {
    __kind: 'CrowdloanContributors'
    value: CrowdloanContributorsCall
}
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type DelegationCall = DelegationCall_add_delegation | DelegationCall_create_hierarchy | DelegationCall_remove_delegation | DelegationCall_revoke_delegation
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type CrowdloanContributorsCall = CrowdloanContributorsCall_receive_gratitude | CrowdloanContributorsCall_remove_contribution | CrowdloanContributorsCall_set_config | CrowdloanContributorsCall_set_contribution | CrowdloanContributorsCall_set_registrar_account | CrowdloanContributorsCall_set_reserve_accounts
 ...
 */
export interface CrowdloanContributorsCall_receive_gratitude {
    __kind: 'receive_gratitude'
 ...
 */
export interface CrowdloanContributorsCall_remove_contribution {
    __kind: 'remove_contribution'
 ...
 */
export interface CrowdloanContributorsCall_set_config {
    __kind: 'set_config'
    newConfig: GratitudeConfig
}
 ...
 * - Writes: Contributions
 */
export interface CrowdloanContributorsCall_set_contribution {
    __kind: 'set_contribution'
    contributor: AccountId32
    amount: bigint
}
 ...
 */
export interface CrowdloanContributorsCall_set_registrar_account {
    __kind: 'set_registrar_account'
    newAccount: MultiAddress
}
 ...
 * - Writes: Reserve
 */
export interface CrowdloanContributorsCall_set_reserve_accounts {
    __kind: 'set_reserve_accounts'
    newVestedReserve: MultiAddress
    newFreeReserve: MultiAddress
}

export interface GratitudeConfig {
    vestedShare: Permill
    startBlock: bigint
...
export const Call: sts.Type<Call> = sts.closedEnum(() => {
    return  {
        ...
        Council: CouncilCall,
        CrowdloanContributors: CrowdloanContributorsCall,
        Ctype: CtypeCall,
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export const CrowdloanContributorsCall: sts.Type<CrowdloanContributorsCall> = sts.closedEnum(() => {
    return  {
        receive_gratitude: sts.enumStruct({
            receiver: AccountId32,
        }),
        remove_contribution: sts.enumStruct({
            contributor: AccountId32,
        }),
        set_config: sts.enumStruct({
            newConfig: GratitudeConfig,
        }),
        set_contribution: sts.enumStruct({
            contributor: AccountId32,
            amount: sts.bigint(),
        }),
        set_registrar_account: sts.enumStruct({
            newAccount: MultiAddress,
        }),
        set_reserve_accounts: sts.enumStruct({
            newVestedReserve: MultiAddress,
            newFreeReserve: MultiAddress,
        }),
    }
...
export const GratitudeConfig: sts.Type<GratitudeConfig> = sts.struct(() => {
    return  {
        vestedShare: Permill,
        startBlock: sts.bigint(),
        vestingLength: sts.bigint(),
    }
})
