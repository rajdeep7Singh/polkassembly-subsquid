 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type VaultRegistryCall = VaultRegistryCall_accept_new_issues | VaultRegistryCall_deposit_collateral | VaultRegistryCall_recover_vault_id | VaultRegistryCall_register_public_key | VaultRegistryCall_register_vault | VaultRegistryCall_report_undercollateralized_vault | VaultRegistryCall_set_custom_secure_threshold | VaultRegistryCall_set_liquidation_collateral_threshold | VaultRegistryCall_set_minimum_collateral | VaultRegistryCall_set_premium_redeem_threshold | VaultRegistryCall_set_secure_collateral_threshold | VaultRegistryCall_set_system_collateral_ceiling | VaultRegistryCall_withdraw_collateral
...
export type Type_254 = Type_254_HrmpChannelAccepted | Type_254_HrmpChannelClosing | Type_254_HrmpNewChannelOpenRequest | Type_254_QueryResponse | Type_254_ReceiveTeleportedAsset | Type_254_RelayedFrom | Type_254_ReserveAssetDeposited | Type_254_SubscribeVersion | Type_254_Transact | Type_254_TransferAsset | Type_254_TransferReserveAsset | Type_254_UnsubscribeVersion | Type_254_WithdrawAsset
...
export type Type_256 = Type_256_BuyExecution | Type_256_DepositAsset | Type_256_DepositReserveAsset | Type_256_ExchangeAsset | Type_256_InitiateReserveWithdraw | Type_256_InitiateTeleport | Type_256_Noop | Type_256_QueryHolding
...
export type Type_249 = Type_249_HrmpChannelAccepted | Type_249_HrmpChannelClosing | Type_249_HrmpNewChannelOpenRequest | Type_249_QueryResponse | Type_249_RelayedFrom | Type_249_ReserveAssetDeposit | Type_249_TeleportAsset | Type_249_Transact | Type_249_TransferAsset | Type_249_TransferReserveAsset | Type_249_WithdrawAsset
...
export type Type_251 = Type_251_BuyExecution | Type_251_DepositAsset | Type_251_DepositReserveAsset | Type_251_ExchangeAsset | Type_251_InitiateReserveWithdraw | Type_251_InitiateTeleport | Type_251_Null | Type_251_QueryHolding
...
export const Type_256: sts.Type<Type_256> = sts.closedEnum(() => {
    return  {
        BuyExecution: sts.enumStruct({
            ...
            debt: sts.bigint(),
            haltOnError: sts.boolean(),
            instructions: sts.array(() => Type_254),
        }),
        DepositAsset: sts.enumStruct({
            assets: V1MultiAssetFilter,
            maxAssets: sts.number(),
