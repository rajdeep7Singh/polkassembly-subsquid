...
export type Call = Call_Assets | Call_AssetsRegistry | Call_Authorship | Call_Balances | Call_BondedFinance | Call_CollatorSelection | Call_Council | Call_CouncilMembership | Call_CrowdloanRewards | Call_CumulusXcm | Call_Democracy | Call_DmpQueue | Call_GovernanceRegistry | Call_Identity | Call_Indices | Call_Multisig | Call_ParachainSystem | Call_Preimage | Call_RelayerXcm | Call_Scheduler | Call_Session | Call_Sudo | Call_System | Call_Timestamp | Call_Tokens | Call_Treasury | Call_Utility | Call_Vesting | Call_XTokens | Call_XcmpQueue
...
export type OriginCaller = OriginCaller_Council | OriginCaller_CumulusXcm | OriginCaller_RelayerXcm | OriginCaller_Void | OriginCaller_system
...
export type Type_238 = Type_238_V0 | Type_238_V1 | Type_238_V2

export interface Type_238_V0 {
    __kind: 'V0'
    value: Type_239
}

export interface Type_238_V1 {
    __kind: 'V1'
    value: Type_244
}

export interface Type_238_V2 {
    __kind: 'V2'
    value: Type_250[]
}

export type Type_250 = Type_250_BuyExecution | Type_250_ClaimAsset | Type_250_ClearError | Type_250_ClearOrigin | Type_250_DepositAsset | Type_250_DepositReserveAsset | Type_250_DescendOrigin | Type_250_ExchangeAsset | Type_250_HrmpChannelAccepted | Type_250_HrmpChannelClosing | Type_250_HrmpNewChannelOpenRequest | Type_250_InitiateReserveWithdraw | Type_250_InitiateTeleport | Type_250_QueryHolding | Type_250_QueryResponse | Type_250_ReceiveTeleportedAsset | Type_250_RefundSurplus | Type_250_ReportError | Type_250_ReserveAssetDeposited | Type_250_SetAppendix | Type_250_SetErrorHandler | Type_250_SubscribeVersion | Type_250_Transact | Type_250_TransferAsset | Type_250_TransferReserveAsset | Type_250_Trap | Type_250_UnsubscribeVersion | Type_250_WithdrawAsset

export interface Type_250_BuyExecution {
    __kind: 'BuyExecution'
    fees: V1MultiAsset
    weightLimit: V2WeightLimit
}

export interface Type_250_ClaimAsset {
    __kind: 'ClaimAsset'
    assets: V1MultiAsset[]
    ticket: V1MultiLocation
}

export interface Type_250_ClearError {
    __kind: 'ClearError'
}

export interface Type_250_ClearOrigin {
    __kind: 'ClearOrigin'
}

export interface Type_250_DepositAsset {
    __kind: 'DepositAsset'
    assets: V1MultiAssetFilter
    maxAssets: number
    beneficiary: V1MultiLocation
...
export interface Type_250_DepositReserveAsset {
    __kind: 'DepositReserveAsset'
    assets: V1MultiAssetFilter
    maxAssets: number
    dest: V1MultiLocation
...
export interface Type_250_DescendOrigin {
    __kind: 'DescendOrigin'
    value: V1Junctions
}

export interface Type_250_ExchangeAsset {
    __kind: 'ExchangeAsset'
    give: V1MultiAssetFilter
    receive: V1MultiAsset[]
}
...
export interface Type_250_InitiateReserveWithdraw {
    __kind: 'InitiateReserveWithdraw'
    assets: V1MultiAssetFilter
    reserve: V1MultiLocation
    xcm: V2Instruction[]
...
export interface Type_250_InitiateTeleport {
    __kind: 'InitiateTeleport'
    assets: V1MultiAssetFilter
    dest: V1MultiLocation
    xcm: V2Instruction[]
...
export interface Type_250_QueryHolding {
    __kind: 'QueryHolding'
    queryId: bigint
    dest: V1MultiLocation
    assets: V1MultiAssetFilter
...
export interface Type_250_RefundSurplus {
    __kind: 'RefundSurplus'
}

export interface Type_250_ReportError {
    __kind: 'ReportError'
    queryId: bigint
    dest: V1MultiLocation
    maxResponseWeight: bigint
...
export interface Type_250_SetAppendix {
    __kind: 'SetAppendix'
    value: Type_250[]
}

export interface Type_250_SetErrorHandler {
    __kind: 'SetErrorHandler'
    value: Type_250[]
}
...
export interface Type_250_Trap {
    __kind: 'Trap'
    value: bigint
}
...
export type Type_244 = Type_244_HrmpChannelAccepted | Type_244_HrmpChannelClosing | Type_244_HrmpNewChannelOpenRequest | Type_244_QueryResponse | Type_244_ReceiveTeleportedAsset | Type_244_RelayedFrom | Type_244_ReserveAssetDeposited | Type_244_SubscribeVersion | Type_244_Transact | Type_244_TransferAsset | Type_244_TransferReserveAsset | Type_244_UnsubscribeVersion | Type_244_WithdrawAsset
...
export interface Type_244_RelayedFrom {
    __kind: 'RelayedFrom'
    who: V1Junctions
    message: Type_244
}
...
export type Type_246 = Type_246_BuyExecution | Type_246_DepositAsset | Type_246_DepositReserveAsset | Type_246_ExchangeAsset | Type_246_InitiateReserveWithdraw | Type_246_InitiateTeleport | Type_246_Noop | Type_246_QueryHolding

export interface Type_246_BuyExecution {
    __kind: 'BuyExecution'
    fees: V1MultiAsset
    weight: bigint
    debt: bigint
    haltOnError: boolean
    instructions: Type_244[]
}

export interface Type_246_DepositAsset {
    __kind: 'DepositAsset'
    assets: V1MultiAssetFilter
    maxAssets: number
    beneficiary: V1MultiLocation
...
export interface Type_246_DepositReserveAsset {
    __kind: 'DepositReserveAsset'
    assets: V1MultiAssetFilter
    maxAssets: number
    dest: V1MultiLocation
...
export interface Type_246_ExchangeAsset {
    __kind: 'ExchangeAsset'
    give: V1MultiAssetFilter
    receive: V1MultiAsset[]
}

export interface Type_246_InitiateReserveWithdraw {
    __kind: 'InitiateReserveWithdraw'
    assets: V1MultiAssetFilter
    reserve: V1MultiLocation
    effects: V1Order[]
...
export interface Type_246_InitiateTeleport {
    __kind: 'InitiateTeleport'
    assets: V1MultiAssetFilter
    dest: V1MultiLocation
    effects: V1Order[]
...
export interface Type_246_QueryHolding {
    __kind: 'QueryHolding'
    queryId: bigint
    dest: V1MultiLocation
    assets: V1MultiAssetFilter
...
export type Type_239 = Type_239_HrmpChannelAccepted | Type_239_HrmpChannelClosing | Type_239_HrmpNewChannelOpenRequest | Type_239_QueryResponse | Type_239_RelayedFrom | Type_239_ReserveAssetDeposit | Type_239_TeleportAsset | Type_239_Transact | Type_239_TransferAsset | Type_239_TransferReserveAsset | Type_239_WithdrawAsset
...
export interface Type_239_ReserveAssetDeposit {
    __kind: 'ReserveAssetDeposit'
    assets: V0MultiAsset[]
    effects: Type_241[]
}

export interface Type_239_TeleportAsset {
    __kind: 'TeleportAsset'
    assets: V0MultiAsset[]
    effects: Type_241[]
}
...
export type Type_241 = Type_241_BuyExecution | Type_241_DepositAsset | Type_241_DepositReserveAsset | Type_241_ExchangeAsset | Type_241_InitiateReserveWithdraw | Type_241_InitiateTeleport | Type_241_Null | Type_241_QueryHolding
...
export interface Type_241_Null {
    __kind: 'Null'
}
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type CrowdloanRewardsCall = CrowdloanRewardsCall_associate | CrowdloanRewardsCall_claim | CrowdloanRewardsCall_initialize | CrowdloanRewardsCall_initialize_at | CrowdloanRewardsCall_populate
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type AssetsRegistryCall = AssetsRegistryCall_approve_assets_mapping_candidate | AssetsRegistryCall_set_foreign_admin | AssetsRegistryCall_set_local_admin | AssetsRegistryCall_set_metadata

export interface AssetsRegistryCall_approve_assets_mapping_candidate {
    __kind: 'approve_assets_mapping_candidate'
    localAssetId: CurrencyId
    foreignAssetId: CurrencyId
    location: XcmAssetLocation
    decimals: number
}

export interface AssetsRegistryCall_set_foreign_admin {
    __kind: 'set_foreign_admin'
    foreignAdmin: AccountId32
}

export interface AssetsRegistryCall_set_local_admin {
    __kind: 'set_local_admin'
    localAdmin: AccountId32
}

export interface AssetsRegistryCall_set_metadata {
    __kind: 'set_metadata'
    localAssetId: CurrencyId
...
export const Type_250: sts.Type<Type_250> = sts.closedEnum(() => {
    return  {
        ...
        ReserveAssetDeposited: sts.array(() => V1MultiAsset),
        SetAppendix: sts.array(() => Type_250),
        SetErrorHandler: sts.array(() => Type_250),
        SubscribeVersion: sts.enumStruct({
            queryId: sts.bigint(),
            maxResponseWeight: sts.bigint(),
        }),
...
export const Type_246: sts.Type<Type_246> = sts.closedEnum(() => {
    return  {
        BuyExecution: sts.enumStruct({
            ...
            debt: sts.bigint(),
            haltOnError: sts.boolean(),
            instructions: sts.array(() => Type_244),
        }),
        DepositAsset: sts.enumStruct({
            assets: V1MultiAssetFilter,
            maxAssets: sts.number(),
...
export const AssetsRegistryCall: sts.Type<AssetsRegistryCall> = sts.closedEnum(() => {
    return  {
        approve_assets_mapping_candidate: sts.enumStruct({
            localAssetId: CurrencyId,
            foreignAssetId: CurrencyId,
            location: XcmAssetLocation,
            decimals: sts.number(),
        }),
        set_foreign_admin: sts.enumStruct({
            foreignAdmin: AccountId32,
        }),
        set_local_admin: sts.enumStruct({
            localAdmin: AccountId32,
        }),
...
export const ForeignMetadata: sts.Type<ForeignMetadata> = sts.struct(() => {
    return  {
        decimals: sts.number(),
    }
})
