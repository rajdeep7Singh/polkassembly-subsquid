...
export type Type_275 = Type_275_Response | Type_275_Xcm

export interface Type_275_Response {
    __kind: 'Response'
    value: V1MultiLocation
}

export interface Type_275_Xcm {
    __kind: 'Xcm'
    value: V1MultiLocation
}
...
export const OriginCaller: sts.Type<OriginCaller> = sts.closedEnum(() => {
    return  {
        AdvisoryCommittee: Type_271,
        Council: Type_272,
        CumulusXcm: Origin,
        PolkadotXcm: Type_275,
        TechnicalCommittee: Type_273,
        Void: Void,
        system: RawOrigin,
    }
})
