module.exports = class Data1704563324348 {
    name = 'Data1704563324348'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "proposal" ("id" character varying NOT NULL, "type" character varying(21) NOT NULL, "hash" text, "index" integer, "proposer" text, "deposit" numeric, "threshold" jsonb, "end" integer, "delay" integer, "curator" text, "payee" text, "reward" numeric, "fee" numeric, "bond" numeric, "curator_deposit" numeric, "description" text, "parent_bounty_index" integer, "proposal_arguments" jsonb, "proposal_argument_hash" text, "status" character varying(21) NOT NULL, "track_number" integer, "threshold_number" integer, "origin" text, "market_metadata" jsonb, "metadata" text, "enactment_at_block" integer, "enactment_after_block" integer, "submitted_at_block" integer, "submission_deposit" jsonb, "decision_deposit" jsonb, "deciding" jsonb, "tally" jsonb, "extrinsic_index" text, "execute_at_block_number" integer, "executed_at" TIMESTAMP WITH TIME ZONE, "proposal_hash_block" text, "created_at_block" integer NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL, "ended_at_block" integer, "ended_at" TIMESTAMP WITH TIME ZONE, "updated_at_block" integer, "updated_at" TIMESTAMP WITH TIME ZONE, "preimage_id" character varying, "group_id" character varying, CONSTRAINT "PK_ca872ecfe4fef5720d2d39e4275" PRIMARY KEY ("id"))`)
        ...
        await db.query(`CREATE TABLE "voting_delegation" ("id" character varying NOT NULL, "from" text NOT NULL, "to" text NOT NULL, "balance" numeric, "lock_period" integer NOT NULL, "track" integer, "extrinsic_index" text, "type" character varying(9) NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL, "created_at_block" integer NOT NULL, "ended_at" TIMESTAMP WITH TIME ZONE, "ended_at_block" integer, CONSTRAINT "PK_32c0d967d3995c8873ad01220bb" PRIMARY KEY ("id"))`)
