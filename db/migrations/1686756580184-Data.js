module.exports = class Data1686756580184 {
    name = 'Data1686756580184'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "proposal" ("id" character varying NOT NULL, "type" character varying(20) NOT NULL, "hash" text, "index" integer, "proposer" text, "deposit" numeric, "threshold" jsonb, "end" integer, "delay" integer, "curator" text, "payee" text, "reward" numeric, "fee" numeric, "bond" numeric, "digest" text, "call_data" jsonb, "description" text, "parent_bounty_index" integer, "proposal_arguments" jsonb, "proposal_argument_hash" text, "status" character varying(21) NOT NULL, "track_number" integer, "origin" text, "enactment_at_block" integer, "enactment_after_block" integer, "submitted_at_block" integer, "submission_deposit" jsonb, "decision_deposit" jsonb, "deciding" jsonb, "tally" jsonb, "execute_at_block_number" integer, "executed_at" TIMESTAMP WITH TIME ZONE, "created_at_block" integer NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL, "ended_at_block" integer, "ended_at" TIMESTAMP WITH TIME ZONE, "updated_at_block" integer, "updated_at" TIMESTAMP WITH TIME ZONE, "announcement_id" character varying, "preimage_id" character varying, CONSTRAINT "PK_ca872ecfe4fef5720d2d39e4275" PRIMARY KEY ("id"))`)
