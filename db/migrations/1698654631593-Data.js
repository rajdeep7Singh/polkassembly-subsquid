module.exports = class Data1698654631593 {
    name = 'Data1698654631593'

    async up(db) {
        await db.query(`CREATE TABLE "preimage" ("id" character varying NOT NULL, "proposer" text, "hash" text NOT NULL, "proposed_call" jsonb, "length" integer, "deposit" numeric, "section" text, "method" text, "status" character varying(21) NOT NULL, "created_at_block" integer NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL, "extrinsic_index" integer, "updated_at_block" integer, "updated_at" TIMESTAMP WITH TIME ZONE, CONSTRAINT "PK_dff8526c5d16d71afbefb55b286" PRIMARY KEY ("id"))`)
        ...
        await db.query(`CREATE TABLE "conviction_vote" ("id" character varying NOT NULL, "voter" text, "proposal_id" character varying NOT NULL, "proposal_index" integer NOT NULL, "created_at_block" integer NOT NULL, "removed_at_block" integer, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL, "removed_at" TIMESTAMP WITH TIME ZONE, "decision" character varying(12) NOT NULL, "balance" jsonb NOT NULL, "lock_period" integer, "delegated_to" text, "extrinsic_index" integer, "is_delegated" boolean, "type" character varying(17) NOT NULL, "txn_hash" text, CONSTRAINT "PK_ff0112254d31eff17e0ab8f8245" PRIMARY KEY ("id"))`)
        ...
        await db.query(`CREATE TABLE "status_history" ("id" character varying NOT NULL, "status" character varying(21) NOT NULL, "block" integer NOT NULL, "extrinsic_index" integer, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "proposal_id" character varying, CONSTRAINT "PK_271a5228edb4eeb41bc01d58fac" PRIMARY KEY ("id"))`)
        ...
        await db.query(`CREATE TABLE "proposal" ("id" character varying NOT NULL, "type" character varying(21) NOT NULL, "hash" text, "index" integer, "proposer" text, "deposit" numeric, "threshold" jsonb, "end" integer, "delay" integer, "curator" text, "payee" text, "reward" numeric, "fee" numeric, "bond" numeric, "curator_deposit" numeric, "description" text, "parent_bounty_index" integer, "proposal_arguments" jsonb, "proposal_argument_hash" text, "status" character varying(21) NOT NULL, "track_number" integer, "origin" text, "enactment_at_block" integer, "enactment_after_block" integer, "execute_at_block_number" integer, "executed_at" TIMESTAMP WITH TIME ZONE, "submitted_at_block" integer, "submission_deposit" jsonb, "decision_deposit" jsonb, "deciding" jsonb, "tally" jsonb, "created_at_block" integer NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL, "extrinsic_index" integer, "ended_at_block" integer, "ended_at" TIMESTAMP WITH TIME ZONE, "updated_at_block" integer, "updated_at" TIMESTAMP WITH TIME ZONE, "preimage_id" character varying, "group_id" character varying, CONSTRAINT "PK_ca872ecfe4fef5720d2d39e4275" PRIMARY KEY ("id"))`)
        ...
        await db.query(`CREATE INDEX "IDX_7e39429371502f6607538c44d9" ON "proposal" ("execute_at_block_number") `)
        await db.query(`CREATE INDEX "IDX_e46b42e8a287b3fe3e3c089691" ON "proposal" ("executed_at") `)
        ...
        await db.query(`CREATE TABLE "tippers" ("id" character varying NOT NULL, "hash" text NOT NULL, "tipper" text, "value" numeric, "extrinsic_index" integer, "created_at_block" integer NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL, "proposal_id" character varying, CONSTRAINT "PK_be6a26f9b9d1e6087da2e4b4d28" PRIMARY KEY ("id"))`)
        ...
        await db.query(`CREATE TABLE "voting_delegation" ("id" character varying NOT NULL, "from" text NOT NULL, "to" text NOT NULL, "balance" numeric, "lock_period" integer NOT NULL, "track" integer, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL, "extrinsic_index" integer, "created_at_block" integer NOT NULL, "ended_at" TIMESTAMP WITH TIME ZONE, "ended_at_block" integer, CONSTRAINT "PK_32c0d967d3995c8873ad01220bb" PRIMARY KEY ("id"))`)
    ...
    async down(db) {
        ...
        await db.query(`DROP INDEX "public"."IDX_7e39429371502f6607538c44d9"`)
        await db.query(`DROP INDEX "public"."IDX_e46b42e8a287b3fe3e3c089691"`)
