module.exports = class Data1690997897434 {
    name = 'Data1690997897434'

    async up(db) {
        await db.query(`CREATE TABLE "preimage" ("id" character varying NOT NULL, "proposer" text, "hash" text NOT NULL, "deposit" numeric, "length" integer, "proposed_call" jsonb, "section" text, "method" text, "status" character varying(15) NOT NULL, "created_at_block" integer NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL, "updated_at_block" integer, "updated_at" TIMESTAMP WITH TIME ZONE, CONSTRAINT "PK_dff8526c5d16d71afbefb55b286" PRIMARY KEY ("id"))`)
        ...
        await db.query(`CREATE TABLE "vote" ("id" character varying NOT NULL, "voter" text, "proposal_index" integer NOT NULL, "block_number" integer NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "decision" character varying(12), "balance" jsonb, "lock_period" integer, "identity_id" text, "removed_at_block" integer, "removed_at" TIMESTAMP WITH TIME ZONE, "proposal_id" character varying, CONSTRAINT "PK_2d5932d46afe39c8176f9d4be72" PRIMARY KEY ("id"))`)
        ...
        await db.query(`CREATE TABLE "status_history" ("id" character varying NOT NULL, "status" character varying(15) NOT NULL, "block" integer NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "proposal_id" character varying, CONSTRAINT "PK_271a5228edb4eeb41bc01d58fac" PRIMARY KEY ("id"))`)
        await db.query(`CREATE INDEX "IDX_6ecfec106cbaabdc5ac1bb4fbf" ON "status_history" ("proposal_id") `)
        await db.query(`CREATE TABLE "proposal" ("id" character varying NOT NULL, "type" character varying(18) NOT NULL, "hash" text, "index" integer, "proposer" text, "identity" text, "deposit" numeric, "threshold" jsonb, "end" integer, "delay" integer, "fee" numeric, "bond" numeric, "description" text, "url" text, "proposal_arguments" jsonb, "status" character varying(15) NOT NULL, "metadata" text, "tally" jsonb, "expiry_time" integer, "execute_at_block_number" integer, "executed_at" TIMESTAMP WITH TIME ZONE, "created_at_block" integer NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL, "ended_at_block" integer, "ended_at" TIMESTAMP WITH TIME ZONE, "updated_at_block" integer, "updated_at" TIMESTAMP WITH TIME ZONE, CONSTRAINT "PK_ca872ecfe4fef5720d2d39e4275" PRIMARY KEY ("id"))`)
